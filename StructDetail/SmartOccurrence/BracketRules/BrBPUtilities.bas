...
Private Const MODULE = "S:\StructDetail\Data\SmartOccurrence\COBracketRules\BrBPUtilities.bas"
...
'***************************************************************************
Public Function CheckValidityOfSupports(oSupports As IJElements, nSupports As Long) As Boolean
...
If nSuppCount = 2 And nSupports = 2 Then
