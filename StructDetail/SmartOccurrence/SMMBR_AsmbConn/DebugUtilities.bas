...
'*****************************************************************************
Option Explicit
Private Const MODULE = "StructDetail\Data\SmartOccurrence\SMMBR_AsmbConn\DebugUtilities"
...
Const METHOD = "::Debug_ObjectName"
    ...
    If Len(Trim(sText)) < 1 Then
        ...
        If TypeOf oObject Is IJSystemChild Then
...
Const METHOD = "::Debug_PortData"
    ...
    ElseIf TypeOf oObject Is ISPSSplitAxisPort Then
        Set oSplitAxisPort = oObject
        ePortId = oSplitAxisPort.PortIndex
        If ePortId = SPSMemberAxisAlong Then
            sText = "ISPSSplitAxisAlongPort:"
        ElseIf ePortId = SPSMemberAxisEnd Then
            sText = "ISPSSplitAxisEndPort:"
        ElseIf ePortId = SPSMemberAxisStart Then
            sText = "ISPSSplitAxisStartPort:"
        Else
            sText = "?ISPSSplitAxisPort:"
        End If

''    ElseIf TypeOf oObject Is ISPSSplitAxisEndPort Then
''        sText = "ISPSSplitAxisEndPort:"
''
''    ElseIf TypeOf oObject Is ISPSSplitAxisAlongPort Then
''        sText = "ISPSSplitAxisAlongPort:"
    ...
    Else
        sText = "?" & TypeName(oObject) & ": Type: ?" & "  Ctx: ?" & "  Opt: ?" & "  Opr: ?" & "  Xid: ?"
    End If
