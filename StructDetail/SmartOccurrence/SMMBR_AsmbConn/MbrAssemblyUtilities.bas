...
'*****************************************************************************
Option Explicit
Private Const MODULE = "StructDetail\Data\SmartOccurrence\SMMBR_AsmbConn\MbrAssemblyUtilities"
Public Const m_sProjectName As String = CUSTOMERID + "MBR_AsmbConn"
