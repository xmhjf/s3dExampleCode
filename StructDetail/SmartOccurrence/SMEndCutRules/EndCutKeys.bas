...
Public Const gsAddCornerFeature = "AddCornerFeature"

Public Const PROJECT_NAME As String = CUSTOMERID + "EndCutRules"
Public Const CMLIBRARY_ENDCUTRULES As String = PROJECT_NAME + ".WebCutDefCM"
Public Const PROJECT_PATH As String = "S:\StructDetail\Data\SmartOccurrence\" + PROJECT_NAME + "\"
Public Const PI As Double = 3.14159265

Private Const MODULE = PROJECT_PATH + "EndCutKeys.bas"
...
'    pQH.DefineCodeList CL_ENDCUTTYPE, colAnswers
    ...
    strError = "Setting question."
    pQH.SetQuestion QUES_ENDCUTTYPE, "Welded", CL_ENDCUTTYPE
zMsgBox "   pQH.SetQuestion..." & QUES_ENDCUTTYPE & "..." & "Welded"
