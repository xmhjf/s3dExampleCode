...
//
//File
//  ZigZagWeldParameterRule.cs
//
//  Original Dll Name: <InstallDir>\SharedContent\Bin\StructDetail\SmartOccurrence\Release\SMPhysConnRules.dll
//  Original Class Name: ‘ZigZagWeldParm’ in VB content
//
//Abstract
//	ZigZagWeldParameterRule is a .NET parameter rule which is defining the custom parameter rule. 
...
namespace Ingr.SP3D.Content.Structure
{
    ...
    [RuleInterface(DetailingCustomAssembliesConstants.IASMPhysConnRules_ZigZagWeldParm, DetailingCustomAssembliesConstants.IASMPhysConnRules_ZigZagWeldParm)]
    [DefaultLocalizer(ConnectionsResourceIdentifiers.ConnectionsResource, ConnectionsResourceIdentifiers.ConnectionsAssembly)]
    public class ZigZagWeldParameterRule : PhysicalConnectionParameterRule
    {
        //==============================================================================================================
        //DefinitionName/ProgID of this symbol is "Connections,Ingr.SP3D.Content.Structure.ZigZagWeldParameterRule"
        //==============================================================================================================
        #region Parameters
        ...
        public override void Evaluate()
        {
            try
            {
                ...
                double boundedPartThickness = 0.0, boundingPartThickness = 0.0, pitchValue, lengthValue;
                if (physicalConnection.PartName.Equals(DetailingCustomAssembliesConstants.ZigZagWeld))
                {
                    try
                    {
                ...
                double fillet = boundedPartThickness > boundingPartThickness ? DetailingCustomAssembliesConstants.MinimunTolerance * 82 : boundedPartThickness * DetailingCustomAssembliesConstants.MinimunTolerance * 82;
                ...
                this.category.Value = (int)WeldFilletMeasure.Leg;
