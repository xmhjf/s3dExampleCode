...
//
//File
//  TeeWeld3ParameterRule.cs
//
//  Original Dll Name: <InstallDir>\SharedContent\Bin\StructDetail\SmartOccurrence\Release\SMPhysConnRules.dll
//  Original Class Name: ‘TeeWeld3Parm’ in VB content
//
//Abstract
//	TeeWeld3ParameterRule is a .NET parameter rule which is defining the custom parameter rule. 
...
namespace Ingr.SP3D.Content.Structure
{
    ...
    [RuleInterface(DetailingCustomAssembliesConstants.IASMPhysConnRules_TeeWeld3Parm, DetailingCustomAssembliesConstants.IASMPhysConnRules_TeeWeld3Parm)]
    [DefaultLocalizer(ConnectionsResourceIdentifiers.ConnectionsResource, ConnectionsResourceIdentifiers.ConnectionsAssembly)]
    public class TeeWeld3ParameterRule : PhysicalConnectionParameterRule
    {
        //==============================================================================================================
        //DefinitionName/ProgID of this symbol is "Connections,Ingr.SP3D.Content.Structure.TeeWeld3ParameterRule"
        //==============================================================================================================
        #region Parameters
        ...
        public override void Evaluate()
        {
            try
            {
                ...
                if (physicalConnection.PartName.Equals(DetailingCustomAssembliesConstants.TeeWeld3))
                {
                    try
                    {
                ...
                this.nose.Value = boundedPartThickness / 2;
                double mountingAnle = physicalConnection.GetConnectionAngle();
                ...
                switch (bevelMethod)
                {
                    case (int)BevelMethod.Constant:
                        ...
                        this.refSideFirstBevelDepth.Value = (Math.Abs((Math.PI / 2) - mountingAnle) > 0) ? boundedPartThickness / 2 : 0;
                        this.refSideFirstBevelAngle.Value = (Math.Abs((Math.PI / 2) - mountingAnle) > 0) ? Math.Abs((Math.PI / 2) - mountingAnle) : 0;
                        this.antiRefSideFirstBevelDepth.Value = (Math.Abs((Math.PI / 2) - mountingAnle) > 0) ? 0 : boundingPartThickness / 2; ;
                        this.antiRefSideFirstBevelAngle.Value = (Math.Abs((Math.PI / 2) - mountingAnle) > 0) ? 0 : Math.Abs((Math.PI / 2) - mountingAnle);
                    ...
                    case (int)BevelMethod.Varying:
                        ...
                        this.refSideFirstBevelDepth.Value = ((90 - mountingAnle) > 0) ? boundedPartThickness / 2 : 0;
                        this.refSideFirstBevelAngle.Value = 0;
                        this.antiRefSideFirstBevelDepth.Value = ((90 - mountingAnle) > 0) ? 0 : boundedPartThickness / 2;
                        this.antiRefSideFirstBevelAngle.Value = 0;
                        this.noseOrientationAngle.Value = Math.Abs(Math.PI / 2 - mountingAnle);
                ...
                if (fillet < DetailingCustomAssembliesConstants.FilletTolerance1)
                {
                    fillet = DetailingCustomAssembliesConstants.FilletTolerance1;
                }
                else if (fillet > DetailingCustomAssembliesConstants.FilletTolerance2)
                {
                    fillet = DetailingCustomAssembliesConstants.FilletTolerance2;
                }
