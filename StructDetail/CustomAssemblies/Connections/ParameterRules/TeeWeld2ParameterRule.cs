...
//
//File
//  TeeWeld2ParameterRule.cs
//
//  Original Dll Name: <InstallDir>\SharedContent\Bin\StructDetail\SmartOccurrence\Release\SMPhysConnRules.dll
//  Original Class Name: ‘TeeWeld2Parm’ in VB content
//
//Abstract
//	TeeWeld2ParameterRule is a .NET parameter rule which is defining the custom parameter rule. 
...
namespace Ingr.SP3D.Content.Structure
{
    ...
    [RuleInterface(DetailingCustomAssembliesConstants.IASMPhysConnRules_TeeWeld2Parm, DetailingCustomAssembliesConstants.IASMPhysConnRules_TeeWeld2Parm)]
    [DefaultLocalizer(ConnectionsResourceIdentifiers.ConnectionsResource, ConnectionsResourceIdentifiers.ConnectionsAssembly)]
    public class TeeWeld2ParameterRule : PhysicalConnectionParameterRule
    {
        //==============================================================================================================
        //DefinitionName/ProgID of this symbol is "Connections,Ingr.SP3D.Content.Structure.TeeWeld2ParameterRule"
        //==============================================================================================================
        #region Parameters
        ...
        public override void Evaluate()
        {
            try
            {
                ...
                if (physicalConnection.PartName.Equals(DetailingCustomAssembliesConstants.TeeWeld2))
                {
                    try
                    {
                ...
                double fillet = boundingPartThickness / 2 < 0.00952 ? boundingPartThickness / 2 : 0.00952;
                ...
                this.antiMoldedFillet.Value = boundedPartThickness / 2;
