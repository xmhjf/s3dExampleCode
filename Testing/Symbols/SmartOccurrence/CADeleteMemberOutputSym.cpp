// CADeleteMemberOutputSym.cpp : Implementation of CCADeleteMemberOutputSym

#include "stdafx.h"
#include "CADeleteMemberOutputSym.h"
#include "Geom3d.h"

STDMETHODIMP CCADeleteMemberOutputSym::InstanciateDefinition(BSTR CodeBase, VARIANT definitionParameters, LPDISPATCH pResourceMgr, LPDISPATCH * ppSymbolDefDisp)
{
	const CComBSTR cProgId(L"ATPSO.CADeleteMemberOutputSym");
	HRESULT hr = S_OK;
...
STDMETHODIMP CCADeleteMemberOutputSym::InitializeSymbolDefinition(IJDSymbolDefinition * * ppSymbolDefDisp)
{
...
HRESULT CCADeleteMemberOutputSym::InitializeDefinition(IJDSymbolDefinition * pSymbolDefDisp)
{
	...
	try
	{
		...
		hr = pSymbolDefDisp->get_IJDRepresentations(&pIReps);
		hr_onFail_throw( hr, IID_IJDUserSymbolServices, __FILE__, L"pSymbolDefDisp->get_IJDRepresentations failed", "", 0 , "");
...
STDMETHODIMP CCADeleteMemberOutputSym::InvokeRepresentation(LPDISPATCH pSymbolOccurrence, BSTR pRepName, LPDISPATCH pOutputColl, SAFEARRAY * * arrayOfInputs)
{
	return S_OK;
}
	
STDMETHODIMP CCADeleteMemberOutputSym::EditOccurence(LPDISPATCH * pSymbolOccurrence, LPDISPATCH pTransactionMgr, VARIANT_BOOL * pbHasOwnEditForm)
{
	return S_OK;
}
	
STDMETHODIMP CCADeleteMemberOutputSym::GetDefinitionName(VARIANT definitionParameters, BSTR * pDefName)
{
	const CComBSTR cName(L"ATPSO.CADeleteMemberOutputSym");

	*pDefName = cName.Copy();
	return S_OK;
}

HRESULT CCADeleteMemberOutputSym::GetSymbolVersion( BSTR *pstrVersion )
{
    if (  !pstrVersion )              
        return E_INVALIDARG;
...
STDMETHODIMP CCADeleteMemberOutputSym::Physical(IJDRepresentationStdCustomMethod** pIRepSCM)
{
	const long PARAMETERINDEX_Diameter = 2;
	const long PARAMETERINDEX_OriginX = 3;
	const long PARAMETERINDEX_OriginY = 4;
	...
	{
		if ( pIRepSCM == NULL )
			hr_throw( E_INVALIDARG, IID_ICADeleteMemberOutputSym, __FILE__, L"Invalid representation argument passed to Physical method.", "", 0 , "");

		CComPtr<IJDRepresentationDuringGame> pRepDG;
		hr = (*pIRepSCM)->QueryInterface( IID_IJDRepresentationDuringGame, (void**)&pRepDG );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pIRepSCM->QueryInterface( IID_IJDRepresentationDuringGame failed", "", 0 , "");

		CComPtr<IJDOutputCollection> pOC;
		hr = pRepDG->get_OutputCollection( &pOC );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pRepDG->get_OutputCollection failed", "", 0 , "");

		// remove all outputs
		CComPtr<IJDSymbolDefinition> oDefinition;
		hr = pOC->get_Definition( &oDefinition );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pOC->get_Definition failed", "", 0 , "");
		...
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oRepresentations->GetRepresentationByName( CComBSTR(Physical) failed", "", 0 , "");
		CComPtr<IJDOutputs> oOutputs;
		hr = oRep->QueryInterface( IID_IJDOutputs, (void**)&oOutputs );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oRep->QueryInterface( IID_IJDOutputs failed", "", 0 , "");
		hr = oOutputs->RemoveAllOutput();
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oOutputs->RemoveAllOutput failed", "", 0 , "");
		...
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"GetInputValue( pInputs, PARAMETERINDEX_Diameter failed", "", 0 , "");

		double lOriginX = 0.0;
		hr = GetInputValue( pInputs, PARAMETERINDEX_OriginX, &lOriginX );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"GetInputValue( pInputs, PARAMETERINDEX_OriginX failed", "", 0 , "");

		double lOriginY = 0.0;
		hr = GetInputValue( pInputs, PARAMETERINDEX_OriginY, &lOriginY );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"GetInputValue( pInputs, PARAMETERINDEX_OriginY failed", "", 0 , "");

		double lOriginZ = 0.0;
		hr = GetInputValue( pInputs, PARAMETERINDEX_OriginZ, &lOriginZ );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"GetInputValue( pInputs, PARAMETERINDEX_OriginZ failed", "", 0 , "");

		CComPtr<IJGeometryFactory> oGeomFactory;
		hr = oGeomFactory.CoCreateInstance(CLSID_GeometryFactory, NULL, CLSCTX_INPROC_SERVER);
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oGeomFactory.CoCreateInstance(CLSID_GeometryFactory failed", "", 0 , "");
		CComPtr<ISpheres3d>	pSpheres;
		hr = oGeomFactory->get_Spheres3d( &pSpheres );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oGeomFactory->get_Spheres3d failed", "", 0 , "");
		CComPtr<IUnknown>	pResourceManager;
		hr = pOC->get_ResourceManager( &pResourceManager );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pOC->get_ResourceManager failed", "", 0 , "");
		...
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pSpheres->CreateByCenterRadius failed", "", 0 , "");

		CComPtr<IJDOutput>	oOutput;
		hr = InitNewOutput(pOC, CComBSTR(L"SymbolSphere"), &oOutput);
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"InitNewOutput failed", "", 0 , "");
		CComBSTR	pAutoName;
		hr = pOC->AddOutput( CComBSTR(L"SymbolSphere"), pSphere, &pAutoName );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pOC->AddOutput failed", "", 0 , "");
	}
	catch ( CCMNException& ce)
	{
		hr = ce.GetHR();
...
HRESULT CCADeleteMemberOutputSym::GetInputValue( IJDInputs *pInputs, long inputIndex, double *value )
{
	HRESULT hr = S_OK;
	...
	{
		if ( pInputs == NULL )
			hr_throw( E_INVALIDARG, IID_ICADeleteMemberOutputSym, __FILE__, L"Invalid pInputs argument passed to GetInputValue.", "", 0 , "");
		if ( value == NULL )
			hr_throw( E_INVALIDARG, IID_ICADeleteMemberOutputSym, __FILE__, L"Invalid value argument passed to GetInputValue.", "", 0 , "");

		CComPtr<IJDInput>	pInput;
		hr = pInputs->GetInputByIndex(inputIndex, &pInput);
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pInputs->GetInputByIndex failed", "", 0 , "");
		CComPtr<IJDInputDuringGame>	pInputDuringGame;
		hr = pInput->get_IJDInputDuringGame( &pInputDuringGame );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pInput->get_IJDInputDuringGame failed", "", 0 , "");
		CComPtr<IDispatch>	pResult;
		hr = pInputDuringGame->get_Result( &pResult );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pInput->get_IJDInputDuringGame failed", "", 0 , "");
		CComPtr<IJDParameterContent>	pc;
		hr = pResult->QueryInterface( IID_IJDParameterContent, (void**) &pc );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pResult->QueryInterface( IID_IJDParameterContent failed", "", 0 , "");
		hr = pc->get_UomValue( value );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"pc->get_UomValue failed", "", 0 , "");
	}
	catch ( CCMNException& ce)
	{
		hr = ce.GetHR();
...
HRESULT CCADeleteMemberOutputSym::InitNewOutput(IJDOutputCollection *pOC, BSTR outputName, IJDOutput **pOutput)
{
	HRESULT hr = S_OK;
	...
	{
		if ( pOC == NULL )
			hr_throw( E_INVALIDARG, IID_ICADeleteMemberOutputSym, __FILE__, L"Invalid pOC argument passed to InitNewOutput", "", 0 , "");
		if ( pOutput == NULL )
			hr_throw( E_INVALIDARG, IID_ICADeleteMemberOutputSym, __FILE__, L"Invalid pOutput argument passed to InitNewOutput", "", 0 , "");
		...
		CComPtr<IJDRepresentations> oRepresentations;
		hr = oDefinition->get_IJDRepresentations( &oRepresentations );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oDefinition->get_IJDRepresentations failed", "", 0 , "");
		hr = oRepresentations->GetRepresentationByName(CComBSTR(L"Physical"), &oRep);
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oRepresentations->GetRepresentationByName failed", "", 0 , "");
		CComPtr<IJDOutputs> oOutputs;
		hr = oRep->get_IJDOutputs( &oOutputs );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oRep->get_IJDOutputs failed", "", 0 , "");
		
		CComPtr<IJDOutput>	oOutput;
		hr = oOutput.CoCreateInstance(CLSID_DOutput, NULL, CLSCTX_INPROC_SERVER);
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oOutput.CoCreateInstance(CLSID_DOutput failed", "", 0 , "");
		hr = oOutput->put_Name( outputName );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oOutput->put_Name failed", "", 0 , "");
		hr = oOutput->put_Description( outputName );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oOutput->put_Description failed", "", 0 , "");
		hr = oOutputs->SetOutput( oOutput );
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oOutputs->SetOutput failed", "", 0 , "");
		hr = oOutput->Reset();
		hr_onFail_throw( hr, IID_ICADeleteMemberOutputSym, __FILE__, L"oOutput.Reset failed", "", 0 , "");
	}
	catch ( CCMNException& ce)
	{
		hr = ce.GetHR();
