// COMSelectionRuleSel.cpp : Implementation of CCOMSelectionRuleSel

#include "stdafx.h"
#include "COMSelectionRuleSel.h"

// CCOMSelectionRuleSel
const CComBSTR CCOMSelectionRuleSel::cSelectorProgid(L"ATPSO.COMSelectionRuleSel");
const CComBSTR CCOMSelectionRuleSel::cSelectorName(L"ATPSO.COMSelectionRuleSel");

STDMETHODIMP CCOMSelectionRuleSel::InstanciateDefinition(BSTR CodeBase, VARIANT definitionParameters, LPDISPATCH pResourceMgr, LPDISPATCH * ppSymbolDefDisp)
{
	HRESULT hr = S_OK;
...
STDMETHODIMP CCOMSelectionRuleSel::InitializeSymbolDefinition(IJDSymbolDefinition * * ppSymbolDefDisp)
{
	HRESULT hr = S_OK;
...
STDMETHODIMP CCOMSelectionRuleSel::InvokeRepresentation(LPDISPATCH pSymbolOccurrence, BSTR pRepName, LPDISPATCH pOutputColl, SAFEARRAY * * arrayOfInputs)
{
	return S_OK;
}
	
STDMETHODIMP CCOMSelectionRuleSel::EditOccurence(LPDISPATCH * pSymbolOccurrence, LPDISPATCH pTransactionMgr, VARIANT_BOOL * pbHasOwnEditForm)
{
	return S_OK;
}
	
STDMETHODIMP CCOMSelectionRuleSel::GetDefinitionName(VARIANT definitionParameters, BSTR * pDefName)
{
...
HRESULT CCOMSelectionRuleSel::InstanciateSelector(BSTR Selector_Progid, BSTR Selector_CodeBase, BSTR Selector_Name, LPDISPATCH pResourceMgr, LPDISPATCH *ppInstanciatedDefinition)
{
	HRESULT hr = S_OK;
...
HRESULT CCOMSelectionRuleSel::InitAbstractSelector( IJDSymbolDefinition *pSelector )
{
	HRESULT hr = S_OK;
...
STDMETHODIMP CCOMSelectionRuleSel::CMSelector(IJDRepresentation * pRepresentation)
{
	...
	try
	{
		...
		hr = pChoice->put_String( CComBSTR(L"COMTestSelectionRule") );
...
HRESULT CCOMSelectionRuleSel::GetSymbolVersion( BSTR *pstrVersion )
{
    if (  !pstrVersion )              
        return E_INVALIDARG;
