// COMSelectionRuleSel.h : Declaration of the CCOMSelectionRuleSel
...
class ATL_NO_VTABLE CCOMSelectionRuleSel :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CCOMSelectionRuleSel, &CLSID_COMSelectionRuleSel>,
	public IDispatchImpl<ICOMSelectionRuleSel, &IID_ICOMSelectionRuleSel, &LIBID_ATPSO,/*wMajor =*/ 0xFFFF, /*wMinor =*/ 0xFFFF>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_COMSELECTIONRULESEL)


BEGIN_COM_MAP(CCOMSelectionRuleSel)
	COM_INTERFACE_ENTRY2(IDispatch,ICOMSelectionRuleSel)
	COM_INTERFACE_ENTRY(ICOMSelectionRuleSel)
...
OBJECT_ENTRY_AUTO(__uuidof(COMSelectionRuleSel), CCOMSelectionRuleSel)
