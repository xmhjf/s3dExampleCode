...
{
    public class LoadSpaceRule : NameRuleBase
    {
        ...
        public override void ComputeName(BusinessObject entity, ReadOnlyCollection<BusinessObject> parents, BusinessObject activeEntity)
        {
            try
            {
                ...
                long count;
                 ...
                 //this is not associated to any LC yet
                BusinessObject boParent  = this.GetParent(HierarchyTypes.Analysis, entity);

                strChildName = Convert.ToString(boParent.GetPropertyValue("IJNamedItem", "Name"));
