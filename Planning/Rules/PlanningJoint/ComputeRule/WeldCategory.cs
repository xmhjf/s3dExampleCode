...
{
    /// <summary>
    /// Weld Category Class Implements PlanningJointRule Base
    /// </summary>
    public class WeldCategory : PlanningJointRuleBase
    {
        ...
        /// <returns>ReadOnlyCollection of ComplexString3d</returns>
        public override ReadOnlyCollection<ComplexString3d> GenerateGeometries(BusinessObject physicalConn)
        {
            ...
            try
            {
                ...
                geometryCollections = GeneratePlnJointGeometry(WeldGeometry.WeldCategoryBased, singlePJForMultiLumpPC, weldType, weldCategory, blockIntersectionJointLength);
            }
            catch (Exception e)
            {
