Attribute VB_Name = "basHLLTeeTap"
'+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
'
...
'+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
Option Explicit
Public Const MODULE = "basHLLTeeTap"
...
'''<{(Projection begin)}>
Public Function PlaceProjectionTrans(ByVal objCurve As Object, _
...
' Construction of projection
    Const METHOD = "PlaceProjectionTrans:"
    On Error GoTo ErrorHandler
    ...
    Set PlaceProjectionTrans = objProjection
    Set objProjection = Nothing
    Set geomFactory = Nothing
