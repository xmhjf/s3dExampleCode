...
//
//   VariableTypeA.cs
//    HSSmartPart,Ingr.SP3D.Content.Support.Symbols.VariableTypeA
//   Author       :  Rajeswari
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class VariableTypeA : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "VariableSpring,Ingr.SP3D.Content.Support.Symbols.TypeA"
        //----------------------------------------------------------------------------------
        ...
        [InputString(19, "Nut1Shape", "Nut1Shape", "No Value")]
        public InputString m_oNut1Shape;
        [InputString(20, "Nut2Shape", "Nut2Shape", "No Value")]
        ...
        public override IEnumerable<OutputDefinition> AdditionalOutputs(string aspectName)
        {
            ...
            AddNutOutputs(3, additionalOutputs);
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                //=================================================
                // Declare the Shape Data Structure
                ...
                Port port2 = new Port(OccurrenceConnection, part, "RodEnd2", new Position(0, 0, height1 / 2 - offset1), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                Port port4 = new Port(OccurrenceConnection, part, "Surface2", new Position(0, 0, height1 / 2), new Vector(1, 0, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Surface2"] = port4;

                // Add the Graphics
                Matrix4X4 matrix = new Matrix4X4();
                if (nut1 != "" && nut1 != "No Value")
                {
                    matrix.Translate(new Vector(0, 0, height1 / 2));
                    AddNut(nut1Inputs, matrix, m_Symbolic.Outputs, "Nut1");
                }
                if (nut2 != "" && nut2 != "No Value")
                {
                    matrix = new Matrix4X4();
                    matrix.Translate(new Vector(0, 0, height1 / 2 + nut1Inputs.ShapeLength));
                    AddNut(nut2Inputs, matrix, m_Symbolic.Outputs, "Nut2");
                }
                if (nut3 != "" && nut3 != "No Value")
                {
                    matrix = new Matrix4X4();
                    matrix.Translate(new Vector(0, 0, height1 / 2 - offset1 - installedRodTakeOut - offset2 - nut3Inputs.ShapeLength));
                    AddNut(nut3Inputs, matrix, m_Symbolic.Outputs, "Nut3");
                }
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of VariableTypeA.cs."));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in Weight CG of VariableTypeA.cs."));
                }
            }
        }
