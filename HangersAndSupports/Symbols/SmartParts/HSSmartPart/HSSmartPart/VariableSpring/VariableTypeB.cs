...
//
//   VariableTypeB.cs
//    HSSmartPart,Ingr.SP3D.Content.Support.Symbols.VariableTypeB
//   Author       :  Rajeswari
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class VariableTypeB : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "VariableSpring,Ingr.SP3D.Content.Support.Symbols.TypeB"
        //----------------------------------------------------------------------------------
        ...
        [InputString(19, "LugShape", "LugShape","No Value")]
        ...
        [InputString(25, "TurnbuckleShape", "TurnbuckleShape", "No Value")]
        public InputString m_oTurnbuckleShape;
        [InputString(26, "Nut3Shape", "Nut3Shape", "No Value")]
        ...
        public override IEnumerable<OutputDefinition> AdditionalOutputs(string aspectName)
        {
            ...
            // Add Outputs for the Lug Shape
            additionalOutputs.Add(new OutputDefinition("Lug", "Lug"));
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (lug != "" && lug != "No Value")
                {
                    ...
                    matrix.Translate(new Vector(-lugInputs.width1 / 2, lugInputs.thickness1 / 2, height1 / 2));
                    AddPlate(lugInputs, matrix, m_Symbolic.Outputs, "Lug");
                }
                if (nut != "" && nut != "No Value")
                {
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of VariableTypeB.cs."));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in Weight CG of VariableTypeB.cs."));
                }
            }
        }
