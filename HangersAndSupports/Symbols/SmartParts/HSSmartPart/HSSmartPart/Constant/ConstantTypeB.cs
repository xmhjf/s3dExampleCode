...
//
//   ConstantTypeB.cs
//    HSSmartPart,Ingr.SP3D.Content.Support.Symbols.ConstantTypeB
//   Author       :  Vijay
...
//   -----------     ---     ------------------
//   04.June.2013    Vijay   CR-CP-222480  Convert HS_S3DConstant Smartpart VB Project to C# .Net  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class ConstantTypeB : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "HSSmartPart,Ingr.SP3D.Content.Support.Symbols.ConstantTypeB"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Double turnbuckleLength = constant.turnbuckle.Opening1 + constant.turnbuckle.Nut.ShapeLength * 2, turnbuckleTakeOut = turnbuckleLength - 2 * constant.offset2,lugHOffset;
                ...
                switch (config)
                {
                    case 1:     //Vertical Casing Above Frame
                        ...
                        if (alignment == 1)
                        {
                            ...
                            matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset - constant.lug.thickness1 / 2, -constant.lug.width1 / 2 - lugHOffset, -constant.pivotOffset + constant.length));
                            AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug1");
                            ...
                            switch (smartShapeType)
                            {
                                case 15:
                                    ...
                                    break;
                                case 65:
                                    matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset, 0, -constant.pivotOffset + constant.length + topPortZOffset));
                            ...
                            if(suspension == 2)
                            {
                                ...
                                matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1));
                                matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset + constant.topSpacing - constant.lug.thickness1 / 2, -constant.lug.width1 / 2 - lugHOffset, -constant.pivotOffset + constant.length));
                                AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug2");
                                if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                                {
                                    matrix = new Matrix4X4();
                                    matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1));
                                ...
                                switch (smartShapeType)
                                {
                                    case 15:
                                        matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.length + constant.offset1));
                                        AddClevis(clevisStructAttachment, matrix, m_PhysicalAspect.Outputs, "StructAtt2");
                                        break;
                                    case 65:
                                        matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.length + topPortZOffset));
                                        AddWBABolt(wbaStructAttachment, matrix, m_PhysicalAspect.Outputs, "StructAtt2");
                                        break;
                                }
                            }
                        }
                        else
                        {
                            matrix = new Matrix4X4();
                            matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                            matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset - constant.lug.width1 / 2 - lugHOffset, constant.lug.thickness1 / 2, -constant.pivotOffset + constant.length));
                            AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug1");
                            if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                            {
                                matrix = new Matrix4X4();
                            ...
                            if(suspension == 2)
                            {
                                matrix = new Matrix4X4();
                                matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                                matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset + constant.topSpacing - constant.lug.width1 / 2 - lugHOffset, constant.lug.thickness1 / 2, -constant.pivotOffset + constant.length));
                                AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug2");
                                if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                                {
                                    matrix = new Matrix4X4();
                    ...
                    case 2:     //Vertical Casing Below Frame
                        ...
                        if (alignment == 1)
                        {
                            ...
                            matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                            matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1));
                            matrix.Translate(new Vector(-constant.topOffset - constant.lug.thickness1 / 2, -constant.lug.width1 / 2 - lugHOffset, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1));
                            AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug1");
                            if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                            {
                                matrix = new Matrix4X4();
                            ...
                            switch (smartShapeType)
                            {
                                case 15:
                                    ...
                                    break;
                                case 65:
                                    matrix.Translate(new Vector(-constant.topOffset, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1 + topPortZOffset));
                                    AddWBABolt(wbaStructAttachment, matrix, m_PhysicalAspect.Outputs, "StructAtt1");
                                    break;
                            }
                            if(suspension == 2)
                            {
                                ...
                                matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1));
                                matrix.Translate(new Vector(-constant.topOffset + constant.topSpacing - constant.lug.thickness1 / 2, -constant.lug.width1 / 2 - lugHOffset, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1));
                                AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug2");
                                if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                                {
                                    matrix = new Matrix4X4();
                                ...
                                switch (smartShapeType)
                                {
                                    case 15:
                                        ...
                                        break;
                                    case 65:
                                        matrix.Translate(new Vector(-constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1 + topPortZOffset));
                                        AddWBABolt(wbaStructAttachment, matrix, m_PhysicalAspect.Outputs, "StructAtt2");
                                        break;
                                }
                            }
                        ...
                        else
                        {
                            matrix = new Matrix4X4();
                            matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                            matrix.Translate(new Vector(-constant.topOffset - constant.lug.width1 / 2 - lugHOffset, constant.lug.thickness1 / 2, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1));
                            AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug1");
                            if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                            {
                                matrix = new Matrix4X4();
                            ...
                            if(suspension == 2)
                            {
                                matrix = new Matrix4X4();
                                matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                                matrix.Translate(new Vector(-constant.topOffset + constant.topSpacing - constant.lug.width1 / 2 - lugHOffset, constant.lug.thickness1 / 2, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1));
                                AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug2");
                                if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                                {
                                    matrix = new Matrix4X4();
                    ...
                    case 3:     //Horizontal Casing Beside Frame
                        ...
                        if (alignment == 1)
                        {
                            ...
                            if(suspension == 2)
                            {
                                ...
                                matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1));
                                matrix.Translate(new Vector(-constant.topOffset + constant.topSpacing - constant.lug.thickness1 / 2, -constant.lug.width1 / 2 - lugHOffset, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset - vTop2Offset));
                                AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug2");
                                if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                                {
                                    matrix = new Matrix4X4();
                                ...
                                switch (smartShapeType)
                                {
                                    case 15:
                                        ...
                                        break;
                                    case 65:
                                        matrix.Translate(new Vector(-constant.topOffset + constant.topSpacing, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset + topPortZOffset - vTop2Offset));
                                        AddWBABolt(wbaStructAttachment, matrix, m_PhysicalAspect.Outputs, "StructAtt2");
                                        break;
                                }
                            }
                        ...
                        else
                        {
                            ...
                            if(suspension == 2)
                            {
                                matrix = new Matrix4X4();
                                matrix.Rotate(Math.PI / 2, new Vector(1, 0, 0));
                                matrix.Translate(new Vector(-constant.topOffset + constant.topSpacing - constant.lug.width1 / 2 - lugHOffset, constant.lug.thickness1 / 2, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset - vTop2Offset));
                                AddPlate(constant.lug, matrix, m_PhysicalAspect.Outputs, "Lug2");
                                if (HgrCompareDoubleService.cmpdbl(constant.pin.PinDiameter , 0)==false)
                                {
                                    matrix = new Matrix4X4();
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of TypeB."));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in Weight CG of TypeB."));
                    return;
                }
            }
        }
