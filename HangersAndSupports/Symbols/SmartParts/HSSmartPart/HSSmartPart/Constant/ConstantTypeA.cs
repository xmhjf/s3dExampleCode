...
//
//   ConstantTypeA.cs
//    HSSmartPart,Ingr.SP3D.Content.Support.Symbols.ConstantTypeA
//   Author       :  Vijay
...
//   -----------     ---     ------------------
//   29.May.2013     Vijay   CR-CP-222480  Convert HS_S3DConstant Smartpart VB Project to C# .Net  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class ConstantTypeA : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "HSSmartPart,Ingr.SP3D.Content.Support.Symbols.ConstantTypeA"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                switch (config)
                {
                    case 1:     //Vertical Casing Above Frame
                        port = new Port(OccurrenceConnection, part, "RodEnd1", new Position(constant.caseCLOffset - constant.topOffset, 0, -constant.pivotOffset + constant.length - constant.offset1), new Vector(1, 0, 0), new Vector(0, 0, 1));
                        m_PhysicalAspect.Outputs["RodEnd1"] = port;
                        if(suspension == 2)
                        {
                            port = new Port(OccurrenceConnection, part, "RodEnd2", new Position(constant.caseCLOffset - constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.length - constant.offset1), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["RodEnd2"] = port;

                            port = new Port(OccurrenceConnection, part, "Top2", new Position(constant.caseCLOffset - constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.length + constant.nut.ShapeLength), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["Top2"] = port;
                        }
                        else        //need to include the second port - it will be at the same position as the first
                        {
                            port = new Port(OccurrenceConnection, part, "RodEnd2", new Position(constant.caseCLOffset - constant.topOffset, 0, -constant.pivotOffset + constant.length - constant.offset1), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["RodEnd2"] = port;

                            port = new Port(OccurrenceConnection, part, "Top2", new Position(constant.caseCLOffset - constant.topOffset, 0, -constant.pivotOffset + constant.length + constant.nut.ShapeLength), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["Top2"] = port;
                        }
                        port = new Port(OccurrenceConnection, part, "Top1", new Position(constant.caseCLOffset - constant.topOffset, 0, -constant.pivotOffset + constant.length + constant.nut.ShapeLength), new Vector(1, 0, 0), new Vector(0, 0, 1));
                    ...
                    case 2:     //Vertical Casing Below Frame
                        port = new Port(OccurrenceConnection, part, "RodEnd1", new Position(-constant.topOffset, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1 - constant.offset1), new Vector(1, 0, 0), new Vector(0, 0, 1));
                        m_PhysicalAspect.Outputs["RodEnd1"] = port;
                        if(suspension == 2)
                        {
                            port = new Port(OccurrenceConnection, part, "RodEnd2", new Position(-constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1 - constant.offset1), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["RodEnd2"] = port;

                            port = new Port(OccurrenceConnection, part, "Top2", new Position(-constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1 + constant.nut.ShapeLength), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["Top2"] = port;
                        }
                        else        //need to include the second port - it will be at the same position as the first
                        {
                            port = new Port(OccurrenceConnection, part, "RodEnd2", new Position(-constant.topOffset, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1 - constant.offset1), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["RodEnd2"] = port;

                            port = new Port(OccurrenceConnection, part, "Top2", new Position(-constant.topOffset, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1 + constant.nut.ShapeLength), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["Top2"] = port;
                        }
                        port = new Port(OccurrenceConnection, part, "Top1", new Position(-constant.topOffset, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1 + constant.nut.ShapeLength), new Vector(1, 0, 0), new Vector(0, 0, 1));
                        m_PhysicalAspect.Outputs["Top1"] = port;
                    ...
                    case 3:     //Horizontal Casing Beside Frame
                        ...
                        port = new Port(OccurrenceConnection, part, "RodEnd1", new Position(-constant.topOffset, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset - constant.offset1 - vTop1Offset), new Vector(1, 0, 0), new Vector(0, 0, 1));
                        m_PhysicalAspect.Outputs["RodEnd1"] = port;
                        if(suspension == 2)
                        {
                            if (constant.topOffset - constant.topSpacing > constant.pivotOffset)
                                vTop2Offset = constant.frameOffset;
                            port = new Port(OccurrenceConnection, part, "RodEnd2", new Position(-constant.topOffset + constant.topSpacing, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset - constant.offset1 - vTop2Offset), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["RodEnd2"] = port;

                            port = new Port(OccurrenceConnection, part, "Top2", new Position(-constant.topOffset + constant.topSpacing, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset + constant.nut.ShapeLength - vTop2Offset), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["Top2"] = port;
                        }
                        else        //need to include the second port - it will be at the same position as the first
                        {
                            if (constant.topOffset > constant.pivotOffset)
                                vTop1Offset = constant.frameOffset;
                            port = new Port(OccurrenceConnection, part, "RodEnd2", new Position(-constant.topOffset, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset - constant.offset1 - vTop1Offset), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["RodEnd2"] = port;

                            port = new Port(OccurrenceConnection, part, "Top2", new Position(-constant.topOffset, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset + constant.nut.ShapeLength - vTop1Offset), new Vector(1, 0, 0), new Vector(0, 0, 1));
                            m_PhysicalAspect.Outputs["Top2"] = port;
                        }
                        port = new Port(OccurrenceConnection, part, "Top1", new Position(-constant.topOffset, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset + constant.nut.ShapeLength - vTop1Offset), new Vector(1, 0, 0), new Vector(0, 0, 1));
                        m_PhysicalAspect.Outputs["Top1"] = port;
                ...
                switch (config)
                {
                    case 1:     //Vertical Casing Above Frame
                        ...
                        //Tops
                        matrix = new Matrix4X4();
                        matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset, 0, -constant.pivotOffset + constant.length));
                        AddNut(constant.nut, matrix, m_PhysicalAspect.Outputs, "Nut1");
                        if(suspension == 2)
                        {
                            matrix = new Matrix4X4();
                            matrix.Translate(new Vector(constant.caseCLOffset - constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.length));
                            AddNut(constant.nut, matrix, m_PhysicalAspect.Outputs, "Nut2");
                        }
                        break;
                    case 2:     //Vertical Casing Below Frame
                        //Frame
                        ...
                        //Tops
                        matrix = new Matrix4X4();
                        matrix.Translate(new Vector(-constant.topOffset, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1));
                        AddNut(constant.nut, matrix, m_PhysicalAspect.Outputs, "Nut1");
                        if(suspension == 2)
                        {
                            matrix = new Matrix4X4();
                            matrix.Translate(new Vector(-constant.topOffset + constant.topSpacing, 0, -constant.pivotOffset + constant.frame.length1 + constant.plate3.thickness1));
                            AddNut(constant.nut, matrix, m_PhysicalAspect.Outputs, "Nut2");
                        }
                        break;
                    case 3:     //Horizontal Casing Beside Frame
                        ...
                        //Tops
                        matrix = new Matrix4X4();
                        matrix.Translate(new Vector(-constant.topOffset, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset - vTop1Offset));
                        AddNut(constant.nut, matrix, m_PhysicalAspect.Outputs, "Nut1");
                        if(suspension == 2)
                        {
                            matrix = new Matrix4X4();
                            matrix.Translate(new Vector(-constant.topOffset + constant.topSpacing, 0, constant.caseCLOffset + constant.casing.ShapeWidth1 / 2 + constant.frameOffset - vTop2Offset));
                            AddNut(constant.nut, matrix, m_PhysicalAspect.Outputs, "Nut2");
                        }
                        break;
                }
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of TypeA."));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in Weight CG of TypeA."));
                    return;
                }
            }
        }
