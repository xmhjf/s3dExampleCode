...
//
//   S3DWBABolt.cs
//    HSSmartPart,Ingr.SP3D.Content.Support.Symbols.S3DWBABolt
//   Author       :  Vijaya
...
//   -----------     ---     ------------------
//   13-Dec-2012    Vijaya   Initial Creation
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class S3DWBABolt : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "HSSmartPart,Ingr.SP3D.Content.Support.Symbols.S3DWBABolt"
        //----------------------------------------------------------------------------------
        ...
        public override IEnumerable<Input> AdditionalInputs
        {
            get
            {
                ...
                AddWBABoltInputs(3, out endIndex, additionalInputs);
        ...
        public override IEnumerable<OutputDefinition> AdditionalOutputs(string aspectName)
        {
            ...
            {
                AddWBABoltOutputs(aspectName, additionalOutputs);
            }
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                WBABoltInputs wbaBolt = LoadWBABoltData(3);
                ...
                Port port2 = new Port(OccurrenceConnection, part, "Pin", new Position(0, 0, -(wbaBolt.Height2 + wbaBolt.Thickness3)), new Vector(1, 0, 0), new Vector(0, 0, -1));
                m_PhysicalAspect.Outputs["Port2"] = port2;

                AddWBABolt(wbaBolt, matrix, m_PhysicalAspect.Outputs, "WBABolt");
            }
            catch //General Unhandled exception 
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of WBABoltt"));
                }
            }
        }
        #endregion
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in WeightCG of WBABoltt"));
                }
            }
        }
        #endregion
