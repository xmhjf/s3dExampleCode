...
//
//   LugPlate.cs
//   HSSmartPart,Ingr.SP3D.Content.Support.Symbols.LugPlate
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class LugPlate : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                LugPlateInputs lugplate = LoadLugPlateData(startindex, out endIndex);
                ...
                Port Hole = new Port(OccurrenceConnection, part, "Hole", new Position(0, 0, -lugplate.Offset1), new Vector(0, 1, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Hole"] = Hole;

                AddLugPlate(lugplate, new Matrix4X4(), m_Symbolic.Outputs, "LugPlate");
