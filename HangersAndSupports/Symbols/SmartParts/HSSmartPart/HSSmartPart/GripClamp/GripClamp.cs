...
//
//   GripClamp.cs
//    HSSmartPart,Ingr.SP3D.Content.Support.Symbols.GripClamp
//   Author       :  Vinod Peddi
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class GripClamp : SmartPartComponentDefinition,ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "HSSmartPart,Ingr.SP3D.Content.Support.Symbols.GripClamp"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                GripClampInputs gripclamp = LoadGripClampData(startindex, out endIndex);
                ...
                Port Hole = new Port(OccurrenceConnection, part, "Hole", new Position(0, 0, gripclamp.Height1 - gripclamp.Offset3), new Vector(0, 1, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Hole"] = Hole;

               AddGripClamp(gripclamp,new Matrix4X4(), m_Symbolic.Outputs, "GripClamp");
            ...
            catch
            {
                ...
                {
                    RaiseSmartPartTDLError(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of GripClamp.");
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in Weight CG of GripClamp"));
                }
            }
        }
        #endregion
