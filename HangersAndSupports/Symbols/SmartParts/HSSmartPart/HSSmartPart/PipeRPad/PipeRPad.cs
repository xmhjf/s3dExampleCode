...
//   Description: Elliptical Reinforcement Pad for Straight Pipe
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class PipeRPad : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "HSSmartPart,Ingr.SP3D.Content.Support.Symbols.PipeRPad"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                //=================================================
                PipeRPadInputs rpad = LoadPipeRPadData(2);
                ...
                Port port2 = new Port(OccurrenceConnection, part, "Weld1", new Position(rpad.Length/2, 0, rpad.PipeOD/2), new Vector(1, 0, 0), new Vector(0, 0, 1));
                m_PhysicalAspect.Outputs["Port2"] = port2;

                // Add the Pipe R-Pad Geometry Outputs
                Matrix4X4 matrix = new Matrix4X4();
                matrix.SetIdentity();
                AddPipeRPad(rpad, matrix, m_PhysicalAspect.Outputs, "RPad");
            }
            catch //General Unhandled exception 
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PipeRPad"));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in Weight CG of Pipe R-Pad"));
                }
            }
        }
        #endregion
