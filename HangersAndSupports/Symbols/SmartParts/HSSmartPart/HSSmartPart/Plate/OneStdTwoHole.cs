...
//
//   OneStdTwoHole.cs
//   HSSmartPart,Ingr.SP3D.Content.Support.Symbols.OneStdTwoHole
//   Author       :  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class OneStdTwoHole : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "HSSmartPart,Ingr.SP3D.Content.Support.Symbols.OneStdTwoHole"
        //----------------------------------------------------------------------------------
        ...
        public override IEnumerable<Input> AdditionalInputs
        {
            get
            {
                ...
                AddHolePortInputs(endIndex, 2, out endIndex, additionalInputs);
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                int numberOfStandardPorts = 1,numberOfRoutePorts = 2,numberOfHolePorts = 2;
                ...
                for (int i = 0; i < numberOfRoutePorts; i++)
                {
                    if (i > 0)
                        thicknessPos = plate.thickness1;
                    matrix.SetIdentity();
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of OneStdTwoHole"));
                    return;
                }
            }
        }
        ...
        public void EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in Weight CG of OneStdTwoHole"));
                }
            }
        }
        #endregion
