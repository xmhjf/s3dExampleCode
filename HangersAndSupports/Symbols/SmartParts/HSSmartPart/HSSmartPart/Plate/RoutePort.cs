...
//
//   RoutePort.cs
//   HSSmartPart,Ingr.SP3D.Content.Support.Symbols.RoutePort
//   Author       :  BS
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class RoutePort : SmartPartComponentDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "HSSmartPart,Ingr.SP3D.Content.Support.Symbols.RoutePort"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (part.SupportsInterface("IJUAhsCurvedEndType"))
                    plate.curvedEndType = (int)GetDoubleInputValue(41);
                ...
                m_PhysicalAspect.Outputs["Route"] = routePort1;
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of RoutePort"));
                    return;
                }
            }
        }
        ...
        public void EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrWeightCG, "Error in Weight CG of RoutePort"));
                }
            }
        }
        #endregion
