...
//
//   Rod.cs
//    PSLBOM,Ingr.SP3D.Content.Support.Symbols.StrutSNC
//   Author       :  PVK
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class StrutSNC : ICustomHgrBOMDescription
    {
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                double lengthValue, minlen,maxlen,setposition;

                lengthValue = (double)((PropertyValueDouble)catalogPart.GetPropertyValue("IJOAHgrOccLength", "Length")).PropValue;
                setposition = (double)((PropertyValueDouble)oSupportOrComponent.GetPropertyValue("IJOAHgrSetPosition", "SetPosition")).PropValue;
                lengthValue = lengthValue + setposition;
            ...
            {
                ToDoListMessage ToDolistMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, PSLBOMLocalizer.GetString(PSLBOMResourceIDs.ErrBOMDescription, "Error in BOMDescription of StructSNC."));
            }
