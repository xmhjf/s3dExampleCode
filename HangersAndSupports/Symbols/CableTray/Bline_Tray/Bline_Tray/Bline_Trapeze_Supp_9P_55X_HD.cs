...
//
//   Bline_Trapeze_Supp_9P_55X_HD.cs
//   Bline_Tray,Ingr.SP3D.Content.Support.Symbols.Bline_Trapeze_Supp_9P_55X_HD
//   Author       :  Vijaya
...
//   -----------     ---     ------------------
//   10.August.2012  Vijaya     CR-CP-219113 Converted HS_B-Line VB project to C#.Net Project 
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class Bline_Trapeze_Supp_9P_55X_HD : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Bline_Tray,Ingr.SP3D.Content.Support.Symbols.Bline_Trapeze_Supp_9P_55X_HD"
        //----------------------------------------------------------------------------------
        ...
        [SymbolOutput("CHANNEL2", "CHANNEL2")]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Projection3d channel = new Projection3d( new LineString3d(pointCollection), projectionVector, projectionVector.Length, true);
                m_Symbolic.Outputs["CHANNEL"] = channel;
                pointCollection.Clear();

                //Add Extruded U-Shape for BOTTOM CHANNEL

                pointCollection.Add(new Position(-CW / 2, -(0.5 * 0.0254) - WH, -CH));
                pointCollection.Add(new Position(CW / 2, -(0.5 * 0.0254) - WH, -CH));
                pointCollection.Add(new Position(CW / 2, -(0.5 * 0.0254) - WH, -2 * CH));
                pointCollection.Add(new Position(CW / 2 - CT, -(0.5 * 0.0254) - WH, -2 * CH));
                pointCollection.Add(new Position(CW / 2 - CT, -(0.5 * 0.0254) - WH, -CH - CT));
                pointCollection.Add(new Position(-CW / 2 + CT, -(0.5 * 0.0254) - WH, -CH - CT));
                pointCollection.Add(new Position(-CW / 2 + CT, -(0.5 * 0.0254) - WH, -2 * CH));
                pointCollection.Add(new Position(-CW / 2, -(0.5 * 0.0254) - WH, -2 * CH));
                ...
                projectionVector.Set(0, CCL, 0);
                Projection3d channel2 = new Projection3d( new LineString3d(pointCollection), projectionVector, projectionVector.Length, true);
                m_Symbolic.Outputs["CHANNEL2"] = channel2;
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, Bline_TrayLocalizer.GetString(Bline_TraySymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of Bline_Trapeze_Supp_9P_55X_HD."));
                    return;
                }
            }
        }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                PropertyValueCodelist inside_OutsideCodelist, clamp_GuideCodelist, holePatternCodelist;
                ...
                holePatternCodelist = (PropertyValueCodelist)oSupportOrComponent.GetPropertyValue("IJOAHgrBlineHDTrChProp", "HolePattern");
                ...
                bomDescription = catalogPart.PartDescription + ", " + clamp_Guide + ": " + inside_Outside + "," + " Cut Length: " + cutLength + ", Hole Pattern: " + holePattern;
                return bomDescription;
            }
            catch
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, Bline_TrayLocalizer.GetString(Bline_TraySymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of Bline_Trapeze_Supp_9P_55X_HD."));
                return "";
            }
        }
        #endregion
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                ...
                double clampWeight = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJUAHgrBlineHDTrHWWeight", "HDTrapeze_HW_Weight")).PropValue;
                ...
                PropertyValueCodelist holePatternCodeList = ((PropertyValueCodelist)supportComponentBO.GetPropertyValue("IJOAHgrBlineHDTrChProp", "HolePattern"));
                ...
                PropertyValueCodelist materialCodeList = ((PropertyValueCodelist)supportComponentBO.GetPropertyValue("IJOAHgrBlineHDTrChProp", "Material"));
