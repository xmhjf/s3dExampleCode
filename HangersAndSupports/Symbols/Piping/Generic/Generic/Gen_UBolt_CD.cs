...
//
//   Gen_UBolt_CD.cs
//    Generic,Ingr.SP3D.Content.Support.Symbols.Gen_UBolt_CD
//   Author       : Hema 
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class Gen_UBolt_CD : HangerComponentSymbolDefinition, ICustomHgrBOMDescription
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Generic,Ingr.SP3D.Content.Support.Symbols.Gen_UBolt_CD"
        //----------------------------------------------------------------------------------
        ...
        [InputString(10, "UBoltType", "UBoltType", "C")]
        public InputString m_oUBoltType;
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                String type = m_oUBoltType.Value;
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(0, P1 / 2, -pipeRadius - T);
                symbolGeometryHelper.SetOrientation(new Vector(0, 0, -1), new Vector(1, 0, 0));
                ...
                Outputstring[4] = "LEFTNUT1";

                if (type == "D")
                {
                    symbolGeometryHelper = new SymbolGeometryHelper();
                    symbolGeometryHelper.ActivePosition = new Position(0, P1 / 2, -pipeRadius);
                    symbolGeometryHelper.SetOrientation(new Vector(0, 0, 1), new Vector(1, 0, 0));
            ...
            catch    //General Unhandled exception
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, GenericLocalizer.GetString(GenericResourceIdentifiers.ErrConstructOutputs, "Error in ConstructOutputs of Gen_UBolt_CD"));
                    return;
                }
            }
        }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, GenericLocalizer.GetString(GenericResourceIdentifiers.ErrBOMDescription, "Error in BOMDescription of Gen_UBolt_CD"));
                }
                return "";
            }
        }
