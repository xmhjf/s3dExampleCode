...
//
//   LRParts_FIG140N.cs
//    LRParts,Ingr.SP3D.Content.Support.Symbols.LRParts_FIG140N
//   Author       :  Hema
...
//   -----------     ---     ------------------
//   24-10-2012      Hema    Initial Creation
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class LRParts_FIG140N : CustomSymbolDefinition,ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "LRParts,Ingr.SP3D.Content.Support.Symbols.LRParts_FIG140N"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Projection3d rod = (Projection3d)symbolGeometryHelper.CreateCylinder(null, rodDiameter / 2, length);
                m_Symbolic.Outputs["ROD"] = rod;
            }
            catch  //General Unhandled exception 
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, LRPartsLocalizer.GetString(LRPartsResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of LRParts_FIG140N.cs."));
                return;
            }
        }
        #endregion
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                ...
                double weightPerUnitlength = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJUAHgrLRParts_FIG140N", "WEIGHT_PER_LENGTH")).PropValue;
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, LRPartsLocalizer.GetString(LRPartsResourceIDs.ErrWeightCG, "Error in WeightCG of LRParts_FIG140N.cs."));
            }
        }
        #endregion
    }
