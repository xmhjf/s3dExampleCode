...
//
//   LRParts_FIG290N.cs
//    LRParts,Ingr.SP3D.Content.Support.Symbols.LRParts_FIG290N
//   Author       :Sasidhar 
...
//   -----------     ---     ------------------
//   23-10-2012     Sasidhar  Initial Creation
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class LRParts_FIG290N : CustomSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "LRParts,Ingr.SP3D.Content.Support.Symbols.LRParts_FIG290N"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Port p1 = new Port(OccurrenceConnection, part, "InThdRH", new Position(0, 0, 0), new Vector(1, 0, 0), new Vector(0, 0, -1));
                m_Symbolic.Outputs["Port1"] = p1;
                Port p2 = new Port(OccurrenceConnection, part, "Eye", new Position(0, 0, A / 2 - E), new Vector(1, 0, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Port2"] = p2;
                ...
                Projection3d elli3d = new Projection3d( ellipse, normal, G, true);
                m_Symbolic.Outputs["ELLIP"] = elli3d;
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, LRPartsLocalizer.GetString(LRPartsResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of LRParts_FIG290N.cs."));
                return;
            }
        }
        #endregion
