...
//
//   LRParts_FIG212N.cs
//    LRParts,Ingr.SP3D.Content.Support.Symbols.LRParts_FIG212N
//   Author       :  Hema
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class LRParts_FIG212N : CustomSymbolDefinition, ICustomHgrBOMDescription
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "LRParts,Ingr.SP3D.Content.Support.Symbols.LRParts_FIG212N"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, LRPartsLocalizer.GetString(LRPartsResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of LRParts_FIG212N.cs."));
                return;
            }
        }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, LRPartsLocalizer.GetString(LRPartsResourceIDs.ErrInvalidCodeListValue, "FINISH code list value should be between 1 and 2."));
                    finishCodelist.PropValue = 1;
                }

                string finishValue = finishCodelist.PropertyInfo.CodeListInfo.GetCodelistItem(finishCodelist.PropValue).DisplayName;
                Part lrPart = (Part)oSupportOrComponent.GetRelationship("madeFrom", "part").TargetObjects[0];

                BOMString = lrPart.PartDescription + ", Finish: " + finishValue;
                return BOMString;
            }
            catch
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, LRPartsLocalizer.GetString(LRPartsResourceIDs.ErrBOMDescription, "Error in BOMDescription of LRParts_FIG212N.cs."));
                return "";
            }
        }
