...
//
//   SFS5856.cs
//    FINL_Parts,Ingr.SP3D.Content.Support.Symbols.SFS5856
//   Author       :   Rajeswari
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class SFS5856 : HangerComponentSymbolDefinition, ICustomHgrBOMDescription
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "FINL_Parts,Ingr.SP3D.Content.Support.Symbols.SFS5856"
        //----------------------------------------------------------------------------------
        ...
        [InputDouble(15, "Temperature", "Temperature", 0.999999)]
        public InputDouble m_dTemperature;
        [InputString(16, "Material", "Material", "No Value")]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Port port2 = new Port(OccurrenceConnection, part, "Pin1", new Position(0, 0, A / 2.0), new Vector(1, 0, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Port2"] = port2;
                Port port3 = new Port(OccurrenceConnection, part, "Pin2", new Position(0, 0, -A / 2.0), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                Projection3d top1 = (Projection3d)symbolGeometryHelper.CreateBox(null, T, B, (A / 2.0 - pipeDiameter / 2.0) + C, 9);
                m_Symbolic.Outputs["TOP1"] = top1;

                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(F / 2.0, -B / 2.0, pipeDiameter / 2.0);
                Projection3d top2 = (Projection3d)symbolGeometryHelper.CreateBox(null, T, B, (A / 2.0 - pipeDiameter / 2.0) + C, 9);
                m_Symbolic.Outputs["TOP2"] = top2;

                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(-(F / 2.0 + T), -B / 2.0, -L / 2.0);
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(F / 2.0, -B / 2.0, -L / 2.0);
                ...
                Vector normal = new Position(boltL / 2.0, 0, A / 2.0).Subtract(new Position(-boltL / 2.0, 0, A / 2.0));
                symbolGeometryHelper = new SymbolGeometryHelper();
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, FINL_PartsLocalizer.GetString(FINL_PartsSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of SFS5856.cs."));
                return;
            }
        }
        #endregion
         ...
         public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                bomDescription = "Pipe clamp D SFS 5856 DN " + pipeNDArray[0];

                return bomDescription;
            }
            catch
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, FINL_PartsLocalizer.GetString(FINL_PartsSymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of SFS5856.cs."));
                return "";
            }
        }
        #endregion
