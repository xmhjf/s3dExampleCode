...
//
//   StandardPlate.cs
//   HgrOglaendParts,Ingr.SP3D.Content.Support.Symbols.StandardPlate
//   Author       :  PVS	
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class StandardPlate : CustomSymbolDefinition, ICustomHgrWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "HgrOglaendParts,Ingr.SP3D.Content.Support.Symbols.StandardPlate"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Port oStructurePort = new Port(connection, part, "Structure", new Position(width / 2, thickness / 2, length), new Vector(1, 0, 0), new Vector(0, 0, 1));
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ...
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, OglaendPartLocalizer.GetString(OglaendPartSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of StandardPlate.cs " + myType.Assembly.FullName + "," + myType.Namespace + "." + myType.Name));
                }
            }
