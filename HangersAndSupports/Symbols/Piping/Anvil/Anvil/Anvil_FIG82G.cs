...
//
//   Anvil_FIG82G.cs
//   Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG82G
//   Author       :  Hema
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Anvil_FIG82G : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG82G"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                double sectionWidth = 0, sectionDepth = 0, takeOut;
                if (P == 0)
                    P = m_dP.Value;
                ...
                PartClass anvilfig82GParts = (PartClass)catalogBaseHelper.GetPartClass("Anvil_C_SECTION");
                ReadOnlyCollection<BusinessObject> fig282GParts = anvilfig82GParts.GetRelationship("PartClassContainsClassItems", "ClassItem").TargetObjects;

                foreach (BusinessObject part1 in fig282GParts)
                {
            ...
            catch       //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrConstructOutputs, "Error in constructOutputs of Anvil_FIG82G"));
                    return;
                }
            }
        }
