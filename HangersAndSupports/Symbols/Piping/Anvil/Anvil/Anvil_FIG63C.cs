...
//
//   Anvil_FIG63C.cs
//   Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG63C
//   Author       :  Hema
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Anvil_FIG63C : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG63C"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                PartClass anvilfig63CClass = (PartClass)catalogBaseHelper.GetPartClass("Anvil_FIG63_DIA");
                ReadOnlyCollection<BusinessObject> fig63AClass = anvilfig63CClass.GetRelationship("PartClassContainsClassItems", "ClassItem").TargetObjects;
                ...
                if (HgrCompareDoubleService.cmpdbl(E , 0)==true)
                {
            ...
            catch       //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrConstructOutputs, "Error in constructOutputs of Anvil_FIG63C"));
                    return;
                }
            }
        }
