...
//
//   Anvil_FIG256.cs
//   Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG256
//   Author       : Vijaya 
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Anvil_FIG256 : HangerComponentSymbolDefinition, ICustomHgrBOMDescription
    {

        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG256"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                PartClass anvilFIG2563 = (PartClass)catalogBaseHelper.GetPartClass("Anvil_FIG256_INSUL"), anvilFIG2564 = (PartClass)catalogBaseHelper.GetPartClass("Anvil_FIG256_SIZE");

                ReadOnlyCollection<BusinessObject> anvilFIG2563Classes = anvilFIG2563.GetRelationship("PartClassContainsClassItems", "ClassItem").TargetObjects, anvilFIG2564Classes = anvilFIG2564.GetRelationship("PartClassContainsClassItems", "ClassItem").TargetObjects;
                foreach (BusinessObject classItem in anvilFIG2563Classes)
                {
                    if (((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "INSUL_T")).PropValue) >= actualInsulation - 0.001 && ((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "INSUL_T")).PropValue) <= actualInsulation + 0.001 && ((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "PIPE_DIA")).PropValue) >= pipeDiameter - 0.001 && ((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "PIPE_DIA")).PropValue) <= pipeDiameter + 0.001)
                    {
                        size = (string)((PropertyValueString)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "SIZE")).PropValue;
                        break;
                    }
                }
                foreach (BusinessObject classItem in anvilFIG2564Classes)
                {
                    if (((string)((PropertyValueString)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_SIZE", "SIZE")).PropValue == size))
                    {
                        B = (double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_SIZE", "B")).PropValue;
                        D = (double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_SIZE", "D")).PropValue;
                        E = (double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_SIZE", "E")).PropValue;
                        G = (double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_SIZE", "G")).PropValue;
                        T = (double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_SIZE", "T")).PropValue;
                        break;
                    }
                }

                double calc = Math.Sqrt(((B / 2) * (B / 2)) - ((E / 3) * (E / 3))), legHeight = (B / 2 - calc) + (D - B / 2);
            ...
            catch  //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrConstructOutputs, "Error in constructOutputs of Anvil_FIG256"));
                    return;
                }
            }
        }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                PropertyValueCodelist insulationCodeList = (PropertyValueCodelist)oSupportOrComponent.GetPropertyValue("IJOAHgrAnvil_FIG256", "INSUL");
                ...
                if (metadataManager != null)
                    ...
                    actualInsulation = 0.0254;
                CatalogBaseHelper catalogBaseHelper = new CatalogBaseHelper();
                PartClass anvilFIG2563 = (PartClass)catalogBaseHelper.GetPartClass("Anvil_FIG256_INSUL");
                ReadOnlyCollection<BusinessObject> anvilFIG2563Classes = anvilFIG2563.GetRelationship("PartClassContainsClassItems", "ClassItem").TargetObjects;
                foreach (BusinessObject classItem in anvilFIG2563Classes)
                {
                    if (((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "INSUL_T")).PropValue) >= actualInsulation - 0.001 && ((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "INSUL_T")).PropValue) <= actualInsulation + 0.001 && ((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "PIPE_DIA")).PropValue) >= pipeDiameter - 0.001 && ((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAnvil_FIG256_INSUL", "PIPE_DIA")).PropValue) <= pipeDiameter + 0.001)
                    {
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrBOMDescription, "Error in BOM description of Anvil_FIG256"));
                return "";
            }
        }
        #endregion
