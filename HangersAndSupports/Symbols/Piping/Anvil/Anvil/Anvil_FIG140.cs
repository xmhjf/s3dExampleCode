...
//
//   Anvil_FIG140.cs
//    Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG140
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Anvil_FIG140 : HangerComponentSymbolDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG140"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Double weightPerLength = m_dWEIGHT_PER_LENGTH.Value;
                Double dUser = m_dD_USER.Value;
            ...
            catch  //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrConstructOutputs, "Error in constructOutputs of Anvil_FIG140"));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                ...
                double weightPerUnitLength = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrAnvil_fig140", "WEIGHT_PER_LENGTH")).PropValue;
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrWeightCG, "Error while defining weightCG of Anvil_FIG140"));
            }
        }
        #endregion
    }
