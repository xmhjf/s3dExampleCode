...
//
//   Anvil_FIG135.cs
//    Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG135
//   Author       :  Vijay
//   Creation Date:  30-04-2013
//   Description:
//   
//   Anvil_FIG135.cs is same for Anvil_FIG135E.cs
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Anvil_FIG135 : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG135"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            ...
            catch  //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrConstructOutputs, "Error in constructOutputs of Anvil_FIG135"));
                    return;
                }
            }
        }
