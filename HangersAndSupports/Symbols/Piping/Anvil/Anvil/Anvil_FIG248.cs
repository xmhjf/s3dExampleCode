...
//
//   Anvil_FIG248.cs
//   Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG248
//   Author       : Vijaya
//   Creation Date: 30-April-2013 
//   Description: Initial Creation-CR-CP-222292
//   
//   Anvil_FIG248.cs is same for Anvil_FIG278.cs
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Anvil_FIG248 : HangerComponentSymbolDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG248"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            ...
            catch  //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrConstructOutputs, "Error in constructOutputs of Anvil_FIG248"));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                ...
                if (supportComponentBO.SupportsInterface("IJOAHgrAnvil_FIG248"))
                    weightPerUnitLength = (double)((PropertyValueDouble)catalogPart.GetPropertyValue("IJOAHgrAnvil_FIG248", "WEIGHT_PER_LENGTH")).PropValue;
                else if (supportComponentBO.SupportsInterface("IJOAHgrAnvil_FIG278"))
                    weightPerUnitLength = (double)((PropertyValueDouble)catalogPart.GetPropertyValue("IJOAHgrAnvil_FIG278", "WEIGHT_PER_LENGTH")).PropValue;
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrWeightCG, "Error while defining weightCG of Anvil_FIG248"));
            }
        }
        #endregion
    }
