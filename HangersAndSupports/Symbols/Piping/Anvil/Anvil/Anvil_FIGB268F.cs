...
//
//   Anvil_FIGB268F.cs
//    Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIGB268F
//   Author       :  Rajeswari
...
//   08-08-2013      Vijay      DM-CP-238274 [TR]For Anvil 'F-Type Spring', Position of rollers is incorrect 
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Anvil_FIGB268F : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIGB268F"
        //----------------------------------------------------------------------------------
        ...
        [InputDouble(5, "TOP", "TOP", 1)]
        public InputDouble m_oTOP;
        [InputDouble(6, "ROLL_MATERIAL", "ROLL_MATERIAL", 1)]
        ...
        [InputDouble(13, "COL_DIA", "COL_DIA", 0.999999)]
        public InputDouble m_dCOL_DIA;
        [InputDouble(14, "FLANGE_T", "FLANGE_T", 0.999999)]
        public InputDouble m_dFLANGE_T;
        [InputDouble(15, "FLANGE_DIA", "FLANGE_DIA", 0.999999)]
        public InputDouble m_dFLANGE_DIA;
        [InputDouble(16, "X", "X", 0.999999)]
        public InputDouble m_dX;
        [InputDouble(17, "ADJ", "ADJ", 0.999999)]
        public InputDouble m_dADJ;
        [InputDouble(18, "COL_TYP", "COL_TYP", 1)]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                CodelistItem codelist = ((PropertyValueCodelist)part.GetPropertyValue("IJOAHgrAnvil_FIGB268F", "DIR")).PropertyInfo.CodeListInfo.GetCodelistItem((int)m_oDIR.Value);
                ...
                PartClass anvilfig268FParts = (PartClass)catalogBaseHelper.GetPartClass("Anvil_SPRING_RATE");
                ReadOnlyCollection<BusinessObject> fig268FParts, fig268FSpringRollerStrokeParts;
                fig268FParts = anvilfig268FParts.GetRelationship("PartClassContainsClassItems", "ClassItem").TargetObjects;
                foreach (BusinessObject part1 in fig268FParts)
                {
                    if (((string)((PropertyValueString)part1.GetPropertyValue("IJUAHgrAnvil_SPRING_RATE", "SIZE")).PropValue == m_oSIZE.Value))
                    {
                        springRate = (double)((PropertyValueDouble)part1.GetPropertyValue("IJUAHgrAnvil_SPRING_RATE", "RATE_B2")).PropValue;
                ...
                PartClass anvilfig268FSpringRollerParts = (PartClass)catalogBaseHelper.GetPartClass("Anvil_FSPRING_ROLLER");
                fig268FSpringRollerStrokeParts = anvilfig268FSpringRollerParts.GetRelationship("PartClassContainsClassItems", "ClassItem").TargetObjects;
                foreach (BusinessObject part1 in fig268FSpringRollerStrokeParts)
                {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrInvalidAPipeDiaPGTZero, "A value,Pipe diameter and P value should be greater than zero"));
                    return;
                }
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrConstructOutputs, "Error in constructOutputs of Anvil_FIG268F"));
                return;
            }
        }
        #endregion
