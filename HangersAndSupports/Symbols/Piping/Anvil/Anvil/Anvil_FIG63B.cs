...
//
//   Anvil_FIG63B.cs
//   Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG63B
//   Author       :  Hema
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Anvil_FIG63B : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Anvil,Ingr.SP3D.Content.Support.Symbols.Anvil_FIG63B"
        //----------------------------------------------------------------------------------
        ...
        [InputDouble(14, "J", "J", 0.999999)]
        public InputDouble m_dJ;
        [InputDouble(15, "K", "K", 0.999999)]
        public InputDouble m_dK;
        [InputDouble(16, "L", "L", 0.999999)]
        public InputDouble m_dL;
        [InputDouble(17, "M", "M", 0.999999)]
        public InputDouble m_dM;
        [InputDouble(18, "N", "N", 0.999999)]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                PartClass anvilfig63BClass = (PartClass)catalogBaseHelper.GetPartClass("Anvil_FIG63_DIA");
                ReadOnlyCollection<BusinessObject> fig63AClass = anvilfig63BClass.GetRelationship("PartClassContainsClassItems", "ClassItem").TargetObjects;
            ...
            catch       //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, AnvilLocalizer.GetString(AnvilSymbolResourceIDs.ErrConstructOutputs, "Error in constructOutputs of Anvil_FIG63B"));
                    return;
                }
            }
        }
