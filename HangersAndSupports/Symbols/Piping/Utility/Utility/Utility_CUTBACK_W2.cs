...
//
//   Utility_CUTBACK_W2.cs
//    Utility,Ingr.SP3D.Content.Support.Symbols.Utility_CUTBACK_W2
//   Author       :  Hema
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Utility_CUTBACK_W2 : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Utility,Ingr.SP3D.Content.Support.Symbols.Utility_CUTBACK_W2"
        //----------------------------------------------------------------------------------
        ...
        public InputString m_dBOM_DESC;
        #endregion
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                String bom_desc = m_dBOM_DESC.Value;
                ...
                if (angle > 0 && angle2 > 0)
                {
                    Z1 = (depth / 2.0) / (Math.Tan(angle));
                    Z4 = (depth / 2.0) / (Math.Tan(angle2));
                    Z2 = (depth / 2.0 - flangeThickness) / (Math.Tan(angle));
                    Z3 = (depth / 2.0 - flangeThickness) / (Math.Tan(angle2));
                }
                ...
                else
                {
                    ...
                    xDirX1 = 0;
                    xDirY1 = Math.Sin(angle2) / ((Math.Cos(angle2) * Math.Cos(angle2)) + (Math.Sin(angle2) * Math.Sin(angle2)));
                    xDirZ1 = Math.Cos(angle2) / ((Math.Cos(angle2) * Math.Cos(angle2)) + (Math.Sin(angle2) * Math.Sin(angle2)));
                    zDirX1 = 0;
                    zDirY1 = Math.Sin(Math.PI * (90 / ((float)180)) + angle2) / ((Math.Cos(Math.PI * (90 / ((float)180)) + angle) * Math.Cos(Math.PI * (90 / ((float)180)) + angle)) + (Math.Sin(Math.PI * (90 / ((float)180)) + angle) * Math.Sin(Math.PI * (90 / ((float)180)) + angle)));
                    zDirZ1 = Math.Cos(Math.PI * (90 / ((float)180)) + angle2) / ((Math.Cos(Math.PI * (90 / ((float)180)) + angle) * Math.Cos(Math.PI * (90 / ((float)180)) + angle)) + (Math.Sin(Math.PI * (90 / ((float)180)) + angle) * Math.Sin(Math.PI * (90 / ((float)180)) + angle)));
                    xDirX2 = 0;
                    xDirY2 = Math.Sin(-angle) / ((Math.Cos(-angle) * Math.Cos(-angle)) + (Math.Sin(-angle) * Math.Sin(-angle)));
                    xDirZ2 = Math.Cos(-angle) / ((Math.Cos(-angle) * Math.Cos(-angle)) + (Math.Sin(-angle) * Math.Sin(-angle)));
                    zDirX2 = 0;
                    zDirY2 = Math.Sin(Math.PI * (90 / ((float)180)) - angle) / ((Math.Cos(Math.PI * (90 / ((float)180)) + angle) * Math.Cos(Math.PI * (90 / ((float)180)) + angle)) + (Math.Sin(Math.PI * (90 / ((float)180)) - angle) * Math.Sin(Math.PI * (90 / ((float)180)) - angle)));
                ...
                Port port1 = new Port(OccurrenceConnection, part, "StartStructure", new Position(0, depth / 2.0, -Z1), new Vector(xDirX1, xDirY1, xDirZ1), new Vector(zDirX1, zDirY1, zDirZ1));
                ...
                if ((port2 != null))
                {
                    ...
                    port3.Origin = new Position(0, depth / 2, L + Z4);
                    port3.SetOrientation(new Vector(xDirX2, xDirY2, xDirZ2), new Vector(zDirX2, zDirY2, zDirZ2));
                    m_Symbolic.Outputs["Port3"] = port3;
                }
                else
                {
                    port3 = new Port(OccurrenceConnection, part, "EndStructure", new Position(0, depth / 2, L + Z4), new Vector(xDirX2, xDirY2, xDirZ2), new Vector(zDirX2, zDirY2, zDirZ2));
                ...
                pointCollection.Add(new Position(-width / 2.0, depth / 2.0 - flangeThickness, -Z2));
                pointCollection.Add(new Position(-width / 2.0, depth / 2.0 - flangeThickness, L + Z3));
                pointCollection.Add(new Position(-width / 2.0, depth / 2.0, L + Z4));
                pointCollection.Add(new Position(-width / 2.0, depth / 2.0, -Z1));
                ...
                pointCollection = new Collection<Position>();
                pointCollection.Add(new Position(-webThickness / 2.0, -depth / 2.0 + flangeThickness, L - Z3));
                pointCollection.Add(new Position(-webThickness / 2.0, -depth / 2.0 + flangeThickness, Z2));
                pointCollection.Add(new Position(-webThickness / 2.0, depth / 2.0 - flangeThickness, -Z2));
                pointCollection.Add(new Position(-webThickness / 2.0, depth / 2.0 - flangeThickness, L + Z3));
                pointCollection.Add(new Position(-webThickness / 2.0, -depth / 2.0 + flangeThickness, L - Z3));
                              
                projectionVector = new Vector(webThickness, 0, 0);
                body = new Projection3d(new LineString3d(pointCollection), projectionVector, projectionVector.Length, true);
            ...
            catch     //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of Utility_CUTBACK_W2"));
                    return;
                }
            }
        }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                double bomZ1, bomZ4, bomOrderLength;

                bomZ1 = (depthValue / 2) / Math.Tan((angleValue));
                bomZ4 = (depthValue / 2) / Math.Tan((angle2Value));

                bomOrderLength = LValue + bomZ1 + bomZ4;
                ...
                else
                {
                    ...
                    {
                        bomString = "Cutback W Section, Width = " + width + ", Depth = " + depth + ", Starting Angle = " + angle + ", Ending Angle = " + angle2 + ", Order Length = " + widthValue;
                    }
                    else
                    {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of Utility_CUTBACK_W2"));
                }
                return "";
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrWeightCG, "Error in WeightCG of Utility_CUTBACK_W2"));
                }
            }
        }
    }
