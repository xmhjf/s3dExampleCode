...
//
//   Utility_FOUR_HOLE_PLATE.cs
//    Utility,Ingr.SP3D.Content.Support.Symbols.Utility_FOUR_HOLE_PLATE
//   Author       :Sasidhar   
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class Utility_FOUR_HOLE_PLATE : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Utility,Ingr.SP3D.Content.Support.Symbols.Utility_FOUR_HOLE_PLATE"
        //----------------------------------------------------------------------------------
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                Double widthValue = (double)((PropertyValueDouble)oSupportOrComponent.GetPropertyValue("IJOAHgrUtility_FOUR_HOLE_PLATE", "WIDTH")).PropValue;
                Double depthValue = (double)((PropertyValueDouble)oSupportOrComponent.GetPropertyValue("IJOAHgrUtility_FOUR_HOLE_PLATE", "DEPTH")).PropValue;
                Double holeSizeValue = (double)((PropertyValueDouble)oSupportOrComponent.GetPropertyValue("IJOAHgrUtility_FOUR_HOLE_PLATE", "HOLE_SIZE")).PropValue;
                Double CValue = (double)((PropertyValueDouble)oSupportOrComponent.GetPropertyValue("IJOAHgrUtility_FOUR_HOLE_PLATE", "C")).PropValue;

                Part part = (Part)oSupportOrComponent.GetRelationship("madeFrom", "part").TargetObjects[0];
                Double thicknessValue = (double)((PropertyValueDouble)part.GetPropertyValue("IJUAHgrUtility_FOUR_HOLE_PLATE", "THICKNESS")).PropValue;
                ...
                bomString = thickness + " Plate Steel, " + width + " X " + depth + " 4 eq spaced " + holeSize + " dia. holes " + C + " from edges";
                return bomString;
            }
            catch
            {
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                ...
                Double width = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_FOUR_HOLE_PLATE", "WIDTH")).PropValue;
                Double depth = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_FOUR_HOLE_PLATE", "DEPTH")).PropValue;
                Double holesize = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_FOUR_HOLE_PLATE", "HOLE_SIZE")).PropValue;
                Double T = (Double)((PropertyValueDouble)part.GetPropertyValue("IJUAHgrUtility_FOUR_HOLE_PLATE", "THICKNESS")).PropValue;
