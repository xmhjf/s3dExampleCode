...
//
//   Utility_CUTBACK_L1.cs
//    Utility,Ingr.SP3D.Content.Support.Symbols.Utility_CUTBACK_L1
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Utility_CUTBACK_L1 : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Utility,Ingr.SP3D.Content.Support.Symbols.Utility_CUTBACK_L1"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (angle > 0 && angle2 > 0)
                {
                    ...
                    Z4 = width / Math.Tan(angle2);
                    Z2 = thickness / Math.Tan(angle2);
                    Z3 = width / Math.Tan(angle);
                }
                ...
                Port port1 = new Port(OccurrenceConnection, part, "StartStructure", new Position(0, 0, -Z3 / 2), new Vector(-zDirX1, -zDirY1, -zDirZ1), new Vector(-xDirX1, -xDirY1, -xDirZ1));
                ...
                {
                    port3 = new Port(OccurrenceConnection, part, "EndStructure", new Position(0, 0, L + Z4 / 2), new Vector(zDirX2, zDirY2, zDirZ2), new Vector(xDirX2, xDirY2, xDirZ2));
                ...
                pointCollection.Add(new Position(width, 0, L - (Z4 / 2)));
                pointCollection.Add(new Position(width, 0, Z3 / 2));
                pointCollection.Add(new Position(0, 0, -Z3 / 2));

                Vector projectionVector = new Vector(0, thickness, 0);
                ...
                pointCollection.Add(new Position(0, thickness, -Z3 / 2));
                pointCollection.Add(new Position(0, thickness, L + (Z4 / 2)));
                pointCollection.Add(new Position(thickness, thickness, L + (Z4 / 2) - Z2));
                pointCollection.Add(new Position(thickness, thickness, (-Z3 / 2) + Z1));
                pointCollection.Add(new Position(0, thickness, -Z3 / 2));

                projectionVector = new Vector(0, depth - thickness, 0);
            ...
            catch     //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of Utility_CUTBACK_L1"));
                    return;
                }
            }
        }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                bomZ3 = widthValue / Math.Tan(angleValue);
                bomZ4 = widthValue / Math.Tan(angle2Value);
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of Utility_CUTBACK_L1"));
                }
                return "";
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                Double weight, cogX, cogY, cogZ, extraWebVolumeEnd, extraWebVolumeStart;
                ...
                double area = thickness * width + thickness * (depth - thickness);
                double volume = area * L;

                if ((angle * 180 / Math.PI) > 0)
                {
                    extraWebVolumeStart = ((thickness * thickness) / (2 * Math.Tan(angle)) + thickness * ((width / 2 - thickness) / Math.Tan(angle))) * (depth - thickness);
                }
                else
                {
                ...
                {
                    extraWebVolumeEnd = ((thickness * thickness) / (2 * Math.Tan(angle2)) + thickness * ((width / 2 - thickness) / Math.Tan(angle2))) * (depth - thickness);
                }
                else
                {
                    extraWebVolumeEnd = 0;
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrWeightCG, "Error in WeightCG of Utility_CUTBACK_L1"));
                }
            }
        }
    }
