...
//
//   Utility_CUTBACK_C1.cs
//    Utility,Ingr.SP3D.Content.Support.Symbols.Utility_CUTBACK_C1
//   Author       : Vijay
...
//   -----------     ---     ------------------
//   01.11.2012    Vijay     CR-CP-222288  Converted HS_Utility VB Project to C# .Net  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Utility_CUTBACK_C1 : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG 
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Utility,Ingr.SP3D.Content.Support.Symbols.Utility_CUTBACK_C1"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (HgrCompareDoubleService.cmpdbl(webThickness, 0) == true)
                {
                ...
                if (angle > 0 && angle2 > 0)
                {
                    ...
                    Z3 = webThickness / (Math.Tan(angle));
                    Z4 = webThickness / (Math.Tan(angle2));
                }
               ...
               if (HgrCompareDoubleService.cmpdbl(angle, 0) == true)
                ...
                {
                    if (Math.Abs(angle * 180 / Math.PI) < 5 || HgrCompareDoubleService.cmpdbl(Math.Abs(angle * 180 / Math.PI), 180) == true)
                    {
                ...
                pointCollection.Add(new Position(-width / 2.0, -depth / 2.0 + flangeThickness, -Z1));
                pointCollection.Add(new Position(-width / 2.0, -depth / 2.0 + flangeThickness, L + Z2));
                pointCollection.Add(new Position(-width / 2.0 + webThickness, -depth / 2.0 + flangeThickness, L + Z2 - Z4));
                pointCollection.Add(new Position(-width / 2.0 + webThickness, -depth / 2.0 + flangeThickness, -Z1 + Z3));
                pointCollection.Add(new Position(-width / 2.0, -depth / 2.0 + flangeThickness, -Z1));
            ...
            catch
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of Utility_CUTBACK_C1"));
                    return;
                }
            }
        }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                string flangeThichness = MiddleServiceProvider.UOMMgr.FormatUnit(UnitType.Distance, flangeThicknessValue, UnitName.DISTANCE_INCH);
                ...
                double bomZ1 = (widthValue / 2) / Math.Tan((angleValue));
                double bomZ2 = (widthValue / 2) / Math.Tan((angle2Value));

                double bomOrderLength = LValue + Math.Abs(bomZ1) + Math.Abs(bomZ2);
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of Utility_CUTBACK_C1"));
                }
                return "";
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                ...
                {
                    extraWebVolumeStart = ((webThickness * webThickness) / (2 * Math.Tan(angle)) + webThickness * ((width / 2 - webThickness) / Math.Tan(angle))) * (depth - 2 * flangeThickness);
                }
                else
                {
                ...
                {
                    extraWebVolumeEnd = ((webThickness * webThickness) / (2 * Math.Tan(angle2)) + webThickness * ((width / 2 - webThickness) / Math.Tan(angle2))) * (depth - 2 * flangeThickness);
                }
                else
                {
                    extraWebVolumeEnd = 0;
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrWeightCG, "Error in WeightCG of Utility_CUTBACK_C1"));
                }
            }
        }
    }
