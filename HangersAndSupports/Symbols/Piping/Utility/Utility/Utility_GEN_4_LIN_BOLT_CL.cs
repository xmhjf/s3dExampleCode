...
//
//   Utility_GEN_4_LIN_BOLT_CL.cs
//    Utility,Ingr.SP3D.Content.Support.Symbols.Utility_GEN_4_LIN_BOLT_CL
//   Author       :  Hema
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Utility_GEN_4_LIN_BOLT_CL : HangerComponentSymbolDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Utility,Ingr.SP3D.Content.Support.Symbols.Utility_GEN_4_LIN_BOLT_CL"
        //----------------------------------------------------------------------------------
        ...
        [InputDouble(9, "BOLT_DIA2", "BOLT_DIA2", 0.999999)]
        public InputDouble m_dBOLT_DIA2;
        [InputDouble(10, "BOLT_L2", "BOLT_L2", 0.999999)]
        public InputDouble m_dBOLT_L2;
        [InputDouble(11, "T", "T", 0.999999)]
        public InputDouble m_dT;
        [InputDouble(12, "W", "W", 0.999999)]
        public InputDouble m_dW;
        [InputDouble(13, "OPT_BOM", "OPT_BOM", 1)]
        ...
        [SymbolOutput("MIDDLE_BOLT2", "MIDDLE_BOLT2")]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (bolt_L2 == 0)
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrInvalidBOlT2LENGTH, "Bolt Two Length cannot be zero"));
                    return;
                }
                ...
                symbolGeometryHelper.ActivePosition = new Position(0, -(H / 2 + T / 2), R);
                symbolGeometryHelper.SetOrientation(new Vector(0, 0, 1), new Vector(0, 1, 0));
                Projection3d top1 = (Projection3d)symbolGeometryHelper.CreateBox(null, A - R, T, W);
                m_Symbolic.Outputs["TOP1"] = top1;

                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(0, (H / 2 + T / 2), R);
                symbolGeometryHelper.SetOrientation(new Vector(0, 0, 1), new Vector(0, 1, 0));
                Projection3d top2 = (Projection3d)symbolGeometryHelper.CreateBox(null, A - R, T, W);
                m_Symbolic.Outputs["TOP2"] = top2;

                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(0, -(H / 2 + T / 2), -A);
                symbolGeometryHelper.SetOrientation(new Vector(0, 0, 1), new Vector(0, 1, 0));
                Projection3d bottom1 = (Projection3d)symbolGeometryHelper.CreateBox(null, A - R, T, W);
                m_Symbolic.Outputs["BOT1"] = bottom1;

                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(0, (H / 2 + T / 2), -A);
                symbolGeometryHelper.SetOrientation(new Vector(0, 0, 1), new Vector(0, 1, 0));
                Projection3d bottom2 = (Projection3d)symbolGeometryHelper.CreateBox(null, A - R, T, W);
                m_Symbolic.Outputs["BOT2"] = bottom2;

                symbolGeometryHelper = new SymbolGeometryHelper();
                Vector normal = new Position(0, -bolt_L / 2, K).Subtract(new Position(0, bolt_L / 2, K));
                symbolGeometryHelper.ActivePosition = new Position(0, -bolt_L / 2, K);
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                Vector normal1 = new Position(0, -bolt_L / 2, -K).Subtract(new Position(0, bolt_L / 2, -K));
                symbolGeometryHelper.ActivePosition = new Position(0, -bolt_L / 2, -K);
                symbolGeometryHelper.SetOrientation(new Vector(0, 1, 0), new Vector(1, 0, 0));
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                Vector normal2 = new Position(0, -bolt_L2 / 2, J).Subtract(new Position(0, bolt_L2 / 2, J));
                symbolGeometryHelper.ActivePosition = new Position(0, -bolt_L2 / 2, J);
                symbolGeometryHelper.SetOrientation(new Vector(0, 1, 0), new Vector(1, 0, 0));
                Projection3d middle_bolt = (Projection3d)symbolGeometryHelper.CreateCylinder(null, bolt_Dia2 / 2, normal2.Length);
                m_Symbolic.Outputs["MIDDLE_BOLT"] = middle_bolt;

                symbolGeometryHelper = new SymbolGeometryHelper();
                Vector normal3 = new Position(0, -bolt_L2 / 2, -J).Subtract(new Position(0, bolt_L2 / 2, -J));
                symbolGeometryHelper.ActivePosition = new Position(0, -bolt_L2 / 2, -J);
                symbolGeometryHelper.SetOrientation(new Vector(0, 1, 0), new Vector(1, 0, 0));
                Projection3d middle_bolt2 = (Projection3d)symbolGeometryHelper.CreateCylinder(null, bolt_Dia2 / 2, normal3.Length);
                m_Symbolic.Outputs["MIDDLE_BOLT2"] = middle_bolt2;
            ...
            catch     //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of Utility_GEN_4_LIN_BOLT_CL"));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                ...
                double R = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_4_LIN_BOLT_CL", "R")).PropValue;
                double A = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_4_LIN_BOLT_CL", "A")).PropValue;
                double H = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_4_LIN_BOLT_CL", "H")).PropValue;
                double boltDiameter = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_4_LIN_BOLT_CL", "BOLT_DIA")).PropValue;
                double boltL = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_4_LIN_BOLT_CL", "BOLT_L")).PropValue;
                double T = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_4_LIN_BOLT_CL", "T")).PropValue;
                double W = (double)((PropertyValueDouble)supportComponentBO.GetPropertyValue("IJOAHgrUtility_4_LIN_BOLT_CL", "W")).PropValue;
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, UtilityLocalizer.GetString(UtilitySymbolResourceIDs.ErrWeightCG, "Error in WeightCG of Utility_GEN_4_LIN_BOLT_CL"));
                }
            }
        }
    }
