...
//
//   Util_Fixed_Cyl_Metric.cs
//    Util_Metric,Ingr.SP3D.Content.Support.Symbols.Util_Fixed_Cyl_Metric
//   Author       :  Rajeswari
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class Util_Fixed_Cyl_Metric : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Util_Metric,Ingr.SP3D.Content.Support.Symbols.Util_Fixed_Cyl_Metric"
        //----------------------------------------------------------------------------------
        ...
        [InputString(4, "InputBomDesc", "InputBomDesc", "No Value")]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Projection3d body = (Projection3d)symbolGeometryHelper.CreateCylinder(null, radius, L);
                m_Symbolic.Outputs["BODY"] = body;
            }
            catch  //General Unhandled exception 
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, Util_MetricLocalizer.GetString(Util_MetricSymbolsResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of Util_Fixed_Cyl_Metric.cs."));
                return;
            }
        }
        #endregion
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                else
                {
                    if (inputBomDescription == null)
                        bomDescription = MiddleServiceProvider.UOMMgr.FormatUnit(UnitType.Distance, radius * 2.0, UnitName.DISTANCE_MILLIMETER) + " dia x " + MiddleServiceProvider.UOMMgr.FormatUnit(UnitType.Distance, L, UnitName.DISTANCE_MILLIMETER) + " long cylinder";
                    else
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, Util_MetricLocalizer.GetString(Util_MetricSymbolsResourceIDs.ErrBOMDescription, "Error in BOMDescription of Util_Fixed_Cyl_Metric.cs."));
                return "";
            }
        }
        #endregion
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, Util_MetricLocalizer.GetString(Util_MetricSymbolsResourceIDs.ErrWeightCG, "Error in WeightCG of Util_Fixed_Cyl_Metric.cs."));
            }
        }
        #endregion
    }
