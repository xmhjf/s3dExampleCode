...
//
//   ZVxBOM.cs
//   Witzenmann,Ingr.SP3D.Content.Support.Symbols.BeamClamp
//   Author       : Vinod  
    ...
    public class BeamClamp : SmartPartComponentDefinition, ICustomWeightCG
    {
        ...
        public override IEnumerable<Input> AdditionalInputs
        {
            get
            {
                ...
                additionalInputs.Add(new InputDouble(++endIndex, "Multi1Qty", "Multi1Qty", 1, true));
                additionalInputs.Add(new InputDouble(++endIndex, "Multi1LocateBy", "Multi1LocateBy", 1, true));
                additionalInputs.Add(new InputDouble(++endIndex, "Multi1Location", "Multi1Location", 0, true));
                additionalInputs.Add(new InputDouble(++endIndex, "StructureLength", "StructureLength", 0, true));
                additionalInputs.Add(new InputDouble(++endIndex, "BottomPlateWidth", "BottomPlateWidth", 0, true));
                additionalInputs.Add(new InputDouble(++endIndex, "BottomPlateThk", "BottomPlateThk", 0, true));
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                int qty = (int)GetDoubleInputValue(++startIndex);
                Double locateBy = GetDoubleInputValue(++startIndex);
                Double multiLocation = GetDoubleInputValue(++startIndex);
                Double structureLength = GetDoubleInputValue(++startIndex);
                Double bottomPlateWidth, bottomPlateThk;
                bottomPlateWidth = GetDoubleorDefaultValueonPart(part, "IJUAhsBottomPlt", "BottomPlateWidth", ++startIndex);
                bottomPlateThk = GetDoubleorDefaultValueonPart(part, "IJUAhsBottomPlt", "BottomPlateThk", ++startIndex);
                ...
                if (beamClamp.RightClipShape != "")
                {
                    if (beamClamp.LeftClipShape == "No Value")
                    {
                ...
                //Add Beam Clamp
                Double[] beamClampXLocation = new double[qty]; ;
                int i = 0;
                for (i = 0; i <= qty - 1; i++)
                {
                    beamClampXLocation[i] = MultiPosition(structureLength , qty, locateBy, multiLocation, leftBeamClip.ClipDepth)[i];
                    matrix = new Matrix4X4();
                    matrix.Origin = new Position(0, 0, 0);                 
                    beamClampXLocation[i] = beamClampXLocation[i] - structureLength / 2 ;
                    AddBeamClamp(beamClamp, flangeThickness, flangeWidth, height3, matrix, m_PhysicalAspect.Outputs, "BeamClamp" + i.ToString(), null,beamClampXLocation[i]);
                }
                ...
                if ((HgrCompareDoubleService.cmpdbl(width1 , 0) == false) && (HgrCompareDoubleService.cmpdbl(length1 , 0) == false) && (HgrCompareDoubleService.cmpdbl(thickness1 , 0) == false))
                {
                    switch (beamClamp.BottomShape)
                    {
                        case 1:     //I shape
                            ...
                            symbolGeometryHelper.ActivePosition = new Position(-width1 / 2, -length1 / 2, -thickness1 - vertOffset2-pin1Diameter);
                            ...
                            if (bottomPlateWidth > 0)
                            {
                                symbolGeometryHelper.ActivePosition = new Position(-structureLength / 2, -bottomPlateWidth / 2, (-thickness1 - vertOffset2 - pin1Diameter - bottomPlateThk));
                                symbolGeometryHelper.SetOrientation(new Vector(1, 0, 0), new Vector(0, 1, 0));

                                Projection3d bottomPlateShape = symbolGeometryHelper.CreateBox(null, structureLength, bottomPlateWidth, bottomPlateThk, 9);
                                m_PhysicalAspect.Outputs["BeamClampBottom1"] = bottomPlateShape;
                            }
                            break;
                        case 2:
                ...
                if ((beamClamp.LeftClipShape != "") && (beamClamp.RightClipShape != ""))
                {
                    //Add Pin
                    if ((HgrCompareDoubleService.cmpdbl(pin1Diameter , 0) == false) || (HgrCompareDoubleService.cmpdbl(pin1Length , 0) == false))
                    {
                        ...
                        {
                            cylinderMatrix.Translate(cylinderMatrix.Transform(new Vector(0, leftBeamClip.ClipThickness -pin1Diameter / 2, -pin1Length / 2)));
                            Projection3d pinCylinder = symbolGeometryHelper.CreateCylinder(null, pin1Diameter / 2, pin1Length);
                            pinCylinder.Transform(cylinderMatrix);
                            m_PhysicalAspect.Outputs["BeamClampPin"] = pinCylinder;
                        }
                ...
                if ((HgrCompareDoubleService.cmpdbl(uBoltWidth, 0) == false) && (HgrCompareDoubleService.cmpdbl(uBoltLength, 0) == false) && (HgrCompareDoubleService.cmpdbl(uBoltRodDia, 0) == false))
                {
                    ...
                    if ((beamClamp.LeftClipShape != "") && (beamClamp.RightClipShape == "No Value"))
                    {
                    ...
                    else if ((beamClamp.RightClipShape != "") && (beamClamp.LeftClipShape == "No Value"))
                    {
