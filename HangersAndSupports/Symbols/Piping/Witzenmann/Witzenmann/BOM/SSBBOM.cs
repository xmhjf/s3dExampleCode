...
//
//   ZVxBOM.cs
//   Witzenmann,Ingr.SP3D.Content.Support.Symbols.SSBBOM
//   Author       : Vinod  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class SSBBOM : SmartPartComponentDefinition, ICustomHgrBOMDescription
    {
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                if (lengthValue > 0)
                {
                    int strutNumber = (int)((PropertyValueInt)catalogPart.GetPropertyValue("IJUAhsWStrutNumber", "StrutNumber")).PropValue;
                    ...
                    bomDescription = "SSB" + " " + (nominalLoad/1000).ToString("0000") + "." + strutNumber.ToString("00") + "." + (lengthValue * 1000).ToString("0000") +"."+ design;
                }
            }
            catch//General Unhandled exception 
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrStrutABOMDescription, "Error in BOMDescription of SSBBOM.cs."));
            }
