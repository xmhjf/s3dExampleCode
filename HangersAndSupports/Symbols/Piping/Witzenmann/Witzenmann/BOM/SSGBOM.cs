...
//
//   ZVxBOM.cs
//   Witzenmann,Ingr.SP3D.Content.Support.Symbols.SSGBOM
///   Author       : Vinod  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class SSGBOM : SmartPartComponentDefinition, ICustomHgrBOMDescription
    {
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                if (lengthValue > 0)
                {
                    ...
                    bomDescription = "SSG" + " " +  (nominalLoad/1000).ToString ("0000") + "." + (lengthValue * 1000).ToString("0000") +  "."+ surfaceFinish;
                }
            }
            catch//General Unhandled exception 
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrStrutABOMDescription, "Error in BOMDescription of SSGBOM.cs."));
            }
