...
//
//   ZVxBOM.cs
//   Witzenmann,Ingr.SP3D.Content.Support.Symbols.MSNBOM
//   Author       : Vinod  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class MSNBOM : SmartPartComponentDefinition, ICustomHgrBOMDescription
    {
        public string BOMDescription(BusinessObject oSupportOrComponent) 
        {
            ...
            try
            {
                ...
                int LGV = (int)((PropertyValueCodelist)oSupportOrComponent.GetPropertyValue("IJUAhsWLGV_MSN", "ULGVMSN")).PropValue;
                bomDescription = "MSN" + " " + nominalDiameter.ToString("0000") +  "." +(nominalLoad / 1000).ToString("000")+"." + (span*1000)+"."+ LGV.ToString ("000")+"-"+ materialType + "."+surfaceFinish;
            }
            catch//General Unhandled exception 
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartPartLocalizer.GetString(SmartPartSymbolResourceIDs.ErrStrutABOMDescription, "Error in BOMDescription of MSNBOM.cs."));
            }
