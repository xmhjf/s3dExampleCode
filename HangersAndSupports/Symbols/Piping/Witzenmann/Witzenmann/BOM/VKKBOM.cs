...
//
//   ZVxBOM.cs
//   Witzenmann,Ingr.SP3D.Content.Support.Symbols.VKKBOM
//   Author       : Vinod  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class VKKBOM : SmartPartComponentDefinition, ICustomHgrBOMDescription
    {
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                double nominalLoad = (double)((PropertyValueDouble)catalogPart.GetPropertyValue("IJUAhsWNominalLoad", "NominalLoad")).PropValue;
                ...
                if (figureNumber == "VGR" || figureNumber == "VSR" || figureNumber == "VPR")
                { 
                    double dynamicLoad = ((double)((PropertyValueDouble)catalogPart.GetPropertyValue("IJUAhsF_Dyn", "F_Dyn")).PropValue)/1000;
                    bomDescription = figureNumber + " " + nominalDiameter.ToString("0000") + "." + nominalLoad.ToString("0000") + "."+(span * 1000).ToString("0000") + "." + dynamicLoad + "-" + materialType + "." + surfaceFinish;
                }
                else
                { 
                    ...
                    if (figureNumber == "VBK")
                    {
                        bomDescription = figureNumber + " " + nominalDiameter.ToString("0000") + "." + nominalLoad.ToString("000") + "."+(span * 1000).ToString("0000") + "." + LGV.ToString("00") + "-" + materialType + "." + surfaceFinish;
                    }
                    else
                    { 
                        bomDescription = figureNumber + " " + nominalDiameter.ToString("0000") + "." + nominalLoad.ToString("0000") + "." + (span * 1000).ToString("0000") + "." + LGV.ToString("00") + "-" + materialType + "." + surfaceFinish; 
                    }
