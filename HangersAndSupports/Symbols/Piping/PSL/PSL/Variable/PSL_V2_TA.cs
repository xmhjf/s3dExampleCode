...
//
//   PSL_V2_TA.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_V2_TA
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_V2_TA : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_V2_TA"
        //----------------------------------------------------------------------------------
        ...
        [InputString(11, "SIZE", "SIZE", "No Value")]
        public InputString SIZE;
        [InputDouble(12, "DIST_FROM_TUBE", "DIST_FROM_TUBE", 0.999999)]
        public InputDouble DIST_FROM_TUBE;
        #endregion
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Double d = D.Value;
                Double k = K.Value;
                Double distanceFromTube = DIST_FROM_TUBE.Value;
                ...
                Port port2 = new Port(OccurrenceConnection, part, "InThdRH", new Position(0, 0, rto + distanceFromTube - preset), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                matrix.Translate(new Vector(0, 0, l));
                matrix.Rotate(3 * Math.PI / 2, new Vector(0, 0, 1), new Position(0, 0, 0));
                Projection3d cylinder = symbolGeometryHelper.CreateCylinder(null, rodDiameter, (rto - preset) - l);
                cylinder.Transform(matrix);
                m_Symbolic.Outputs["CYLINDER1"] = cylinder;
            }
            catch  //General Unhandled exception 
            {
                if (base.ToDoListMessage == null)
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_V2_TA."));
                    return;
                }
            }
        }
