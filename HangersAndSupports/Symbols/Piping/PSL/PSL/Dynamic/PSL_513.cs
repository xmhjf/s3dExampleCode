...
//
//   PSL_513.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_513
//   Author       :  Hema
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_513 : HangerComponentSymbolDefinition
    {
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_513"
        ...
        [InputDouble(12, "I", "I", 0.999999)]
        public InputDouble I;
        [InputDouble(13, "U", "U", 0.999999)]
        public InputDouble U;
        [InputDouble(14, "Q", "Q", 0.999999)]
        public InputDouble Q;
        [InputDouble(15, "Z", "Z", 0.999999)]
        public InputDouble Z;
        [InputDouble(16, "P", "P", 0.999999)]
        public InputDouble P;
        [InputDouble(17, "L", "L", 0.999999)]
        public InputDouble L;
        [InputDouble(18, "O", "O", 0.999999)]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Revolution3d bend = new Revolution3d((new Circle3d(new Position(u / 2.0, 0, 0), new Vector(0, 0, 1), rodDiameter / 2.0)), new Vector(0, -1, 0), new Position(0, 0, 0), Math.PI, true);
                ...
                pointCollection.Add(new Position(-d / 2.0, -b / 2.0 - l, c - o));
                pointCollection.Add(new Position(-d / 2.0, -b / 2.0 - l, c + p));
                pointCollection.Add(new Position(-d / 2.0, -b / 2.0, c + p));
                pointCollection.Add(new Position(-d / 2.0, -b / 2.0, c - o));
                pointCollection.Add(new Position(-d / 2.0, b / 2.0, c - o));
                pointCollection.Add(new Position(-d / 2.0, b / 2.0, c + p));
                pointCollection.Add(new Position(-d / 2.0, b / 2.0 + l, c + p));
                pointCollection.Add(new Position(-d / 2.0, b / 2.0 + l, c - o));
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                Vector normal = new Position(0, b / 2.0 + l, c).Subtract(new Position(0, -b / 2.0 - l, c));
                symbolGeometryHelper.ActivePosition = new Position(0, -b / 2.0 - l, c);
                symbolGeometryHelper.SetOrientation(normal, normal.GetOrthogonalVector());
                Projection3d cylinder1 = symbolGeometryHelper.CreateCylinder(null, a / 2.0, normal.Length);
            ...
            catch       //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_513."));
                    return;
                }
            }
        }
