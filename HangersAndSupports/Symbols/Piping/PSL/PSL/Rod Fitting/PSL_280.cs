...
//
//   PSL_280.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_280
//   Author       :  Manikanth
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_280 : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_280"
        //----------------------------------------------------------------------------------
        ...
        [InputDouble(5, "B1", "B1", 0.999999)]
        public InputDouble B11;
        #endregion
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Port port1 = new Port(OccurrenceConnection, part, "Structure", new Position(0, 0, C - B4), new Vector(1, 0, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Port1"] = port1;

                Port port2 = new Port(OccurrenceConnection, part, "Structure", new Position(0, 0, 0), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                Projection3d cylinder = (Projection3d)symbolGeometryHelper.CreateCylinder(null, B / 2, A);
            ...
            catch  //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_280"));
                    return;
                }
            }
        }
