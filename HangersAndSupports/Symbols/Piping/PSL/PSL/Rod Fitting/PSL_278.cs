...
//
//   PSL_278.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_278
//   Author       :  Manikanth
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_278 : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_278"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            ...
            try
            {
                ...
                Projection3d bodyCylinder = (Projection3d)symbolGeometryHelper.CreateCylinder(null, D / 2, B);
            ...
            catch  //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_278"));
                    return;
                }
            }
        }
