...
//
//   PSL_122.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_122
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_122 : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_122"
        //----------------------------------------------------------------------------------
        ...
        [InputString(2, "LOAD_GROUP", "LOAD_GROUP", "0.999999")]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (f == 0)
                {
                    Port port3 = new Port(OccurrenceConnection, part, "Structure", new Position(0, 0, -a + c), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                if (Convert.ToDouble(loadGroup) < 6)
                    f = C.Value;
            ...
            catch  //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_122."));
                    return;
                }
            }
        }
