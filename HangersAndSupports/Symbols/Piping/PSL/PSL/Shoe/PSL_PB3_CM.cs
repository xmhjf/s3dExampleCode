...
//
//   PSL_PB3_CM.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_PB3_CM
//   Author       :  Vijaya
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_PB3_CM : HangerComponentSymbolDefinition
    {

        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_PB3_CM"
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Double pipeDiameter = PIPE_DIA.Value, a = A.Value, b = B.Value, c = C.Value, d = D.Value, e = E.Value, comlinThickness = COMLIN_T.Value, webThickness = WEB_T.Value, flangeThickness = FLANGE_T.Value, endThickness = END_T.Value;
            ...
            catch
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_PB3_CM.cs"));
                    return;
                }
