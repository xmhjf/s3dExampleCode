...
//
//   PSL_350_SML.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_350_SML
//   Author       :  Hema
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_350_SML : HangerComponentSymbolDefinition
    {
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_350_SML"
        ...
        [InputDouble(6, "WEB_T", "WEB_T", 0.999999)]
        public InputDouble WEB_T;
        [InputDouble(7, "FLANGE_T", "FLANGE_T", 0.999999)]
        public InputDouble FLANGE_T;
        [InputDouble(8, "END_T", "END_T", 0.999999)]
        ...
        protected override void ConstructOutputs()
        {
            ...
            catch       //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_350_SML."));
                    return;
                }
            }
        }
