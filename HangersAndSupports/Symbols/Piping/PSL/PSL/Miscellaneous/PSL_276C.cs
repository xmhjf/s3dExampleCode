...
//
//   PSL_276C.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_276C
//   Author       :  Manikanth
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_276C : HangerComponentSymbolDefinition, ICustomHgrBOMDescription
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_276C"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            ...
            catch  //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_276C"));
                    return;
                }
            }
        }
        ...
        public string BOMDescription(BusinessObject SupportOrComponent)
        {
            ...
            try
            {
                ...
                double length = (double)((PropertyValueDouble)part.GetPropertyValue("IJUAHgrPSL_276C", "L")).PropValue;
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of PSL_276C."));
                return "";
            }
        }
        #endregion
