...
//
//   PSL_VS_TS2.cs
//   PSL,Ingr.SP3D.Content.Support.Symbols.PSL_VS_TS2
//   Author       :BS   
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    /// <summary>
    /// Implementation of the PSL_VS_TS2 class.
    /// </summary>
    /// <remarks></remarks>
    [CacheOption(CacheOptionType.Cached)]
    public class PSL_VS_TS2 : HangerComponentSymbolDefinition
    {
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_VS_TS2"
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                pointCollection.Add(new Position(-FB / 2.0, D + FC, A2 - FM));
                pointCollection.Add(new Position(-FB / 2.0, D + FE / 2.0 + fd, A2 - TE));
                pointCollection.Add(new Position(-FB / 2.0, D + FE / 2.0 + fd, A2 - TE - FC));
                ...
                pointCollection.Add(new Position(-FB / 2.0, D - TF, A2 - rodDiameter * 2.0));
                pointCollection.Add(new Position(-FB / 2.0, D - TF, A2 - FM));
                ...
                matrix.Translate(new Vector(D - V2 - CC / 2.0, -EE / 2.0, A2));
                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1), new Position(0, 0, 0));
            ...
            catch
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_VS_TS2"));
                    return;
                }
            }
        }
