...
//
//   PSL_VD_TS2.cs
//   PSL,Ingr.SP3D.Content.Support.Symbols.PSL_VD_TS2
//   Author       :BS   
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    /// <summary>
    /// Implementation of the PSL_VD_TS2 class.
    /// </summary>
    /// <remarks></remarks>
    [CacheOption(CacheOptionType.Cached)]
    public class PSL_VD_TS2 : HangerComponentSymbolDefinition
    {
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_VD_TS2"
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                //minTravel = MiddleServiceProvider.UOMMgr.ConvertUnitToDBU(UnitType.Distance, minTravel, UnitName.DISTANCE_MILLIMETER);
                ...
                matrix.Translate(new Vector(D - U - CC / 2.0, -EE / 2.0, A2));
                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1), new Position(0, 0, 0));
                ...
                matrix = new Matrix4X4();
                matrix.Translate(new Vector(D + FG - CC / 2.0, -EE / 2.0, A2));
                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1), new Position(0, 0, 0));
            ...
            catch
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_VD_TS2"));
                    return;
                }
            }
        }
