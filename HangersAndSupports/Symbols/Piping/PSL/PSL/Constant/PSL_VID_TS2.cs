...
//
//   PSL_VID_TS2.cs
//   PSL,Ingr.SP3D.Content.Support.Symbols.PSL_VID_TS2
//   Author       :BS   
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_VID_TS2 : HangerComponentSymbolDefinition
    {
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_VID_TS2"
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                Projection3d lug1 = symbolGeometryHelper.CreateBox(null, CC + U + FG, EE, AA + BB, 9);
                matrix = new Matrix4X4();
                matrix.Translate(new Vector(D - U - CC / 2.0, -EE / 2.0, A3));
                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1), new Position(0, 0, 0));
            ...
            catch
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_VID_TS2"));
                    return;
                }
            }
        }
