...
//
//   PSL_HD_TS5.cs
//   PROGID : PSL,Ingr.SP3D.Content.Support.Symbols.PSL_HD_TS5
//   Author       :  Mahanth
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_HD_TS5 : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Port port2 = new Port(OccurrenceConnection, part, "Structure", new Position(0, d + fg - (fg + u) / 2.0, a1), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(d - u - fj, -fk / 2.0, a1 - fm);
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_HD_TS5.cs."));
                return;
            }
        }
