...
//
//   PSL_HS_TS2.cs
//   PROGID : PSL,Ingr.SP3D.Content.Support.Symbols.PSL_HS_TS2
//   Author       :  Mahanth
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_HS_TS2 : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                symbolGeometryHelper.ActivePosition = new Position(d - v1 - cc / 2.0, -ee / 2.0, a1);
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_HS_TS2.cs."));
                return;
            }
        }
