...
//
//   PSL_VD_TS4.cs
//   PSL,Ingr.SP3D.Content.Support.Symbols.PSL_VD_TS4
//   Author       :BS   
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    /// <summary>
    /// Implementation of the PSL_VD_TS4 class.
    /// </summary>
    /// <remarks></remarks>
    [CacheOption(CacheOptionType.Cached)]
    public class PSL_VD_TS4 : HangerComponentSymbolDefinition
    {
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_VD_TS4"
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Port port2 = new Port(OccurrenceConnection, part, "Hole", new Position(0, D - U, A2 + AA), new Vector(1, 0, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Port2"] = port2;
                Port port3 = new Port(OccurrenceConnection, part, "Hole", new Position(0, D + FG, A2 + AA), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                matrix.Translate(new Vector(D - U - EE / 2.0, -CC / 2.0, A2));
                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1), new Position(0, 0, 0));
                ...
                matrix = new Matrix4X4();
                matrix.Translate(new Vector(D + FG - EE / 2.0, -CC / 2.0, A2));
                matrix.Rotate(Math.PI / 2, new Vector(0, 0, 1), new Position(0, 0, 0));
            ...
            catch
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_VD_TS4"));
                    return;
                }
            }
        }
