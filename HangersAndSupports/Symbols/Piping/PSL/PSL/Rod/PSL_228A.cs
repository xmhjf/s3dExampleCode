...
//
//   PSL_228A.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_228A
//   Author       :  Vijay
...
{   
    ...
    public class PSL_228A : HangerComponentSymbolDefinition, ICustomHgrBOMDescription
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_228A"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrInvalidThreadL, "THREAD_L cannot exceed MAX_THREAD length" + Convert.ToSingle(maximumThread * 1000)));
                ...
                Port port2 = new Port(OccurrenceConnection, part, "ExThdLH", new Position(0, 0, length + e / 2.0), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                Projection3d rodCylinder = symbolGeometryHelper.CreateCylinder(null, e / 2.0 + rodDiameter, rodDiameter);
                rodCylinder.Transform(matrix);
                m_Symbolic.Outputs["CYL"] = rodCylinder;
                ...
                matrix.Rotate(3 * Math.PI / 2, new Vector(0, 0, 1), new Position(0, 0, 0));
                Projection3d rodCylinder1 = symbolGeometryHelper.CreateCylinder(null, rodDiameter / 2.0, length - e / 2.0);
                rodCylinder1.Transform(matrix);
                m_Symbolic.Outputs["ROD"] = rodCylinder1;
            }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                string partNumber = (string)((PropertyValueString)part.GetPropertyValue("IJUAHgrPSL_228A", "PART_NO_L")).PropValue;
                double lengthValue = (double)((PropertyValueDouble)part.GetPropertyValue("IJUAHgrPSL_228A", "L")).PropValue;
