...
//
//   PSL_PC2_CM.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_PC2_CM
//   Author       :  Vijaya
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_PC2_CM : HangerComponentSymbolDefinition, ICustomHgrBOMDescription
    {

        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_PC2_CM"
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                matrix.SetIdentity();
                symbolGeometryHelper.ActivePosition = new Position(-(b / 2 + t), -e / 2, -(c + d));
                matrix.Rotate(3 * Math.PI / 2, new Vector(0, 0, 1));
                Projection3d bottom1 = symbolGeometryHelper.CreateBox(null, t, e, c + d - pipeDiameter / 2 - DValue, 9);
                ...
                matrix.Rotate(3 * Math.PI / 2, new Vector(0, 0, 1));
                Projection3d bottom2 = symbolGeometryHelper.CreateBox(null, t, e, c + d - pipeDiameter / 2 - DValue, 9);
                ...
                symbolGeometryHelper = new SymbolGeometryHelper();
                normal = new Position(0, b / 2 + 2 * t, c).Subtract(new Position(0, -(b / 2 + 2 * t), c));
                symbolGeometryHelper.ActivePosition = new Position(0, -(b / 2 + 2 * t), c);
                symbolGeometryHelper.SetOrientation(normal, normal.GetOrthogonalVector());
            ...
            catch
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_PC2_CM.cs"));
                    return;
                }
            }
        }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                PropertyValueCodelist gradeCodelist = (PropertyValueCodelist)oSupportOrComponent.GetPropertyValue("IJOAHgrPSL_PC2_CM", "COMLIN_GRADE");
                ...
                string materialGrade = (string)((PropertyValueString)part.GetPropertyValue("IJUAHgrPSL_PC2_CM", "MATERIAL")).PropValue;
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of PSL_PC2_CM.cs."));
                return "";
            }
        }
        #endregion
