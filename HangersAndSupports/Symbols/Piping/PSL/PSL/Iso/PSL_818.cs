...
//
//   PSL_818.cs
//    PSL,Ingr.SP3D.Content.Support.Symbols.PSL_818
//   Author       :  Rajeswari
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class PSL_818 : HangerComponentSymbolDefinition, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PSL,Ingr.SP3D.Content.Support.Symbols.PSL_818"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            ...
            catch       //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of PSL_818.cs"));
                    return;
                }
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            try
            {
                ...
                double C = (double)((PropertyValueDouble)part.GetPropertyValue("IJUAHgrPSL_818", "C")).PropValue;
                double weightPerMeter = (double)((PropertyValueDouble)part.GetPropertyValue("IJUAHgrPSL_818", "WEIGHT_FR80")).PropValue;
            ...
            {
                ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, PSLLocalizer.GetString(PSLSymbolResourceIDs.ErrWeightCG, "Error in EvaluateWeightCG of PSL_818.cs."));
            }
        }
        #endregion
    }
