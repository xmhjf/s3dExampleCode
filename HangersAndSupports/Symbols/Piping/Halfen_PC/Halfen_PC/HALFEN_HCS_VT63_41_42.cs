...
//
//   HALFEN_HCS_VT63_41_42.cs
//    Halfen_PC,Ingr.SP3D.Content.Support.Symbols.HALFEN_HCS_VT63_41_42
//   Author       :Sasidhar  
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class HALFEN_HCS_VT63_41_42 : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Halfen_PC,Ingr.SP3D.Content.Support.Symbols.HALFEN_HCS_VT63_41_42"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                Port port3 = new Port(connection, part, "Middle", new Position(0, 0, height / 2), new Vector(1, 0, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Port3"] = port3;

                Port port4 = new Port(connection, part, "Right", new Position(0, -width / 2 - L, height / 2), new Vector(1, 0, 0), new Vector(0, 0, 1));
                m_Symbolic.Outputs["Port4"] = port4;

                if (size == "42/2")
                {
                    Port port5 = new Port(connection, part, "Left", new Position(0, width / 2 + L, height / 2), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                Projection3d side1 = (Projection3d)symbolGeometryHelper.CreateBox(null, L, width2, width2);
                ...
                if (size == "42/2")
                {
                    ...
                    symbolGeometryHelper.ActivePosition = new Position(0, width / 2, height / 2);
                    symbolGeometryHelper.SetOrientation(new Vector(0, 1, 0), new Vector(1, 0, 0));
                    Projection3d side2 = (Projection3d)symbolGeometryHelper.CreateBox(null, L, width2, width2);
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, HalfenPCLocalizer.GetString(HalfenPClResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of HALFEN_HCS_VT63_41_42.cs."));
                    return;
                }
            }
        }
