...
//
//   HALFEN_HCS_VT63_14_15_16.cs
//    Halfen_PC,Ingr.SP3D.Content.Support.Symbols.HALFEN_HCS_VT63_14_15_16
//   Author       :Sasidhar   
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    [VariableOutputs]
    public class HALFEN_HCS_VT63_14_15_16 : HangerComponentSymbolDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "Halfen_PC,Ingr.SP3D.Support.Content.Symbols.HALFEN_HCS_VT63_14_15_16"
        //----------------------------------------------------------------------------------
        ...
        [InputDouble(2, "Beam_Flange_W_Min", "Beam_Flange_W_Min", 0.999999)]
        public InputDouble m_dBeam_Flange_W_Min;
        [InputDouble(3, "Beam_Flange_W_Max", "Beam_Flange_W_Max", 0.999999)]
        public InputDouble m_dBeam_Flange_W_Max;
        [InputString(4, "SIZE", "SIZE", "No Value")]
        public InputString m_oSIZE;
        [InputDouble(5, "CutHeight", "CutHeight", 0.999999)]
        public InputDouble m_dCutHeight;
        ...
        [InputString(11, "Stock_Number", "Stock_Number", "No Value")]
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (cutheight > 0)
                {
                    if (cutheight > height)
                    {
                        ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, HalfenPCLocalizer.GetString(HalfenPClResourceIDs.ErrCutheight, "The height to cut to is longer than the standard height."));
                    }
                    else
                    {
                        height = cutheight;
                ...
                Port port2 = new Port(connection, part, "Top", new Position(0, 0, T + height), new Vector(1, 0, 0), new Vector(0, 0, 1));
                ...
                symbolGeometryHelper.SetOrientation(new Vector(0, 0, 1), new Vector(1, 0, 0));
                Projection3d squareTube = (Projection3d)symbolGeometryHelper.CreateBox(null, height, channelW, channelW);
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, HalfenPCLocalizer.GetString(HalfenPClResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of HALFEN_HCS_VT63_14_15_16.cs."));
                    return;
                }
            }
        }
