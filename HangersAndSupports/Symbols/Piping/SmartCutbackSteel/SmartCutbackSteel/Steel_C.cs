...
//
//   Steel_C.cs
//    SmartCutbackSteel,Ingr.SP3D.Content.Support.Symbols.Steel_C
//   Author       :  Vijay
...
//   -----------     ---     ------------------
//   15.11.2012     Vijay    CR222284 Converted VB SmartCutBackSteel to C#.Net
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Steel_C : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "SmartCutbackSteel,Ingr.SP3D.Content.Support.Symbols.Steel_C"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (beginCutbackAnchorPoint == 4 && endCutbackAnchorPoint == 4)
                {
                    ...
                    pointCollection.Add(new Position(0, flangeThickness, -beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength));
                    pointCollection.Add(new Position(webThk, flangeThickness, L + endOverLength - Z2));
                    pointCollection.Add(new Position(webThk, flangeThickness, -Z1 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, -beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 4 && endCutbackAnchorPoint == 6)
                {
                    Collection<Position> pointCollection = new Collection<Position>();
                    pointCollection.Add(new Position(0, 0, -beginOverLength));
                    pointCollection.Add(new Position(0, 0, L + Z4 + endOverLength));
                    ...
                    pointCollection = new Collection<Position>();
                    pointCollection.Add(new Position(0, flangeThickness, -beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength + Z4));
                    pointCollection.Add(new Position(webThk, flangeThickness, L + endOverLength + Z4 - Z2));
                    pointCollection.Add(new Position(webThk, flangeThickness, -Z1 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, -beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 6 && endCutbackAnchorPoint == 4)
                {
                    ...
                    pointCollection = new Collection<Position>();
                    pointCollection.Add(new Position(0, flangeThickness, Z3 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength));
                    pointCollection.Add(new Position(webThk, flangeThickness, L + endOverLength - Z2));
                    pointCollection.Add(new Position(webThk, flangeThickness, Z3 - Z1 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, Z3 - beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 2 && endCutbackAnchorPoint == 2)
                {
                    ...
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength - Z8));
                    pointCollection.Add(new Position(0, depth - flangeThickness, L + endOverLength - Z6 + Z8));
                    pointCollection.Add(new Position(0, depth - flangeThickness, -Z5 + Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 2 && endCutbackAnchorPoint == 8)
                {
                    Collection<Position> pointCollection = new Collection<Position>();
                    pointCollection.Add(new Position(0, 0, -beginOverLength));
                    pointCollection.Add(new Position(0, 0, L + endOverLength + Z6));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength + Z6 - Z8));
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, 0, -beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 8 && endCutbackAnchorPoint == 2)
                {
                    ...
                    pointCollection.Add(new Position(0, 0, Z5 - beginOverLength));
                    pointCollection.Add(new Position(0, 0, L + endOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength - Z8));
                    pointCollection.Add(new Position(0, flangeThickness, Z5 - Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, 0, Z5 - beginOverLength));
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrConstructOutputs, "Error in constructoutputs of Steel_C.cs"));
                    return;
                }
            }
        }
        ...
        private double GetBeginFaceZCoord(CrossSection crossSection, long beginCutbackAnchorPoint, long cardinalPoint, double beginCutbackAngle)
        {
            ...
            if (beginCutbackAnchorPoint == 4 || beginCutbackAnchorPoint == 6)
            {
                ...
                else if (cardinalPoint == 2 || cardinalPoint == 5 || cardinalPoint == 8 || cardinalPoint == 15)
                {
                    if (beginCutbackAnchorPoint == 4)
                        beginFaceZ = -Z3 / 2;
                    else if (beginCutbackAnchorPoint == 6)
                ...
                else if (cardinalPoint == 10 || cardinalPoint == 11 || cardinalPoint == 14)
                {
                    if (beginCutbackAnchorPoint == 4)
                        beginFaceZ = -Z3 * 25 / 90;       //As per Cross section symbol
                    else if (beginCutbackAnchorPoint == 6)
                        beginFaceZ = Z3 * 25 / 90;       //As per Cross section symbol
                }
        ...
        private double GetEndFaceZCoord(CrossSection crossSection, long endCutbackAnchorPoint, long cardinalPoint, double endCutbackAngle)
        {
            ...
            if (endCutbackAnchorPoint == 4 || endCutbackAnchorPoint == 6)
            {
                ...
                {
                    if (endCutbackAnchorPoint == 4)
                        endFaceZ = -Z4 * 25 / 90;       //As per Cross section symbol
                    else if (endCutbackAnchorPoint == 6)
                        endFaceZ = Z4 * 25 / 90;       //As per Cross section symbol
                }
                else if (cardinalPoint == 3 || cardinalPoint == 6 || cardinalPoint == 9 || cardinalPoint == 13)
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            catch       //General Unhandled exception 
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of Steel_C.cs"));
                }
                return "";
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrWeightCG, "Error in weightCG of Steel_C.cs"));
                }
            }
        }
        #endregion
