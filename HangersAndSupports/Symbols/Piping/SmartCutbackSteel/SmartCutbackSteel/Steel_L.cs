...
//
//   Steel_L.cs
//    SmartCutbackSteel,Ingr.SP3D.Content.Support.Symbols.Steel_L
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Steel_L : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "SmartCutbackSteel,Ingr.SP3D.Content.Support.Symbols.Steel_L"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                else if (beginCutbackAnchorPoint == 2 && endCutbackAnchorPoint == 2)
                {
                    ...
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength - Z8));
                    pointCollection.Add(new Position(0, depth, L + endOverLength - Z6 + Z8));
                    pointCollection.Add(new Position(0, depth, -Z5 + Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 2 && endCutbackAnchorPoint == 8)
                {
                    ...
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength + Z6 - Z8));
                    pointCollection.Add(new Position(0, depth, L + endOverLength + Z8));
                    pointCollection.Add(new Position(0, depth, -Z5 + Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 8 && endCutbackAnchorPoint == 2)
                {
                    ...
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength - Z8));
                    pointCollection.Add(new Position(0, depth, L + endOverLength - Z6 + Z8));
                    pointCollection.Add(new Position(0, depth, Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, Z5 - Z7 - beginOverLength));
                ...
                else
                {
                    ...
                    if (HgrCompareDoubleService.cmpdbl(flexPortRotY  , 0)==false)
                    {
                        ...
                        transMatrix.Rotate(flexPortRotY, tempVector);
                    }
                    if (HgrCompareDoubleService.cmpdbl(flexPortRotZ  , 0)==false)
                    {
                        tempVector.Set(0, 0, 1);
                        transMatrix.Rotate(flexPortRotZ, tempVector);
                    }
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrConstructOutputs, "Error in constructoutputs of Steel_L.cs"));
                    return;
                }
            }
        }
        ...
        private double GetBeginFaceZCoord(CrossSection crossSection, long beginCutbackAnchorPoint, long cardinalPoint, double beginCutbackAngle)
        {
            ...
            dZ3 = width * Math.Tan(beginCutbackAngle);    //for Anchor Points 4 and 6
            dZ5 = depth * Math.Tan(beginCutbackAngle);    //for Anchor Points 2 and 8
            ...
            if (beginCutbackAnchorPoint == 4 || beginCutbackAnchorPoint == 6)
            {
                ...
                else if (cardinalPoint == 2 || cardinalPoint == 5 || cardinalPoint == 8)
                {
                    if (beginCutbackAnchorPoint == 4)
                        dBeginFaceZ = -(dZ3 / 2);
                    else if (beginCutbackAnchorPoint == 6)
                ...
                else if (cardinalPoint == 10 || cardinalPoint == 11 || cardinalPoint == 14 || cardinalPoint == 15)
                {
                    if (beginCutbackAnchorPoint == 4)
                        dBeginFaceZ = -dZ3 / 4;       //As per Cross section symbol
                    else if (beginCutbackAnchorPoint == 6)
                        dBeginFaceZ = dZ3 / 4;       //As per Cross section symbol
                }
            ...
            else if (beginCutbackAnchorPoint == 2 || beginCutbackAnchorPoint == 8)
            {
                ...
                else if (cardinalPoint == 4 || cardinalPoint == 5 || cardinalPoint == 6 || cardinalPoint == 15)
                {
                    if (beginCutbackAnchorPoint == 2)
                        dBeginFaceZ = -dZ5 / 2;
                    else if (beginCutbackAnchorPoint == 8)
                ...
                else if (cardinalPoint == 10 || cardinalPoint == 12 || cardinalPoint == 13)
                {
                    if (beginCutbackAnchorPoint == 2)
                        dBeginFaceZ = -dZ5 / 4;
                    else if (beginCutbackAnchorPoint == 8)
        ...
        private double GetEndFaceZCoord(CrossSection crossSection, long endCutbackAnchorPoint, long cardinalPoint, double endCutbackAngle)
        {
            ...
            dZ4 = width * Math.Tan(endCutbackAngle);    //for Anchor Points 4 and 6
            dZ6 = depth * Math.Tan(endCutbackAngle);    //for Anchor Points 2 and 8
            ...
            if (endCutbackAnchorPoint == 4 || endCutbackAnchorPoint == 6)
            {
                ...
                {
                    if (endCutbackAnchorPoint == 4)
                        dEndFaceZ = -dZ4 / 4;       //As per Cross section symbol
                    else if (endCutbackAnchorPoint == 6)
                        dEndFaceZ = dZ4 / 4;       //As per Cross section symbol
                }
                else if (cardinalPoint == 3 || cardinalPoint == 6 || cardinalPoint == 9 || cardinalPoint == 13)
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            catch //General Unhandled exception 
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of Steel_L.cs"));
                }
                return "";
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrWeightCG, "Error in weightCG of Steel_L.cs"));
                }
            }
        }
        #endregion
