...
//
//   Steel_W.cs
//    SmartCutbackSteel,Ingr.SP3D.Content.Support.Symbols.Steel_W
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Steel_W : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "SmartCutbackSteel,Ingr.SP3D.Content.Support.Symbols.Steel_W"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                double width, depth, flangeThickness, webThk;
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrFlangeThicknessArgument, "Flange Thickness cannot be zero"));
                    return;
                }
                ...
                if (HgrCompareDoubleService.cmpdbl(webThk , 0)==true)
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrWebThicknessArgument, "Web Thickness cannot be zero"));
                    return;
                }
                ...
                if (beginCutbackAnchorPoint == 4 && endCutbackAnchorPoint == 4)
                {
                    ...
                    Vector tempVector1 = new Vector(-(width / 2 - webThk / 2), 0, 0);
                    transMatrix1.SetIdentity();
                    transMatrix1.Translate(tempVector1);

                    pointCollection.Add(new Position(0, depth - flangeThickness, -beginOverLength));
                    pointCollection.Add(new Position(0, depth - flangeThickness, L + endOverLength));
                    pointCollection.Add(new Position(width, depth - flangeThickness, L + endOverLength - Z4));
                    pointCollection.Add(new Position(width, depth - flangeThickness, -Z3 - beginOverLength));
                    pointCollection.Add(new Position(0, depth - flangeThickness, -beginOverLength));
                    ...
                    tempVector1 = new Vector(-(width / 2 - webThk / 2), 0, 0);
                    transMatrix1.SetIdentity();
                    transMatrix1.Translate(tempVector1);

                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, -((width - webThk) / 2) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, L + endOverLength - ((width - webThk) / 2) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position((width + webThk) / 2, flangeThickness, L + endOverLength - ((width + webThk) / 2) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position((width + webThk) / 2, flangeThickness, -((width + webThk) / 2) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, -((width - webThk) / 2) * Math.Tan(cutbackBeginAngle) - beginOverLength));

                    projectionVector = new Vector(0, depth - 2 * flangeThickness, 0);
                ...
                else if (beginCutbackAnchorPoint == 4 && endCutbackAnchorPoint == 6)
                {
                    ...
                    pointCollection.Add(new Position(0, depth - flangeThickness, -beginOverLength));
                    pointCollection.Add(new Position(0, depth - flangeThickness, L + Z4 + endOverLength));
                    pointCollection.Add(new Position(width, depth - flangeThickness, L + endOverLength));
                    pointCollection.Add(new Position(width, depth - flangeThickness, -Z3 - beginOverLength));
                    pointCollection.Add(new Position(0, depth - flangeThickness, -beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 6 && endCutbackAnchorPoint == 4)
                {
                    ...
                    pointCollection.Add(new Position(0, depth - flangeThickness, Z3 - beginOverLength));
                    pointCollection.Add(new Position(0, depth - flangeThickness, L + endOverLength));
                    pointCollection.Add(new Position(width, depth - flangeThickness, L + endOverLength - Z4));
                    pointCollection.Add(new Position(width, depth - flangeThickness, -beginOverLength));
                    pointCollection.Add(new Position(0, depth - flangeThickness, Z3 - beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 6 && endCutbackAnchorPoint == 6)
                {
                    ...
                    pointCollection.Add(new Position(0, depth - flangeThickness, Z3 - beginOverLength));
                    pointCollection.Add(new Position(0, depth - flangeThickness, L + endOverLength + Z4));
                    pointCollection.Add(new Position(width, depth - flangeThickness, L + endOverLength));
                    pointCollection.Add(new Position(width, depth - flangeThickness, -beginOverLength));
                    pointCollection.Add(new Position(0, depth - flangeThickness, Z3 - beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 2 && endCutbackAnchorPoint == 2)
                {
                    ...
                    pointCollection.Add(new Position(0, (depth - flangeThickness), -(depth - flangeThickness) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position(0, (depth - flangeThickness), L + endOverLength - (depth - flangeThickness) * Math.Tan(cutbackEndAngle)));
                    ...
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, -Z7 - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, L + endOverLength - Z8));
                    pointCollection.Add(new Position((width - webThk) / 2, depth - flangeThickness, L + endOverLength - (depth - flangeThickness) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position((width - webThk) / 2, depth - flangeThickness, -(depth - flangeThickness) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, -Z7 - beginOverLength));

                    projectionVector = new Vector(webThk, 0, 0);
                    projectionSteel = new Projection3d(new LineString3d(pointCollection), projectionVector, projectionVector.Length, true);
                    m_Symbolic.Outputs["BODY2"] = projectionSteel;
                    projectionSteel.Transform(transMatrix1);
                    ...
                    pointCollection.Add(new Position(0, 0, -beginOverLength));
                    pointCollection.Add(new Position(0, 0, L + endOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength - Z8));
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, 0, -beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 2 && endCutbackAnchorPoint == 8)
                {
                    ...
                    pointCollection.Add(new Position(0, (depth - flangeThickness), -(depth - flangeThickness) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position(0, (depth - flangeThickness), L + endOverLength + Z8));
                    ...
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, -Z7 - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, L + endOverLength + (depth - flangeThickness) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position((width - webThk) / 2, (depth - flangeThickness), L + endOverLength + Z8));
                    pointCollection.Add(new Position((width - webThk) / 2, (depth - flangeThickness), -(depth - flangeThickness) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, -Z7 - beginOverLength));
                    ...
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength + (depth - flangeThickness) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position(0, flangeThickness, -Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, 0, -beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 8 && endCutbackAnchorPoint == 2)
                {
                    ...
                    pointCollection.Add(new Position(0, (depth - flangeThickness), Z7 - beginOverLength));
                    pointCollection.Add(new Position(0, (depth - flangeThickness), L + endOverLength - (depth - flangeThickness) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position(0, depth, L + endOverLength - depth * Math.Tan(cutbackEndAngle)));
                    ...
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, (depth - flangeThickness) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, L + endOverLength - Z8));
                    pointCollection.Add(new Position((width - webThk) / 2, depth - flangeThickness, L + endOverLength - (depth - flangeThickness) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position((width - webThk) / 2, depth - flangeThickness, Z7 - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, flangeThickness, (depth - flangeThickness) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    ...
                    pointCollection.Add(new Position(0, 0, L + endOverLength));
                    pointCollection.Add(new Position(0, flangeThickness, L + endOverLength - Z8));
                    pointCollection.Add(new Position(0, flangeThickness, (depth - flangeThickness) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position(0, 0, depth * Math.Tan(cutbackBeginAngle) - beginOverLength));
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of Steel_W.cs"));
                    return;
                }
            }
        }
        ...
        private double GetBeginFaceZCoord(CrossSection crossSection, long beginCutbackAnchorPoint, long cardinalPoint, double beginCutbeingAngle)
        {
            double beginFaceZ = 0;
            double Z3, Z5;
            ...
            Z3 = width * Math.Tan(beginCutbeingAngle);    //for Anchor Points 4 and 6
            Z5 = depth * Math.Tan(beginCutbeingAngle);    //for Anchor Points 2 and 8
        ...
        private double GetEndFaceZCoord(CrossSection crossSection, long endCutbackAnchorPoint, long cardinalPoint, double endCutbackAngle)
        {
            ...
            Z6 = depth * Math.Tan(endCutbackAngle);    //for Anchor Points 2 and 8
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            catch //General Unhandled exception 
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of Steel_W.cs"));
                }
                return "";
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrWeightCG, "Error in WeightCG of Steel_W.cs"));
                }
            }
        }
        #endregion
