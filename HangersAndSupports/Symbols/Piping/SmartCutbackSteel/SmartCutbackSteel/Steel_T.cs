...
//
//   Steel_T.cs
//    SmartCutbackSteel,Ingr.SP3D.Content.Support.Symbols.Steel_T
//   Author       :  Vijay
...
//   -----------     ---     ------------------
//   19.11.2012     Vijay    CR222284 Converted VB SmartCutBackSteel to C#.Net
...
namespace Ingr.SP3D.Content.Support.Symbols
{
    ...
    public class Steel_T : HangerComponentSymbolDefinition, ICustomHgrBOMDescription, ICustomWeightCG
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "SmartCutbackSteel,Ingr.SP3D.Content.Support.Symbols.Steel_T"
        //----------------------------------------------------------------------------------
        ...
        protected override void ConstructOutputs()
        {
            try
            {
                ...
                if (beginCutbackAnchorPoint == 4 && endCutbackAnchorPoint == 4)
                {
                    ...
                    pointCollection.Add(new Position((width - webThk) / 2, 0, -((width - webThk) / 2) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, 0, L + endOverLength - ((width - webThk) / 2) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position((width + webThk) / 2, 0, L + endOverLength - -((width + webThk) / 2) * Math.Tan(cutbackEndAngle)));
                    pointCollection.Add(new Position((width + webThk) / 2, 0, -((width + webThk) / 2) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, 0, -((width - webThk) / 2) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                ...
                else if (beginCutbackAnchorPoint == 2 && endCutbackAnchorPoint == 2)
                {
                    ...
                    pointCollection.Add(new Position(0, depth, L + endOverLength - Z6));
                    pointCollection.Add(new Position(0, depth, -Z5 - beginOverLength));
                    pointCollection.Add(new Position(0, (depth - flangeThickness), -(depth - flangeThickness) * Math.Tan(cutbackBeginAngle) - beginOverLength));
                    ...
                    pointCollection.Add(new Position((width - webThk) / 2, 0, -beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, 0, L + endOverLength));
                ...
                else if (beginCutbackAnchorPoint == 2 && endCutbackAnchorPoint == 8)
                {
                    ...
                    pointCollection.Add(new Position((width - webThk) / 2, 0, -beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, 0, L + endOverLength + Z6));
                ...
                else if (beginCutbackAnchorPoint == 8 && endCutbackAnchorPoint == 2)
                {
                    ...
                    pointCollection.Add(new Position((width - webThk) / 2, 0, Z5 - beginOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, 0, L + endOverLength));
                    pointCollection.Add(new Position((width - webThk) / 2, depth - flangeThickness, L + endOverLength - (depth - flangeThickness) * Math.Tan(cutbackEndAngle)));
            ...
            catch //General Unhandled exception 
            {
                ...
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageError, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrConstructOutputs, "Error in ConstructOutputs of Steel_T.cs."));
                    return;
                }
            }
        }
        ...
        private double GetBeginFaceZCoord(CrossSection crossSection, long beginCutbackAnchorPoint, long cardinalPoint, double beginCutbackAngle)
        {
            ...
            else if (beginCutbackAnchorPoint == 2 || beginCutbackAnchorPoint == 8)
            {
                ...
                else if (cardinalPoint == 4 || cardinalPoint == 5 || cardinalPoint == 6)
                {
                    if (beginCutbackAnchorPoint == 2)
                        beginFaceZ = -Z5 / 2;
                    else if (beginCutbackAnchorPoint == 8)
                ...
                else if (cardinalPoint == 10 || cardinalPoint == 12 || cardinalPoint == 13 || cardinalPoint == 15)
                {
                    if (beginCutbackAnchorPoint == 2)
                        beginFaceZ = -Z5 * (132.3 / 180);
                    else if (beginCutbackAnchorPoint == 8)
                        beginFaceZ = Z5 * (132.3 / 180);
                }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            catch //General Unhandled exception 
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrBOMDescription, "Error in BOMDescription of Steel_T.cs."));
                }
                return "";
            }
        }
        ...
        void ICustomWeightCG.EvaluateWeightCG(BusinessObject supportComponentBO)
        {
            ...
            catch
            {
                if (base.ToDoListMessage == null) //Check ToDoListMessgae created already or not
                {
                    ToDoListMessage = new ToDoListMessage(ToDoMessageTypes.ToDoMessageWarning, SmartCutbackSteelLocalizer.GetString(SmartCutbackSteelSymbolResourceIDs.ErrWeightCG, "Error in weightCG of Steel_T.cs"));
                }
            }
        }
        #endregion
