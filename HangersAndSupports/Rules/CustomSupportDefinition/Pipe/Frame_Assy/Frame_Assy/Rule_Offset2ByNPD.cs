...
//
//   RULEGuideSecSize.cs
//   Frame_Assy,Ingr.SP3D.Content.Support.Rules.Rule_Offset2ByNPD
//   Author       :Hema
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    //-----------------------------------------------------------------------------------
    public class Rule_Offset2ByNPD : IHgrRule
    {
        public Array AttributeValue(BusinessObject SupportOrComponent)
        {
            ...
            int routeIndex = boundingBoxHelper.GetBoundaryRouteIndex("BBFrame", BoundingBoxEdge.Right);
