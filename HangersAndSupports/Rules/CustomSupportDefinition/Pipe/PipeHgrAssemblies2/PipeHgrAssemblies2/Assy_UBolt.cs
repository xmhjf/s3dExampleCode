...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_UBolt : CustomSupportDefinition
    {
        ...
        //-----------------------------------------------------------------------------------
        private const string Anvil_FIG137 = "Anv10_UBolt";
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    PartClass anvil_FIG137PartClass = (PartClass)catalogBaseHelper.GetPartClass("Anv10_UBolt"); ;
                    string partselection = anvil_FIG137PartClass.GetPropertyValue("IJHgrPartClass", "PartSelectionRule").ToString();
                    parts.Add(new PartInfo(Anvil_FIG137, "Anv10_UBolt", partselection));
