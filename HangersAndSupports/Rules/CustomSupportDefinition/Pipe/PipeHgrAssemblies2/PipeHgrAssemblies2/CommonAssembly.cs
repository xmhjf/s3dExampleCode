...
namespace Ingr.SP3D.Content.Support.Rules
{
    public  class CommonAssembly 
    {
        ...
        /// </code>
      public PropertyValue GetProertyFromObject(BusinessObject businessObject, string[] collectionOfInterfaces, string propertyName, object defaultValue)
      {
      ...
      /// </code>
      public void SetPropertyFromObject(BusinessObject businessObject, string[] collectionOfInterfaces, string propertyName, int value)
      {
           foreach (string interfacename in collectionOfInterfaces)
          {
              if (businessObject.SupportsInterface(interfacename))
      ...
      ///     SetPropertyFromObject(businessObject, collectionOfInterfaces, propertyName, value)
      /// </code>
      public void SetPropertyFromObject(BusinessObject businessObject, string[] collectionOfInterfaces, string propertyName, double value)
      {
          foreach (string interfacename in collectionOfInterfaces)
          {
              if (businessObject.SupportsInterface(interfacename))
      ...
      ///     SetPropertyFromObject(businessObject, collectionOfInterfaces, propertyName, value)
      /// </code>
      public void SetPropertyFromObject(BusinessObject businessObject, string[] collectionOfInterfaces, string propertyName, string value)
      {
          foreach (string interfacename in collectionOfInterfaces)
          {
              if (businessObject.SupportsInterface(interfacename))
      ...
      ///     SetPropertyFromObject(businessObject, collectionOfInterfaces, propertyName, value)
      /// </code>
      public void SetPropertyFromObject(BusinessObject businessObject, string[] collectionOfInterfaces, string propertyName, bool value)
      {
         foreach (string interfacename in collectionOfInterfaces)
          {
              if (businessObject.SupportsInterface(interfacename))
      ...
      /// </code>
      public String[] GetIndexedStructPortName(CustomSupportDefinition customSupportDefinition, Boolean[] isOffsetApplied)
      {
      ...
      ///</code>
      public Boolean[] GetIsLugEndOffsetApplied(CustomSupportDefinition customSupportDefinition)
      {
          try
          {
