                    ...
                    double pipeDiameter = routeInfo.OutsideDiameter;
                        ...
                        if (topType == "ROD_CLEVIS_LUG")
                        {
                            if (turnbuckle == 1) // 1 means With Turnbuckle
                            {
                                ...
                                parts.Add(new PartInfo(LUG_NUT4, "Anv10_HexNut" ));
                            }
                            else
                            {
                                parts.Add(new PartInfo(PIPE_CLAMP, pipeAttType));
                        ...
                        if (topType == "ROD_BEAM_ATT")
                        {
                            if (turnbuckle == 1) // 1 means With Turnbuckle
                            {
                                ...
                                parts.Add(new PartInfo(ATT_NUT4, "Anv10_HexNut" ));
                            }
                            else
                            {
                                parts.Add(new PartInfo(PIPE_CLAMP, pipeAttType));
                        ...
                        if (topType == "ROD_WASHER")
                        {
                            if (turnbuckle == 1) // 1 means With Turnbuckle
                            {
                                ...
                                parts.Add(new PartInfo(WASH_NUT4, "Anv10_HexNut" ));
                            }
                            else
                            {
                                parts.Add(new PartInfo(PIPE_CLAMP, pipeAttType));
            ...
            try
            {
                ...
                if (topType == "ROD_C_CLAMP")
                {
                    ...
                    if (turnbuckle == 1) // 1 means With Turnbuckle
                    {
                        ...
                        JointHelper.CreateRigidJoint(ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(TB, "RodEnd1", ROD1, "RodEnd1", Plane.XY, Plane.XY, Axis.Y, Axis.Y, 0, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(ROD2, "RodEnd1", NUT2, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 - clampThickness, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(ROD2, "RodEnd2", NUT3, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(ROD1, "RodEnd1", NUT4, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);
                    }
                    else
                    {
                        // Add a revolute Joint between bottom rod and Clevis Hanger

                        JointHelper.CreateRevoluteJoint(ROD1, "RodEnd1", PIPE_CLAMP, "RodEnd", Axis.X, Axis.Y);

                        // Add a Rigid Joint between the bottom nut and the rod

                        JointHelper.CreateRigidJoint(ROD1, "RodEnd1", NUT1, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(ROD1, "RodEnd1", NUT2, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 - clampThickness, 0, 0);
                    }
                }
                ...
                if (topType == "ROD_CLEVIS_LUG")
                {
                    ...
                    if (turnbuckle == 1) // 1 means With Turnbuckle
                    {
                        ...
                        JointHelper.CreateRigidJoint(LUG_ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);

                        // Add a Rigid Joint between bottom rod and Turnbuckle

                        JointHelper.CreateRigidJoint(LUG_ROD2, "RodEnd2", LUG_TB, "RodEnd2", Plane.XY, Plane.XY, Axis.X, Axis.Y, 0, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(LUG_ROD2, "RodEnd1", NUT2, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 - clampThickness, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(LUG_ROD2, "RodEnd2", LUG_NUT3, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(ROD1, "RodEnd1", LUG_NUT4, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);
                    }
                    else
                    {
                        // Add a revolute Joint between bottom rod and Clevis Hanger

                        JointHelper.CreateRevoluteJoint(ROD1, "RodEnd1", PIPE_CLAMP, "RodEnd", Axis.X, Axis.X);
                ...
                if (topType == "ROD_BEAM_ATT")
                {
                    ...
                    JointHelper.CreateRevoluteJoint(EYE_NUT, "Eye", BEAM_ATT, "Pin", Axis.X, Axis.X);
                    ...
                    if (turnbuckle == 1)
                    {
                        ...
                        JointHelper.CreateRigidJoint(ATT_ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);

                        // Add a Rigid Joint between bottom rod and Turnbuckle

                        JointHelper.CreateRigidJoint(ATT_ROD2, "RodEnd2", ATT_TB, "RodEnd2", Plane.XY, Plane.XY, Axis.X, Axis.Y, 0, 0, 0);

                        // Add a Rigid Joint between bottom rod and Turnbuckle
                        JointHelper.CreateRigidJoint(ATT_TB, "RodEnd1", ROD1, "RodEnd1", Plane.XY, Plane.XY, Axis.Y, Axis.Y, 0, 0, 0);

                        // Add a Rigid Joint between the bottom nut and the rod

                        JointHelper.CreateRigidJoint(ATT_ROD2, "RodEnd1", NUT1, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(ATT_ROD2, "RodEnd1", NUT2, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 - clampThickness, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(ATT_ROD2, "RodEnd2", ATT_NUT3, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(ROD1, "RodEnd1", ATT_NUT4, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);
                    }
                    else
                    {
                        // Add a revolute Joint between bottom rod and Clevis Hanger
                ...
                if (topType == "ROD_WASHER")
                {
                    ...
                    if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                        JointHelper.CreatePrismaticJoint(WASHER, "Port1", "-1", "Structure", Plane.XY, Plane.NegativeXY, Axis.Y, Axis.X, -supportingSectionDepth, 0);
                    else
                        JointHelper.CreatePlanarJoint(WASHER, "Port1", "-1", "Structure", Plane.XY, Plane.NegativeXY, -supportingSectionDepth);
                    ...
                    if (turnbuckle == 1) // 1 means With Turnbuckle
                    {
                        ...
                        JointHelper.CreateRigidJoint(WASH_ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(WASH_TB, "RodEnd1", ROD1, "RodEnd1", Plane.XY, Plane.XY, Axis.Y, Axis.Y, 0, 0, 0);

                        // Add a Rigid Joint between the bottom nut and the rod

                        JointHelper.CreateRigidJoint(WASH_ROD2, "RodEnd1", NUT1, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(WASH_ROD2, "RodEnd1", NUT2, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 - clampThickness, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(WASH_ROD2, "RodEnd2", WASH_NUT3, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(ROD1, "RodEnd1", WASH_NUT4, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);
                    }
                    else
                    {
                        // Add a revolute Joint between bottom rod and Clevis Hanger
                ...
                if (topType == "ROD_NUT")
                {
                    ...
                    if (turnbuckle == 1) // 1 means With Turnbuckle
                    {
                        ...
                        JointHelper.CreateRigidJoint(NUT_ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(NUT_TB, "RodEnd1", ROD1, "RodEnd1", Plane.XY, Plane.XY, Axis.Y, Axis.Y, 0, 0, 0);

                        // Add a Rigid Joint between the bottom nut and the rod

                        JointHelper.CreateRigidJoint(NUT_ROD2, "RodEnd1", NUT1, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(NUT_ROD2, "RodEnd1", NUT2, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition1 - clampThickness, 0, 0);
                        ...
                        JointHelper.CreateRigidJoint(NUT_ROD2, "RodEnd2", NUT_NUT3, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);

                        JointHelper.CreateRigidJoint(ROD1, "RodEnd1", NUT_NUT4, "Top", Plane.XY, Plane.XY, Axis.X, Axis.X, nutPosition + nutThichness, 0, 0);
                    }
                    else
                    {
                        // Add a revolute Joint between bottom rod and Clevis Hanger
