...
//
//   G4G_1400_H.cs
//   PipeHgrAssemblies2,Ingr.SP3D.Content.Support.Rules.G4G_1400_H
//   Author       : Vinay
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PipeHgrAssemblies2,Ingr.SP3D.Content.Support.Rules.G4G_1400_H"
        //----------------------------------------------------------------------------------
        //Constants
        private const string BEAM_ATT = "WELDEDBEAMATTACHMENT";
        private const string EYE_NUT = "EYENUT1";
        private const string ROD = "ROD";
        private const string PIPE_CLAMP = "PIPECLAMP";
        private const string LOW_EYE_NUT = "EYENUT2";
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    //Pipe Clamp
                    parts.Add(new PartInfo(PIPE_CLAMP, "S3Dhs_MediumPipeClamp"));

                    //TopEyenut
                    parts.Add(new PartInfo(EYE_NUT, "S3Dhs_EyeNut-" + rodDiametr1));

                    //BottomEyenut
                    parts.Add(new PartInfo(LOW_EYE_NUT, "S3Dhs_EyeNut-" + rodDiametr1));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                JointHelper.CreateRigidJoint("-1", "Route", PIPE_CLAMP, "Route", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                ...
                JointHelper.CreateRigidJoint(ROD, "RodEnd1", LOW_EYE_NUT, "RodEnd", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
