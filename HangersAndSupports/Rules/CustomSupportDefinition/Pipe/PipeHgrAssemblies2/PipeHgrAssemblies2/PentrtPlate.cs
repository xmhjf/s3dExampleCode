...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class PentrtPlate : CustomSupportDefinition
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.PentrtPlate"
        //----------------------------------------------------------------------------------
        //Constants
        private const string HGRSUPPENTRTPLATE = "HgrSupPentrtPlate";
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    PartClass hgrSupPentrtPlatePartClass = (PartClass)catalogBaseHelper.GetPartClass("HgrSupPentrtPlate");
                    ...
                    parts.Add(new PartInfo(HGRSUPPENTRTPLATE, "HgrSupPentrtPlate", partselection));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                BusinessObject pentrtPlatepart = (componentDictionary[HGRSUPPENTRTPLATE]).GetRelationship("madeFrom", "part").TargetObjects[0];
                ...
                // String BBXWidth = BBX.;
                (componentDictionary[HGRSUPPENTRTPLATE]).SetPropertyValue(width, "IJUAHgrOccGeometry", "Width");
                (componentDictionary[HGRSUPPENTRTPLATE]).SetPropertyValue(height, "IJUAHgrOccGeometry", "Height");
                ...
                (componentDictionary[HGRSUPPENTRTPLATE]).SetPropertyValue(lcsBBox_Low.GetIndexValue(12), "IJUAHgrOccPenPlate", "PipePort_X");
                (componentDictionary[HGRSUPPENTRTPLATE]).SetPropertyValue(lcsBBox_Low.GetIndexValue(13), "IJUAHgrOccPenPlate", "PipePort_Y");

                //Set the part type on the penetration plate
                (componentDictionary[HGRSUPPENTRTPLATE]).SetPropertyValue(PartTypecodeList, "IJExternalWeldedPipePart", "PartType");
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                    JointHelper.CreateRigidJoint("-1", "BBS_Low", HGRSUPPENTRTPLATE, "Structure", Plane.YZ, Plane.XY, Axis.Y, Axis.X, 0, 0, 0);
                else
                    JointHelper.CreateRigidJoint("-1", "BBR_Low", HGRSUPPENTRTPLATE, "Structure", Plane.YZ, Plane.XY, Axis.Y, Axis.X, 0, 0, 0);
            ...
            get
            {
                try
                {
                    ...
                    for (int index = 1; index <= numberOfRoutes; index++)
                    {
                        ...
                        routeConnections.Add(new ConnectionInfo(HGRSUPPENTRTPLATE, index));
                    }
            ...
            get
            {
                try
                {
                    ...
                    if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                    {
                        ...
                        structConnections.Add(new ConnectionInfo(HGRSUPPENTRTPLATE, 1));
                    }
