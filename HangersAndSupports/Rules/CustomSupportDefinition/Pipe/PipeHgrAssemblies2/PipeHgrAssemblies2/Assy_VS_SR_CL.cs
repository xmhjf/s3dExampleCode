...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_VS_SR_CL : CustomSupportDefinition
    {
        ...
        private String topType, rodType, springType, pipeAttType;
        private int tempDir;
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                componentDictionary[SPRING].SetPropertyValue(actualTravel, "IJUAhsOperatingTravel", "OperatingTravel");
                componentDictionary[SPRING].SetPropertyValue(tempDir, "IJUAhsMovementDir", "MovementDirection");
                ...
                if (topType == "ROD_C_CLAMP")
                {
                    ...
                    else if (SupportHelper.PlacementType == PlacementType.PlaceByReference)
                    {
                        ...
                        JointHelper.CreatePrismaticJoint(C_CLAMP, "Bottom", "-1", "Structure", Plane.XY, Plane.NegativeXY, Axis.X, Axis.Y, flangeThickness / 2, 0);

                        JointHelper.CreateRigidJoint(ROD1, "RodEnd2", C_CLAMP, "RodEnd1", Plane.XY, Plane.XY, Axis.Y, Axis.NegativeX, 0, 0, 0);
                    }
                    else
                    {
                    ...
                    JointHelper.CreateRevoluteJoint(ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Axis.Y, Axis.NegativeY);

                    // Add a Rigid Joint between bottom rod and Turnbuckle

                    JointHelper.CreateRigidJoint(ROD2, "RodEnd2", SPRING, "RodEnd1", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);

                    // Add a Rigid Joint between bottom rod and Turnbuckle

                    JointHelper.CreateRigidJoint(SPRING, "RodEnd2", ROD1, "RodEnd1", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                ...
                if (topType == "ROD_CLEVIS_LUG")
                {
                    ...
                    JointHelper.CreateRevoluteJoint(LUG_ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Axis.X, Axis.Y);

                    // Add a Rigid Joint between bottom rod and Turnbuckle

                    JointHelper.CreateRigidJoint(LUG_ROD2, "RodEnd2", SPRING, "RodEnd1", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);
                ...
                if (topType == "ROD_BEAM_CLAMP")
                {
                    ...
                    JointHelper.CreateRevoluteJoint(ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Axis.X, Axis.Y);

                    // Add a Rigid Joint between bottom rod and Turnbuckle

                    JointHelper.CreateRigidJoint(ROD2, "RodEnd2", SPRING, "RodEnd1", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);

                    // Add a Rigid Joint between Top rod and Spring
                ...
                if (topType == "ROD_BEAM_ATT")
                {
                    ...
                    JointHelper.CreateRigidJoint(ATT_ROD2, "RodEnd2", SPRING, "RodEnd1", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);
                    ...
                    JointHelper.CreateRevoluteJoint(ATT_ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Axis.X, Axis.Y);
                ...
                if (topType == "ROD_WASHER")
                {
                    ...
                    JointHelper.CreateRevoluteJoint(WASH_ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Axis.X, Axis.Y);

                    // Add a Rigid Joint between bottom rod and Turnbuckle

                    JointHelper.CreateRigidJoint(WASH_ROD2, "RodEnd2", SPRING, "RodEnd1", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);
                ...
                if (topType == "ROD_NUT")
                {
                    ...
                    JointHelper.CreateRevoluteJoint(NUT_ROD2, "RodEnd1", PIPE_CLAMP, "RodEnd", Axis.X, Axis.Y);

                    // Add a Rigid Joint between bottom rod and Turnbuckle

                    JointHelper.CreateRigidJoint(NUT_ROD2, "RodEnd2", SPRING, "RodEnd1", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);
                ...
                if (topType == "ROD_BEAM_ATT_B")
                {
                    ...
                    if (Configuration == 2)
                        JointHelper.CreateRigidJoint(ROD1, "RodEnd2", SPRING, "RodEnd1", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);
                    else
                        JointHelper.CreateRigidJoint(ROD1, "RodEnd2", SPRING, "RodEnd1", Plane.XY, Plane.NegativeXY, Axis.X, Axis.Y, 0, 0, 0);
                ...
                if (topType == "ROD_LUG_C")
                {
                    ...
                    JointHelper.CreateRigidJoint(SPRING, "Hole", LUG_C_PIN, "Pin", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);
