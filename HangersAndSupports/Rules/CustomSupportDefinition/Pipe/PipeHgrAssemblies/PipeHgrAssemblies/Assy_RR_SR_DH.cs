...
//
//   Assy_RR_SR_DH.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.Assy_RR_SR_DH
//   Author       : Rajeswari
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_RR_SR_DH : CustomSupportDefinition
    {
        // For everything
            ...
            get
            {
                try
                {
                    ...
                    if (topType == "ROD_C_CLAMP")
                    {
                        ...
                        {
                            parts.Add(new PartInfo(PIPE_CLAMP, "Anvil_FIG295H"));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (topType == "ROD_C_CLAMP")
                {
                    ...
                    {
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "C-Clamp Top Type can not be placed by 'Place By Reference' Command", "", "Assy_RR_SR_DH.cs", 1);
                        return;
                    }
