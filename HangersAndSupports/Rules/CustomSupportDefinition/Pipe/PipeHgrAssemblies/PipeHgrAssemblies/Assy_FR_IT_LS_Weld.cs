...
//
//   Assy_FR_IT_LS_Weld.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.Assy_FR_IT_LS_Weld
//   Author       :  Vijay
...
//   -----------     ---     ------------------
//   05-04-2013     Vijay   CR-CP-224484  Convert HS_Assembly to C# .Net  
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_FR_IT_LS_Weld : CustomSupportDefinition
    {
        ...
        private string WELDPART = "WELDPART";
            ...
            get
            {
                try
                {
                    ...
                    if (basePlate == "With")
                    {
                        ...
                        parts.Add(new PartInfo(WELDPART, "S3Dhs_WeldRect-1"));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                {
                    ...
                    PropertyValueCodelist primarySideSymbolCodeList = (PropertyValueCodelist)componentDictionary[WELDPART].GetPropertyValue("IJWeldingSymbol", "PrimarySideSymbol");
                    if (primarySideSymbolCodeList.PropValue == -1)
                        primarySideSymbolCodeList.PropValue = 1;

                    componentDictionary[HOR_SECTION].SetPropertyValue(width1 + width2, "IJUAHgrOccLength", "Length");
                    componentDictionary[WELDPART].SetPropertyValue(steelWidth - overLap, "IJOAWeldDimensions", "Width");
                    componentDictionary[WELDPART].SetPropertyValue(steelDepth, "IJOAWeldDimensions", "Height");
                    componentDictionary[WELDPART].SetPropertyValue(primarySideSymbolCodeList.PropValue, "IJWeldingSymbol", "PrimarySideSymbol");
                    componentDictionary[WELDPART].SetPropertyValue(true, "IJWeldingSymbol", "AllAround");
                    componentDictionary[WELDPART].SetPropertyValue(0.0063, "IJWeldingSymbol", "PrimarySideActualThroatThickness");
                    ...
                    JointHelper.CreateRigidJoint(HOR_SECTION, "BeginCap", WELDPART, "Other", Plane.YZ, Plane.NegativeXY, Axis.Z, Axis.NegativeY, 0, 0, width2 + steelDepth / 2.0);
                ...
                else
                {
                    if (connection == "Steel")
                    {
                        ...
                        else
                        {
                            ...
                            //Add Joint Between Structure and Vertical Beam
                            if (Configuration == 1 || Configuration == 2 || Configuration == 5 || Configuration == 6)
                                JointHelper.CreateRigidJoint("-1", "Structure", VERT_SECTION, "EndCap", pointStructPlane[0], pointStructPlane[1], pointStructAxis[0], pointStructAxis[1], 0.0, pointStructOffset, 0);
                            else if (Configuration == 3 || Configuration == 4 || Configuration == 7 || Configuration == 8)
                                JointHelper.CreateRigidJoint("-1", "Structure", VERT_SECTION, "BeginCap", pointStructPlane[0], pointStructPlane[1], pointStructAxis[0], pointStructAxis[1], 0.0, pointStructOffset, 0);
                        }

                        if (Configuration == 1 || Configuration == 4 || Configuration == 5 || Configuration == 8)
                            JointHelper.CreateRigidJoint(HOR_SECTION, "BeginCap", WELDPART, "Other", Plane.YZ, Plane.NegativeXY, Axis.Z, Axis.NegativeY, 0, 0, width2 + steelDepth / 2.0);
                        else
                            JointHelper.CreateRigidJoint(HOR_SECTION, "EndCap", WELDPART, "Other", Plane.YZ, Plane.NegativeXY, Axis.Z, Axis.NegativeY, 0, 0, -(width2 - steelDepth / 2.0));
                    ...
                    if (connection == "Slab")
                    {
                        ...
                        if (Configuration == 1 || Configuration == 4 || Configuration == 5 || Configuration == 8)
                            JointHelper.CreateRigidJoint(HOR_SECTION, "BeginCap", WELDPART, "Other", Plane.YZ, Plane.NegativeXY, Axis.Z, Axis.NegativeY, 0, 0, width1 + steelDepth / 2.0);
                        else
                            JointHelper.CreateRigidJoint(HOR_SECTION, "BeginCap", WELDPART, "Other", Plane.ZX, Plane.XY, Axis.Z, Axis.NegativeY, 0, 0, width2 + steelDepth / 2.0);
                ...
                if (excludeNote == false)
                    note = CreateNote("Support Notes", HOR_SECTION, "BeginCap", new Position(0.0, 0.0, 0.0), "SN", false, 2, 55, out controlPoint);
                else
                    DeleteNoteIfExists("Support Notes");
