...
//
//   Assy_RR_SR_DB.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.Assy_RR_SR_DB
//   Author       : Rajeswari
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_RR_SR_DB : CustomSupportDefinition
    {
        // For everything
                ...
                try
                {
                    ...
                    beamClampSize = (string)((PropertyValueString)support.GetPropertyValue("IJUAHgrAssyRR", "BEAM_CLAMP_SIZE")).PropValue;
                        ...
                        if (topType == "ROD_C_CLAMP")
                        {
                            ...
                            {
                                parts.Add(new PartInfo(PIPE_CLAMP, "Anvil_FIG295"));
            ...
            try
            {
                 ...
                 if (topType == "ROD_C_CLAMP")
                {
                    if (SupportHelper.PlacementType == PlacementType.PlaceByReference)
                    {
                        ...
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "C-Clamp Top Type can not be placed by 'Place By Reference' Command", "", "Assy_RR_SR_DB.cs", 1);
                        return;
                    }
                    else
                    {
