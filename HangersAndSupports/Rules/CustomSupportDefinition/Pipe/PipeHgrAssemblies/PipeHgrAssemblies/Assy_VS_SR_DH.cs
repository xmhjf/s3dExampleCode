...
//
//   Assy_RR_SR_CL.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.Assy_VS_SR_DH
//   Author       : Hema
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_VS_SR_DH : CustomSupportDefinition
    {
        //----------------------------------------------------------------------------------
            ...
            try
            {
               ...
               if (HgrCompareDoubleService.cmpdbl(Math.Round(routeAngle, 3) , 0)==false)
                ...
                if (topType == "ROD_C_CLAMP")
                {
                    ...
                    {
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "C-Clamp Top Type can not be placed by 'Place By Reference' Command", "", "Assy_VS_SR_DH", 1);
                        return;
                    }
