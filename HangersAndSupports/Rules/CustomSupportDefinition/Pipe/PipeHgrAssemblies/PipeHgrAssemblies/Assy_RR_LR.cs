...
//   21.Nov.2013    Vijay    HF-CP-243509  [TR] Issues observed in H&S .net delivered content  
    ...
    public class Assy_RR_LR : CustomSupportDefinition
    {
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    {
                        parts.Add(new PartInfo(DIM_1, "HSDimensionPort" + "_1"));   //2nd part
                        parts.Add(new PartInfo(DIM_2, "HSDimensionPort" + "_1"));   //3rd part
                    }
                    //**************************************************************
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (isDimensionPort == true)
                {
                    JointHelper.CreateRigidJoint(DIM_1, "Dimension", CLAMP_TYPE, "Route", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                    JointHelper.CreateRigidJoint(DIM_2, "Dimension", DIM_1, "Dimension", Plane.XY, Plane.XY, Axis.X, Axis.X, -length, 0, 0);
                    //*****************************************
                    // L Note
                    //*****************************************
                    Note noteLStart = CreateNote("L_Start", componentDictionary[DIM_1], "Dimension");
                    noteLStart.SetPropertyValue("", "IJGeneralNote", "Text");
                    CodelistItem fabrication = noteLStart.GetPropertyValue("IJGeneralNote", "Purpose").PropertyInfo.CodeListInfo.GetCodelistItem(3);
                    ...
                    Note noteLEnd = CreateNote("L_End", componentDictionary[DIM_2], "Dimension");
                    noteLEnd.SetPropertyValue("", "IJGeneralNote", "Text");
                    fabrication = noteLEnd.GetPropertyValue("IJGeneralNote", "Purpose").PropertyInfo.CodeListInfo.GetCodelistItem(3);
                    noteLEnd.SetPropertyValue(fabrication, "IJGeneralNote", "Purpose"); //value 3 means fabrication
                    noteLEnd.SetPropertyValue(true, "IJGeneralNote", "Dimensioned");
                }
