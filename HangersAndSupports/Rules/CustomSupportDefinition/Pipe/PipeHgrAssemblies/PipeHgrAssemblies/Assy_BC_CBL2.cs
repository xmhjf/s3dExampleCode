...
//
//   Assy_BC_CBL2.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.Assy_BC_CBL2
//   Author       :  Vijay
...
//   -----------     ---     ------------------
//   18-04-2013     Vijay   CR-CP-224484  Convert HS_Assembly to C# .Net  
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_BC_CBL2 : CustomSupportDefinition
    {
            ...
            get
            {
                try
                {
                    ...
                    if (basePlate == "With")
                    {
                        ...
                        parts.Add(new PartInfo(ANGLE_SECTION, "Utility_CUTBACK_L2_1"));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                Note note3 = CreateNote("Dim3", componentDictionary[ANGLE_SECTION], "StartStructure");
                ...
                if (Math.Abs(angle) < Math.Round(Math.PI, 2) / 2)
                {
                    ...
                    else if (Configuration == 3)
                    {
                        ...
                        {
                            confStructPlane[0] = Plane.XY;
                            confStructPlane[1] = Plane.NegativeXY;
                            confStructAxis[0] = Axis.X;
                            confStructAxis[1] = Axis.NegativeY;
                ...
                double tr1Leg1, tr1Leg2, tr1Leg3, z1, z4, plateThickness, orderLength, yoffSet = 0, axisBraceOffset;
                string cutbackBOM;

                axisBraceOffset = (steelDepth / 2) / Math.Sin(cutBackAngle);
                ...
                if (basePlate == "With")
                {
                    ...
                    tr1Leg1 = length - plateThickness;
                    tr1Leg2 = tr1Leg1 * Math.Tan(cutBackAngle) + steelThickness - steelDepth / 2;
                    tr1Leg3 = (length - plateThickness) / Math.Cos(cutBackAngle);

                    z1 = (steelDepth / 2.0) / Math.Tan(cutBackAngle);
                    z4 = (steelDepth / 2.0) / Math.Tan(cutBackAngle2);
                    orderLength = tr1Leg3 + z1 + z4;
                    ...
                    componentDictionary[TOP_SECTION].SetPropertyValue(tr1Leg1, "IJUAHgrOccLength", "Length");

                    componentDictionary[ANGLE_SECTION].SetPropertyValue(tr1Leg3, "IJOAHgrUtility_GENERIC_L", "L");
                    componentDictionary[ANGLE_SECTION].SetPropertyValue(steelWidth, "IJOAHgrUtility_GENERIC_L", "WIDTH");
                    componentDictionary[ANGLE_SECTION].SetPropertyValue(steelDepth, "IJOAHgrUtility_GENERIC_L", "DEPTH");
                    componentDictionary[ANGLE_SECTION].SetPropertyValue(steelThickness, "IJOAHgrUtility_GENERIC_L", "THICKNESS");
                    ...
                    componentDictionary[ANGLE_SECTION].SetPropertyValue(cutbackBOM, "IJOAHgrUtility_GENERIC_L", "BOM_DESC");
                    ...
                    if (Configuration == 1 || Configuration == 2)
                        ...
                        componentDictionary[TOP_SECTION].SetPropertyValue((pipeDiaHeight / 2) + overHang, "IJUAHgrOccOverLength", "BeginOverLength");
                    ...
                    if (Configuration == 1 || Configuration == 2)
                        ...
                        JointHelper.CreateRigidJoint(TOP_SECTION, "EndCap", TOP_PLATE, "BotStructure", Plane.XY, Plane.NegativeXY, Axis.X, Axis.NegativeX, 0, steelDepth / 2, steelWidth / 2);

                    JointHelper.CreateRigidJoint(TOP_PLATE, "TopStructure", BOT_PLATE, "TopStructure", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, tr1Leg2, 0);
                ...
                else
                {
                    ...
                    tr1Leg1 = length;
                    tr1Leg2 = tr1Leg1 * Math.Tan(cutBackAngle) + steelThickness - steelDepth / 2;
                    tr1Leg3 = length / Math.Cos(cutBackAngle);
                    ...
                    if (Configuration == 1 || Configuration == 2)
                        componentDictionary[TOP_SECTION].SetPropertyValue((pipeDiameter / 2) + overHang, "IJUAHgrOccOverLength", "EndOverLength");
                    else if (Configuration == 3 || Configuration == 4)
                        componentDictionary[TOP_SECTION].SetPropertyValue((pipeDiameter / 2) + overHang, "IJUAHgrOccOverLength", "BeginOverLength");
                }
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                {
                    if (Configuration == 1 || Configuration == 2)
                        ...
                        JointHelper.CreateRigidJoint("-1", "Structure", TOP_SECTION, "EndCap", confStructPlane[0], confStructPlane[1], confStructAxis[0], confStructAxis[1], plateThickness, structOffset, offset);
                }
                else
                {
                    if ((SupportHelper.SupportingObjects.Count != 0))
                    {
                        ...
                        else
                        {
                            if (Configuration == 1 || Configuration == 2)
                            {
                                ...
                                JointHelper.CreateRigidJoint("-1", "Structure", TOP_SECTION, "EndCap", confStructPlane[0], confStructPlane[1], confStructAxis[0], confStructAxis[1], plateThickness, offset, structOffset);
                        }
                    }
                    else
                    {
                ...
                if (Configuration == 1 || Configuration == 2)
                    JointHelper.CreateRigidJoint(TOP_SECTION, "EndCap", ANGLE_SECTION, "EndStructure", Plane.ZX, Plane.NegativeYZ, Axis.X, Axis.Y, steelThickness, axisBraceOffset, yoffSet + steelThickness);
                else if (Configuration == 3 || Configuration == 4)
                    JointHelper.CreateRigidJoint(TOP_SECTION, "BeginCap", ANGLE_SECTION, "StartStructure", Plane.ZX, Plane.YZ, Axis.X, Axis.Y, steelThickness, -axisBraceOffset, yoffSet + steelThickness);

                if (includeWeld == true)
                {
                    //Add Joint Between the Angle Section and the Weld Part 2
                    JointHelper.CreateRigidJoint(ANGLE_SECTION, "EndStructure", WELDPART2, "Other", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);

                    //Add Joint Between the Angle Section and the Weld Part 1
                    JointHelper.CreateRigidJoint(ANGLE_SECTION, "StartStructure", WELDPART1, "Other", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                }
