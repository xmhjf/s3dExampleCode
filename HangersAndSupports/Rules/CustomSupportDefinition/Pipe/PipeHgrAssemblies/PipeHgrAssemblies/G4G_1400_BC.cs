...
//
//   G4G_1400_U.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.G4G_1400_BC
//   Author       : Hema
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    {
        //----------------------------------------------------------------------------------
        //DefinitionName/ProgID of this symbol is "PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.G4G_1400_BC"
        //----------------------------------------------------------------------------------
        //Constants
        // private const string G4G_1400_BC = "G4G_1400_BC";
        private const string G4G_1461_01 = "G4G_1461_01_P01";
        private const string G4G_1460_01 = "G4G_1460_01_P02";
        private const string G4G_1451_04 = "G4G_1451_04_P03";
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    PartClass g4g_1461_01PartClass, g4g_1460_01PartClass, g4g_1451_04PartClass;
                    ...
                    g4g_1451_04PartClass = (PartClass)catalogBaseHelper.GetPartClass("G4G_1451_04"); ;

                    //Use the default selection rule to get a catalog part for each part class
                    string partselection = g4g_1461_01PartClass.GetPropertyValue("IJHgrPartClass", "PartSelectionRule").ToString();
                    string partselection1 = g4g_1460_01PartClass.GetPropertyValue("IJHgrPartClass", "PartSelectionRule").ToString();
                    string partselection2 = g4g_1451_04PartClass.GetPropertyValue("IJHgrPartClass", "PartSelectionRule").ToString();
                    ...
                    //HngSupHgrAssemblySymbols.BottomLug  (Bottom Lug)
                    parts.Add(new PartInfo(G4G_1451_04, "G4G_1451_04", partselection2));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                double pipeRadius, beamWidth = 0.0;
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                    JointHelper.CreatePrismaticJoint(G4G_1451_04, "Route", "-1", "Route", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0);
                else
                    JointHelper.CreateRigidJoint(G4G_1451_04, "Route", "-1", "Route", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                ...
                JointHelper.CreateSphericalJoint(G4G_1451_04, "Rod", G4G_1460_01, "RodBottom");
        ...
        public override Collection<ConnectionInfo> SupportedConnections
        {
            get
            {
                try
                {
                    ...
                    routeConnections.Add(new ConnectionInfo(G4G_1451_04, 1));
