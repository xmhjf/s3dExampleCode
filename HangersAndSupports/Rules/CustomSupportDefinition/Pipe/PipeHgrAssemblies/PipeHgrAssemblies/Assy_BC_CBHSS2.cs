...
//
//   Assy_BC_CBHSS2.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.Assy_BC_CBHSS2
//   Author       :  Vijay
...
//   -----------     ---     ------------------
//   17-04-2013     Vijay   CR-CP-224484  Convert HS_Assembly to C# .Net  .
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_BC_CBHSS2 : CustomSupportDefinition
    {
            ...
            get
            {
                try
                {
                    ...
                    if (basePlate == "With")
                    {
                        ...
                        parts.Add(new PartInfo(ANGLE_SECTION, "Utility_CUTBACK_TS2_1"));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                double steelThickness = (double)((PropertyValueDouble)crosssection.GetPropertyValue("IJUAHSS", "tnom")).PropValue;
                ...
                double triLeg1 = 0, trileg2 = 0, trileg3, plateT = 0, calc1, z1, z4, orderLength, axisBraceOffset;
                string cutBackBom;
                ...
                if (basePlate == "With")
                {
                    ...
                    triLeg1 = length + overHang - beamOverHang - plateT;
                    trileg2 = triLeg1 / Math.Tan(cutBackAngle2);
                    trileg3 = (length - plateT) / Math.Cos(cutBackAngle);
                    ...
                    componentDictionary[ANGLE_SECTION].SetPropertyValue(trileg3, "IJOAHgrUtility_GENERIC_L", "L");
