...
//
//   Assy_FR_US_LS.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.Assy_FR_US_LS
//   Author       :Vijaya
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_FR_US_LS : CustomSupportDefinition
    {
        //Constants
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                string leftStructPort = structPort[0], rightStructPort = structPort[1], connection;
                ...
                else
                {
                    if (connection == "Steel" && SupportHelper.SupportingObjects.Count > 1)
                    {
                        ...
                        {
                            //Add Joint Between Structure and Vertical Beam                           
                            JointHelper.CreatePointOnPlaneJoint(VERT_SECTION1, "EndCap", "-1", rightStructPort, Plane.XY);//4

                            //Add Joint Between Structure and Vertical Beam
                            JointHelper.CreatePointOnPlaneJoint(VERT_SECTION2, "BeginCap", "-1", leftStructPort, Plane.XY);//4
                        }
                    ...
                    if (connection == "Slab" || connection == "Steel" && SupportHelper.SupportingObjects.Count < 2)
                    {
                        ...
                        if (basePlate == "With")
                        {
                            ...
                            JointHelper.CreatePointOnPlaneJoint(PLATE1, "TopStructure", "-1", "StructAlt", Plane.XY);//4

                            //Add Joint Between Structure and Plate 2
                            JointHelper.CreatePointOnPlaneJoint(PLATE2, "TopStructure", "-1", "StructAlt", Plane.XY);//4
                    ...
                    if (connection == "Slab-Steel")
                    {
                        ...
                        if (basePlate == "With")
                        {
                            ...
                            //Steel Joint
                            JointHelper.CreatePointOnPlaneJoint(PLATE1, "TopStructure", "-1", rightStructPort, Plane.XY);//4

                            //Slab Joint
                            JointHelper.CreatePointOnPlaneJoint(PLATE2, "TopStructure", "-1", leftStructPort, Plane.XY);//4
