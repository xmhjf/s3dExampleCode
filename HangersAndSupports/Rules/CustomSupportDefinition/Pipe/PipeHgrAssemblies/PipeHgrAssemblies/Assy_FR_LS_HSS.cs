...
//
//   Assy_FR_LS_HSS.cs
//   PipeHgrAssemblies,Ingr.SP3D.Content.Support.Rules.Assy_FR_LS_HSS
//   Author       :  Vijay
...
//   -----------     ---     ------------------
//   09-04-2013     Vijay   CR-CP-224484  Convert HS_Assembly to C# .Net  
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class Assy_FR_LS_HSS : CustomSupportDefinition
    {
        ...
        private double shoeH, overHang, bpWidth, bpHoleSize, bpHoleInset, extension;
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    plateSize = (string)((PropertyValueString)support.GetPropertyValue("IJUAHgrAssyLS_HSS_WS", "PLATE_SIZE")).PropValue;
                    ...
                    bpHoleSize = (double)((PropertyValueDouble)support.GetPropertyValue("IJUAHgrAssyLS_HSS_WS", "BP_HOLE_SIZE")).PropValue;
            ...
            try
            {
               ...
               length = RefPortHelper.DistanceBetweenPorts("Route", "Structure", PortDistanceType.Horizontal);               
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                {
                    ...
                    JointHelper.CreateRigidJoint(HOR_SECTION, "EndCap", VERT_SECTION, "BeginCap", Plane.ZX, Plane.XY, Axis.X, Axis.NegativeX, -overLap, 0, steelDepth);
                ...
                else
                {
                    ...
                    if (connection == "Slab")
                    {
                        ...
                        //Add Joint Between the Horizontal and Vertical Beams
                        JointHelper.CreateRigidJoint(HOR_SECTION, "BeginCap", VERT_SECTION, "BeginCap", structRoutePlane[0], structRoutePlane[1], structRouteAxis[0], structRouteAxis[1], horOffset, pointStructOffset, steelWidth);
