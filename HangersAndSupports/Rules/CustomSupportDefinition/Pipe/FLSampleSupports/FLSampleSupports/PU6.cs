...
//
//   PU6.cs
//   FLSampleSupports,Ingr.SP3D.Content.Support.Rules.PU6
//   Author       : Rajeswari
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class PU6 : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Can not place-by-structure please place-by-point.", "", "PU6.cs", 113);
                    return;
                }
                ...
                componentDictionary[PLATE1].SetPropertyValue(plateWidth, "IJOAHgrUtility_VARIABLE_BOX", "WIDTH");
                componentDictionary[PLATE1].SetPropertyValue(plateHeight, "IJOAHgrUtility_VARIABLE_BOX", "DEPTH");
                componentDictionary[PLATE1].SetPropertyValue(plateThickness, "IJUAHgrOccLength", "Length");
                componentDictionary[PLATE1].SetPropertyValue("50x50x6 THK Carbon Steel Plate.", "IJOAHgrUtility_VARIABLE_BOX", "BOM_DESC");
                componentDictionary[PLATE2].SetPropertyValue(plateWidth, "IJOAHgrUtility_VARIABLE_BOX", "WIDTH");
                componentDictionary[PLATE2].SetPropertyValue(plateHeight, "IJOAHgrUtility_VARIABLE_BOX", "DEPTH");
                componentDictionary[PLATE2].SetPropertyValue(plateThickness, "IJUAHgrOccLength", "Length");
                ...
                JointHelper.CreateRigidJoint(HANGERBEAM, "BeginCap", PLATE1, "EndOther", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, hangerW / 2);
                JointHelper.CreateRigidJoint(HANGERBEAM, "EndCap", PLATE2, "EndOther", Plane.XY, Plane.XY, Axis.X, Axis.X, plateThickness, 0, hangerW / 2);
        ...
        {
            return "PU6 - Pick-Up from Single non-Insulated Line.";
        }
        #endregion
        /// <summary>
