...
//
//   PU3.cs
//   FLSampleSupports,Ingr.SP3D.Content.Support.Rules.PU3
//   Author       : Rajeswari
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class PU3:CustomSupportDefinition,ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Can not place-by-structure please place-by-point.", "", "PU3.cs", 78);
                    return;
                }
                ...
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Length can not exceed 1.2m.", "", "PU3.cs", 110);
                    return;
                }

                PipeObjectInfo routeInfo = (PipeObjectInfo)SupportedHelper.SupportedObjectInfo(1);
                if (routeInfo.InsulationThickness > 0)
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARININGMESSAGE", "ConfigureSupport" + ": " + "WARINING: " + "Not placable for Insulated pipe.", "", "PU3.cs", 116);
        ...
        {
            return "PU3 - Pick-Up from Single non-Insulated Line.";
        }
        #endregion
        /// <summary>
