...
//
//   Assy_SS3_V.cs
//   Power_Assy,Ingr.SP3D.Content.Support.Rules.Assy_SS3_V
//   Author       :  Vijaya
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    //-----------------------------------------------------------------------------------
    public class Assy_SS3_V : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        //Constants
        ...
        private const string NUT3 = " NUT3 "; // 6
        private const string NUT4 = " NUT4 "; // 7
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    PropertyValueCodelist sectionSizeCodelist = (PropertyValueCodelist)support.GetPropertyValue("IJUAHgrPowerAssyLSec", "LSize");
                    ...
                    if (support.SupportsInterface("IJUAHgrPowerAssySS3_V"))
                        interfaceName = "IJUAHgrPowerAssySS3_V";
                    else
                        interfaceName = "IJUAHgrPowerAssySS3";
                    ...
                    {
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "Parts" + ": " + "ERROR: " + "Rod spacing should be less than the support length. Please check the value.", "", "Assy_SS3_V.cs", 199);
                        return null;
                    }
                    ...
                    NominalDiameter[] diameterArray = GetNominalDiameterArray(new double[] { 20, 25, 32, 40, 50, 65, 80, 90, 100, 115, 125, 150, 200, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 750, 800, 850, 900, 950, 1000 }, "mm");
                    ...
                    for (index = 0; index < numOfRoutes; index++)
                    {
                        ...
                        {
                            MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "Parts" + ": " + "ERROR: " + "Parts are not available for this Pipe Size.", "", "Assy_SS3_V.cs", 354);
                            return null;
                        }
                        ...
                        PartClass auxilaryTable = (PartClass)catalogBaseHelper.GetPartClass("HgrAssy_SZ3PartSel");
                        ...
                        {
                            if (((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAssySZ3PartSel", "PipeOutDia")).PropValue > pipeDiameter1[index].Size - 0.01) && ((double)((PropertyValueDouble)classItem.GetPropertyValue("IJUAHgrAssySZ3PartSel", "PipeOutDia")).PropValue < pipeDiameter1[index].Size + 0.01) && ((string)((PropertyValueString)classItem.GetPropertyValue("IJUAHgrAssySZ3PartSel", "UnitType")).PropValue == pipeDiameter1[index].Units))
                            {
                                shoePart[index] = (string)((PropertyValueString)classItem.GetPropertyValue("IJUAHgrAssySZ3PartSel", "PartNo")).PropValue;
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "The structure is sloped. Please check.", "", "Assy_SS3.cs", 443);
                    return;
                }
                //====== ======
                ...
                double largePipeDiameter = pipeDiameter[0];
                Double H = 0.0;
                if (supportType.ToUpper() == "FIXED")
                {
                    H = shoeHeight;
                    for (index = 0; index < numOfRoutes; index++)
                        shoePart[0].SetPropertyValue(H, "IJUAHgrPowerSZ_ShoeH", "H");
                ...
                if (topType == 1)//ROD_CLEVIS_LUG
                {
                    ...
                    if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                    {
                        JointHelper.CreateRigidJoint("-1", "BBSR_Low", HOR_SECTION, "BeginCap", Plane.XY, Plane.NegativeZX, Axis.X, Axis.NegativeX, -H + largePipeDiameter / 2, BBXWidth / 2 + w1 + overhang, steelDepth / 2);//1196
                    ...
                    else
                    {
                        if (leftStructPort == rightStructPort)   // one piece of steel
                        {
                            if (configuration == "1" || configuration == "3")
                                ...
                                JointHelper.CreateRigidJoint("-1", "BBRV_Low", HOR_SECTION, "BeginCap", Plane.XY, Plane.NegativeZX, Axis.X, Axis.NegativeX, -H + largePipeDiameter / 2, overhang + BBXWidth / 2 + w1, steelDepth / 2);// 1196
                    ...
                    JointHelper.CreatePlanarJoint(HOR_SECTION, "BeginCap", ROD1, "BotExThdRH", Plane.ZX, Plane.XY, SteelThickness + nutThickness * 3);


                    JointHelper.CreatePlanarJoint(HOR_SECTION, "EndCap", ROD2, "BotExThdRH", Plane.ZX, Plane.XY, SteelThickness + nutThickness * 3);


                    //Add a Rigid Joint between the bottom nut and the rod
                    JointHelper.CreateRigidJoint(ROD1, "BotExThdRH", NUT1, "InThdRH", Plane.XY, Plane.XY, Axis.X, Axis.X, -nutThickness, 0, 0);//

                    JointHelper.CreateRigidJoint(ROD1, "BotExThdRH", NUT2, "InThdRH", Plane.XY, Plane.XY, Axis.X, Axis.X, -nutThickness * 2, 0, 0);//

                    JointHelper.CreateRigidJoint(ROD2, "BotExThdRH", NUT3, "InThdRH", Plane.XY, Plane.XY, Axis.X, Axis.X, -nutThickness, 0, 0);//

                    JointHelper.CreateRigidJoint(ROD2, "BotExThdRH", NUT4, "InThdRH", Plane.XY, Plane.XY, Axis.X, Axis.X, -nutThickness * 2, 0, 0);//
                ...
                if (topType == 2)//ROD_BEAM_CLAMP
                {
                    ...
                    if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                        JointHelper.CreateRigidJoint(BEAM_CLAMP, "Structure", "-1", "Structure", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, w1);//9380
                    ...
                    if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                        JointHelper.CreateRigidJoint(BEAM_CLAMP2, "Structure", "-1", "Structure", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, -w2);
                    ...
                    //Add a Rigid Joint between the bottom rods and the horizontal section
                    JointHelper.CreateRigidJoint(HOR_SECTION, "BeginCap", ROD1, "BotExThdRH", Plane.XY, Plane.NegativeZX, Axis.X, Axis.X, overhang, SteelThickness + nutThickness * 3, steelDepth / 2);//9388

                    JointHelper.CreateRigidJoint(HOR_SECTION, "EndCap", ROD2, "BotExThdRH", Plane.XY, Plane.NegativeZX, Axis.X, Axis.X, -overhang, SteelThickness + nutThickness * 3, steelDepth / 2);
                ...
                if (topType == 3)//ROD_BEAM_ATT
                {
                    ...
                    JointHelper.CreateRevoluteJoint(EYE_NUT, "Eye", BEAM_ATT, "Pin", Axis.X, Axis.Y);//81    
                    ...
                    JointHelper.CreateRevoluteJoint(ROD1, "TopExThdRH", EYE_NUT, "InThdRH", Axis.Z, Axis.Z);



                    //Rigid Joint causes Asserts, Turnbuckle will rotate but I don't care
                    ...
                    JointHelper.CreatePlanarJoint(HOR_SECTION, "BeginCap", ROD2, "BotExThdRH", Plane.ZX, Plane.XY, SteelThickness + nutThickness * 3);
                ...
                if (topType == 4)//ROD_WASHER
                {
                    ...
                    //Add a Rigid Joint between the bottom rods and the horizontal section
                    JointHelper.CreateRigidJoint(HOR_SECTION, "BeginCap", ROD1, "BotExThdRH", Plane.XY, Plane.NegativeZX, Axis.X, Axis.X, overhang, SteelThickness + nutThickness * 3, steelDepth / 2);
                ...
                if (topType == 5)//ROD_NUT
                {
                    ...
                    //Joint from L-Section to Pipe
                    if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                        JointHelper.CreateRigidJoint("-1", "BBSR_Low", HOR_SECTION, "BeginCap", Plane.XY, Plane.NegativeZX, Axis.X, Axis.NegativeX, -H + largePipeDiameter / 2, BBXWidth / 2 + w1 + overhang, steelDepth / 2);
        ...
        public string BOMDescription(BusinessObject SupportOrComponent)
        {
            ...
            try
            {
                ...
                {
                    if (supportType.ToUpper() == "FIXED")
                        BOMString = "SS3 Assembly for " + Math.Round(pipeDiameter.Size, 1) + " mm Pipe Outside Dia with fixed overall width and rod spacing";
                    else if (supportType.ToUpper() == "VARIABLE")
                        BOMString = "SS3 Assembly for " + Math.Round(pipeDiameter.Size, 1) + " " + pipeDiameter.Units + " with variable overall width and rod spacing";
                }
                else
                {
            ...
            {
                Type myType = this.GetType();
                CmnException e1 = new CmnException("Error in BOM of Assembly - Assy_ss3_V" + myType.Assembly.FullName + "," + myType.Namespace + "." + myType.Name + ". Error:" + e.Message, e);
                throw e1;
            }
        }
        #endregion
