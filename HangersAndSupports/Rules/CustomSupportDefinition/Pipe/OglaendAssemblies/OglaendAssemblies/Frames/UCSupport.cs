...
//
//   UCSupport.cs
//   OglaendAssemblies,Ingr.SP3D.Content.Support.Rules.UCSupport
//   Author       :  PVK
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    //-----------------------------------------------------------------------------------
    public class UCSupport : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        Boolean isMember, isLeg1, isLeg2, isweldstat1, isweldstat2;
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                Boolean includeInsulation = false;//(bool)((PropertyValueBoolean)support.GetPropertyValue("IJUAhsIncludeInsulation", "IncludeInsulation")).PropValue;
                ...
                if (supportingCount > 1)
                {
                    ...
                    else
                    {
                        ...
                        else if (SpanWidth < MinSpanWidth)
                        {
                            ...
                            MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARNINGMESSAGE", OglaendAssembliesLocalizer.GetString(OglaendAssembliesResourceIDs.ErrInvalidMinWidth, "Width is less than Minimumn Allowable Width. Resetting it to Minimumn Width."), "", "USupport_1", 346);
                            support.SetPropertyValue(SpanWidth, "IJUAhsOGSpanWidth", "SpanWidth");
                        }
                    }
                ...
                {
                    leg1BeginOverHang = sectionDepth;
                    leg2BeginOverHang = sectionDepth;
                }
                //'==========================
                //' Member 1  Overhangs
                //'==========================
                ...
                if (connection1Type == 0)
                {
                    member1BeginOverhang = -leg1Depth;
                    member1EndOverhang = -leg2Depth;
                }
                //==========================
                ...
                if (connectionSwap)
                    ...
                    OglaendAssemblyServices.SetSteelConnection(this, LEG_1, "BeginCap", ref leg1Data, leg1BeginOverHang, SECTION, "BeginCap", ref sectionData, member1BeginOverhang, (OglaendAssemblyServices.SteelConnectionAngle)90, 0, (OglaendAssemblyServices.SteelConnection)connection1Type, connection1Mirror, OglaendAssemblyServices.SteelJointType.SteelJoint_RIGID);
                ...
                if (connection2Swap)
                    ...
                    OglaendAssemblyServices.SetSteelConnection(this, LEG_2, "EndCap", ref leg2Data, leg2BeginOverHang, SECTION, "EndCap", ref sectionData, member1EndOverhang, (OglaendAssemblyServices.SteelConnectionAngle)270, 0, (OglaendAssemblyServices.SteelConnection)connection2Type, connection2Mirror, OglaendAssemblyServices.SteelJointType.SteelJoint_RIGID);
                //==========================
                // Set Steel CPs
                //==========================
                ...
                //'========================
                double Wlength1, WeldFlangeWidth,  Yoffset;
                ...
                Yoffset = leg1Depth / 2 - WeldFlangeWidth/2;

                if (Yoffset < 0) //for weld starters outside the lug
                    Yoffset = -Yoffset;
                else
                    Yoffset = Yoffset - leg1.webThickness;


                JointHelper.CreateAngularRigidJoint(WELDSTAT_1, "Structure", LEG_1, "EndCap", new Vector(0, -Yoffset, 0), new Vector(0, 0, Math.PI / 2));
                JointHelper.CreateAngularRigidJoint(WELDSTAT_2, "Structure", LEG_2, "BeginCap", new Vector(0, -Yoffset, 0), new Vector(0, Math.PI, Math.PI / 2));
