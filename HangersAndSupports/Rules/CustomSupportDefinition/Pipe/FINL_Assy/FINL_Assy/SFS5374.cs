...
//
//   SFS5374.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5374
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class SFS5374 : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        double rotation, normalPipeDiameterMetric;
        string material;


        private const string PLATE1 = "Plate1_5374";
        private const string PLATE2 = "Plate2_5374";
        private const string CONNOBJECT = "ConnObj_5374";
        private const string LEFTLEG = "LeftLeg_5374";
        private const string RIGHTLEG = "RightLeg_5374";
        private const string ROUTECONNOBJECT = "RouteConnObject_5374";
        private const string PIPECLAMP1 = "PipeClamp1_5374";
        private const string PIPECLAMP2 = "PipeClamp2_5374";
            ...
            get
            {
                try
                {
                    ...
                    if (IsPipeSizeValid(pipeInfo.NominalDiameter, minNominalDiameter, maxNominalDiameter, diameterArray) == false)
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARNINGMESSAGE", "Parts" + ": " + "WARNING: " + "Pipe size not valid.", "", "SFS5374.cs", 170);
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                double plateThickness = 8.0 / 1000, plateDepth = 60.0 / 1000, length = 350.0 / 1000;

                //Getting Dimension Information
                //Interface name: IJUAFINLSrv_SFS5374_Dim:: Pipe_Nom_Dia_m, Shoe_H Shoe_W, E ,A ,S ,Weight, Max_Load
                double shoeH = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5374_Dim", "IJUAFINLSrv_SFS5374_Dim", "Shoe_H", "IJUAFINLSrv_SFS5374_Dim", "Pipe_Nom_Dia_m", Convert.ToString(normalPipeDiameterMetric * 1000));
                double E = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5374_Dim", "IJUAFINLSrv_SFS5374_Dim", "E", "IJUAFINLSrv_SFS5374_Dim", "Pipe_Nom_Dia_m", Convert.ToString(normalPipeDiameterMetric * 1000));
                double A = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5374_Dim", "IJUAFINLSrv_SFS5374_Dim", "A", "IJUAFINLSrv_SFS5374_Dim", "Pipe_Nom_Dia_m", Convert.ToString(normalPipeDiameterMetric * 1000));
                double S = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5374_Dim", "IJUAFINLSrv_SFS5374_Dim", "S", "IJUAFINLSrv_SFS5374_Dim", "Pipe_Nom_Dia_m", Convert.ToString(normalPipeDiameterMetric * 1000));
                ...
                componentDictionary[LEFTLEG + "_" + Index].SetPropertyValue(A, "IJOAHgrUtility_GENERIC_L", "WIDTH");
                ...
                componentDictionary[RIGHTLEG + "_" + Index].SetPropertyValue(A, "IJOAHgrUtility_GENERIC_L", "WIDTH");
                ...
                //Plate
                JointHelper.CreateRigidJoint(ROUTECONNOBJECT + "_" + Index, "Connection", PLATE1 + "_" + Index, "StartOther", Plane.XY, Plane.XY, Axis.X, Axis.X, clampInnerDiameter / 2 + shoeH - plateThickness - 10.0 / 1000, 0, length / 2 - clampWidth - 30.0 / 1000);

                //Plate
                JointHelper.CreateRigidJoint(ROUTECONNOBJECT + "_" + Index, "Connection", PLATE2 + "_" + Index, "StartOther", Plane.XY, Plane.XY, Axis.X, Axis.X, clampInnerDiameter / 2 + shoeH - plateThickness - 10.0 / 1000, 0, -(length / 2 - clampWidth - 30.0 / 1000));
                ...
                if (Clamps == 1)      //With Clamp
                {
                    ...
                    if ((Math.Abs(verticalAngle) > 40 + 0.0001) && Symbols.HgrCompareDoubleService.cmpdbl(Math.Round(Math.Abs(verticalAngle)), 45) == false)
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARNINGMESSAGE", "ConfigureSupport" + ": " + "WARNING: " + "Clamp rotation cannot exceed 40 degrees.", "", "SFS5375.cs", 217);
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                if (Symbols.HgrCompareDoubleService.cmpdbl(rotationbom, 0) == true)
                    BOMString = "Pipe slide SFS 5374 DN " + Convert.ToString(pipeDiameter);
                else
                    BOMString = "Pipe slide SFS 5374 DN " + Convert.ToString(pipeDiameter) + " -" + Convert.ToString(Math.Round(angle, 0)) + Convert.ToString(176);
