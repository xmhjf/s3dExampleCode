...
//
//   SFS5859.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5859
//   Author       :  Manikanth
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class SFS5859 : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    {
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "Parts" + ": " + "ERROR: " + "Pipe size not valid.", "", "SFS5859.cs", 83);
                        return parts;
                    }
                    if (Clamps == 1)
                    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                double shoeH = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5859_Dim", "IJUAFINLSrv_SFS5859_Dim", "Shoe_H", "IJUAFINLSrv_SFS5859_Dim", "Pipe_Nom_Dia_m", Convert.ToString(nomPipeDiaMetric * 1000));
                double K = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5859_Dim", "IJUAFINLSrv_SFS5859_Dim", "K", "IJUAFINLSrv_SFS5859_Dim", "Pipe_Nom_Dia_m", Convert.ToString(nomPipeDiaMetric * 1000));
                double T = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5859_Dim", "IJUAFINLSrv_SFS5859_Dim", "T", "IJUAFINLSrv_SFS5859_Dim", "Pipe_Nom_Dia_m", Convert.ToString(nomPipeDiaMetric * 1000));
                double A = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5859_Dim", "IJUAFINLSrv_SFS5859_Dim", "A", "IJUAFINLSrv_SFS5859_Dim", "Pipe_Nom_Dia_m", Convert.ToString(nomPipeDiaMetric * 1000));
                double L = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5859_Dim", "IJUAFINLSrv_SFS5859_Dim", "L", "IJUAFINLSrv_SFS5859_Dim", "Pipe_Nom_Dia_m", Convert.ToString(nomPipeDiaMetric * 1000));
                double E = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5859_Dim", "IJUAFINLSrv_SFS5859_Dim", "E", "IJUAFINLSrv_SFS5859_Dim", "Pipe_Nom_Dia_m", Convert.ToString(nomPipeDiaMetric * 1000));
                ...
                (componentDictionary[CSECTION + " _ " + Index]).SetPropertyValue(F, "IJOAHgrUtility_Width", "Width");
                ...
                JointHelper.CreateRigidJoint(ROUTECONNOBJECT + " _ " + Index, "Connection", CSECTION + " _ " + Index, "EndCap", Plane.YZ, Plane.YZ, Axis.Z, Axis.NegativeZ, L / 2, K / 2, F + offset);
                ...
                if (Clamps == 1)
                {
                    ...
                    if (Math.Abs(varAngle) > 40 + 0.0001 && Symbols.HgrCompareDoubleService.cmpdbl(Math.Round(Math.Abs(varAngle)), 45) == false)
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARNINGMESSAGE", "WARNING: " + "Clamp rotation cannot exceed 40 degrees..", "", "SFS5859.cs", 196);
                    ...
                    if (nomPipeDiaMetric > 49.00 / 1000.00)
                    {
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            try
            {
                ...
                if (Symbols.HgrCompareDoubleService.cmpdbl(rotation, 0) == true)
                    BOMdesc = "Pipe slide SFS 5859 DN " + currentDiameter;
                else
                    BOMdesc = "Pipe slide SFS 5859 DN " + currentDiameter + " -" + angle;
