...
//
//   SFS5380_YK1.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5380_YK1
//   Author       : Rajeswari
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class SFS5380_YK1 : CustomSupportDefinition
    {
        private const string ATTACHMENTB = "ATTACHMENTB_YK1";
        private const string HEXNUT1 = "HEXNUT1_YK1";
        private const string HEXNUT2 = "HEXNUT2_YK1";
        private const string ROD = "ROD_YK1";
        private const string LOGOBJ = "LOGOBJ_YK1";
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    parts.Add(new PartInfo(ATTACHMENTB + Index, "FINLCmp_SFS5386_" + loadClass));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (assmDescription.IndexOf("AK2") > 0 || assmDescription.IndexOf("AK4") > 0 || assmDescription.IndexOf("AR2") > 0 || assmDescription.IndexOf("AR4") > 0)
                {
                    ...
                    JointHelper.CreateRigidJoint(ATTACHMENTB + Index, "Hole", ROD + Index, "TopExThdRH", Plane.XY, Plane.NegativeXY, Axis.X, Axis.NegativeX, 0, 0, 0);

                    JointHelper.CreateRigidJoint(ATTACHMENTB + Index, "Hole", HEXNUT1 + Index, "InThdRH", Plane.XY, Plane.XY, Axis.X, Axis.X, -hexNutTakeOut, 0, 0);

                    JointHelper.CreateRigidJoint(ATTACHMENTB + Index, "Hole", HEXNUT2 + Index, "InThdRH", Plane.XY, Plane.XY, Axis.X, Axis.X, -hexNutTakeOut + hexNutThickness, 0, 0);
