...
//
//   SFS5380_AR5.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5380_AR5
//   Author       : Rajeswari
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    //-----------------------------------------------------------------------------------
    public class SFS5380_AR5 : CustomSupportDefinition
    {
        private const string PIPECLAMP = "PIPECLAMP_AR5";
        private const string SPRING = "SPRING_AR5";
        private const string LUG = "LUG_AR5";
        private const string LOGOBJ = "LOGOBJ_AR5";
        private const string LOGOBJ2 = "LOGOBJ2_AR5";
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (support.SupportedObjects.Count > 1)
                {
                    ...
                    {
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Assembly may be too short.", "", "SFS5380_AR5.cs", 115);
                        return;
                    }
                }
                else
                {
                    ...
                    {
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Assembly may be too short.", "", "SFS5380_AR5.cs", 123);
                        return;
                    }
                }
                ...
                ndFrom = FINLAssemblyServices.GetDataByCondition("FINLSubAsm_SFS5380_AR5", "IJHgrSupportDefinition", "NDFrom", "IJOAFINL_LoadClass", "LoadClass", loadClass);
                ndTo = FINLAssemblyServices.GetDataByCondition("FINLSubAsm_SFS5380_AR5", "IJHgrSupportDefinition", "NDTo", "IJOAFINL_LoadClass", "LoadClass", loadClass);

                if (ndFrom > nominalDiameter || nominalDiameter > ndTo)
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARNINGMESSAGE", "ConfigureSupport" + ": " + "WARNING: " + "Load Class of Supported Pipe does not match Load Class of supporting Pipe.", "", "SFS5380_AR5.cs", 134);
                ...
                {
                   double routeZstructangle = RefPortHelper.AngleBetweenPorts("Route", PortAxisType.X, "Structure", PortAxisType.Y, OrientationAlong.Global_X);
