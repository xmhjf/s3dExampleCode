...
//
//   SFS5398_F2.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5398_F2
//   Author       :  Manikanth
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class SFS5398_F2 : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Pipe size not valid.", "", "SFS5398_F2.cs", 98);
                    return;
                }
                ...
                GenericHelper.GetDataByRule("FINLSrv_SFS5398_F2_Dim", "IJUAFINLSrv_SFS5398_F2_Dim", "TS_Size", parameter, out tsSize);
                double maxSpan = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_F2_Dim", "IJUAFINLSrv_SFS5398_F2_Dim", "Max_Span", "IJUAFINLSrv_SFS5398_F2_Dim", "Size3", size3);
                double maxLength = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_F2_Dim", "IJUAFINLSrv_SFS5398_F2_Dim", "Max_Len", "IJUAFINLSrv_SFS5398_F2_Dim", "Size3", size3);
                double ma = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_F2_Dim", "IJUAFINLSrv_SFS5398_F2_Dim", "MA", "IJUAFINLSrv_SFS5398_F2_Dim", "Size3", size3);
                double mp = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_F2_Dim", "IJUAFINLSrv_SFS5398_F2_Dim", "MP", "IJUAFINLSrv_SFS5398_F2_Dim", "Size3", size3);
                double fMax = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_F2_Dim", "IJUAFINLSrv_SFS5398_F2_Dim", "Fmax", "IJUAFINLSrv_SFS5398_F2_Dim", "Size3", size3);
                ...
                if (overHang < 0)
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Overhang must a positive value.", "", "SFS5398_F2.cs", 124);
                    return;
                }
                ...
                double verticalLength = vertDistance - pipeDia / 2 - shoeH - widthHorTS - angledOffset / 2;
                //Checking for max H
                if (verticalLength > maxLength)
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARNINGMESSAGE", "ConfigureSupport" + ": " + "WARNING: " + "Maximum allowable length of " + maxLength * 1000 + "mm exceeded.", "", "SFS5398_F2.cs", 141);
                //If the span length entered is greater than allowed
                if (horLength > maxSpan)
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Maximum allowable length of " + maxSpan * 1000 + "mm exceeded.", "", "SFS5398_F2.cs", 145);
                    return;
                }
                if (overHang > span)
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Overhang must not exceed the value of Span.", "", "SFS5398_F2.cs", 150);
                    return;
                }
                ...
                else
                {
                    if (SupportHelper.PlacementType == PlacementType.PlaceByReference || SupportHelper.PlacementType == PlacementType.PlaceByPoint)
                    {
                        ...
                        MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARNINGMESSAGE", "ConfigureSupport" + ": " + "WARNING: " + "Support can only be placed on Slab By-Point. " + pipeDia * 1000 + shoeH * 1000 + " mm.", "", "SFS5398_H2.cs", 192);
                }
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            size3 = sizeList.PropertyInfo.CodeListInfo.GetCodelistItem(sizeList.PropValue).DisplayName;
            string BOMdesc = "Gate support F2 -" + size3 + " SFS 5398";
