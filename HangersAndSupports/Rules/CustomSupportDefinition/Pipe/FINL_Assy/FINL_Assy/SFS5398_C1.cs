...
//
//   SFS5398_C1.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5398_C1
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class SFS5398_C1 : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        string size4;
        double shoeH, X1, X2, dH, normalPipeDiameter;
        PropertyValueCodelist size4CodeList;
        private const string HORSTEEL = "HorSteel_5398_C1";
        private const string VERSTEEL = "VerSteel_5398_C1";
        private const string PLATE1 = "Plate1_5398_C1";
        private const string PLATE2 = "Plate2_5398_C1";
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    dH = (double)((PropertyValueDouble)support.GetPropertyValue("IJUAFINLHeight", "H")).PropValue;
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Pipe size not valid.", "", "SFS5398_C1.cs", 115);
                    return;
                }

                //Getting Dimension Information
                //Interface name: IJUAFINLSrv_SFS5398_C1_Dim

                PropertyValue TSSize1, TSSize2;
                Dictionary<String, Object> parameter = new Dictionary<String, Object>();
                parameter.Add("Size4", size4);

                GenericHelper.GetDataByRule("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "TS_Size1", parameter, out TSSize1);
                GenericHelper.GetDataByRule("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "TS_Size2", parameter, out TSSize2);

                double maxSpan = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "Max_Span", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double maxLength = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "Max_Len", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double plateT = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "Plate_T", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double plateW = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "Plate_W", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double plateD = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "Plate_D", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double dC = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "C", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double inset = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "Inset", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double holeDiameter = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "D", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double MA = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "MA", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double MP = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "MP", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double FU = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "MA", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double FQ = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "MP", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                double FMax = FINLAssemblyServices.GetDataByCondition("FINLSrv_SFS5398_C1_Dim", "IJUAFINLSrv_SFS5398_C1_Dim", "Fmax", "IJUAFINLSrv_SFS5398_C1_Dim", "Size4", size4);
                ...
                double horizontalLength, verticalLength, widthHorTS, widthVerTS, depthHorTS, depthVerTS, widthOffsetVerTS;
                ...
                if (verticalDistance + shoeH + pipeInfo.OutsideDiameter / 2 + depthHorTS > maxLength)
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERWARNINGMESSAGE", "ConfigureSupport" + ": " + "WANRING: " + "Maximum allowable length of " + Convert.ToString(maxLength * 1000) + "mm exceeded.", "", "SFS5398_C1.cs", 169);

                //If the span length entered is greater than allowed
                if (X1 + X2 > maxSpan)
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Maximum allowable span of " + Convert.ToString(maxLength * 1000) + "mm exceeded.", "", "SFS5398_C1.cs", 174);
                    return;
                }

                if (pipeInfo.OutsideDiameter / 2 > X1 || pipeInfo.OutsideDiameter / 2 > X2)
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "X1 and X2 must exceed Pipe outside radius.", "", "SFS5398_C1.cs", 180);
                    return;
                }
                ...
                double theta = RefPortHelper.AngleBetweenPorts("Route", PortAxisType.Y, "Route", PortAxisType.X, OrientationAlong.Global_Z);

                //Create graphics
                if (SupportHelper.PlacementType == PlacementType.PlaceByReference || SupportHelper.PlacementType == PlacementType.PlaceByPoint)
                {
                    if (Math.Abs(theta) < (Math.Atan(1) * 4.0) / 2)
                        JointHelper.CreateRigidJoint("-1", "Structure", HORSTEEL, "StartOther", Plane.XY, Plane.ZX, Axis.X, Axis.NegativeZ, widthHorTS / 2 + plateT, pipeInfo.OutsideDiameter / 2 + shoeH + depthHorTS / 2, horizontalLength - X1);
                    else
                        JointHelper.CreateRigidJoint("-1", "Structure", HORSTEEL, "StartOther", Plane.XY, Plane.ZX, Axis.X, Axis.Z, widthHorTS / 2 + plateT, -(pipeInfo.OutsideDiameter / 2 + shoeH + depthHorTS / 2), -X2);

                    JointHelper.CreateRigidJoint(HORSTEEL, "StartOther", VERSTEEL, "StartOther", Plane.XY, Plane.NegativeYZ, Axis.X, Axis.Z, -depthVerTS / 2, (widthVerTS / 2 - widthHorTS / 2), -depthHorTS / 2);
                    JointHelper.CreateRigidJoint(VERSTEEL, "EndOther", PLATE1, "TopStructure", Plane.XY, Plane.ZX, Axis.X, Axis.X, 0, -widthVerTS / 2, 0);
                    JointHelper.CreateRigidJoint(HORSTEEL, "EndOther", PLATE2, "TopStructure", Plane.XY, Plane.ZX, Axis.X, Axis.X, 0, -widthHorTS / 2, 0);
                }
                else
                {
                    MiddleServiceProvider.ErrorLogger.Log(0, "", "", "USERERRORMESSAGE", "ConfigureSupport" + ": " + "ERROR: " + "Support can only be placed on Wall By-Point.", "", "SFS5398_C1.cs", 236);
                    return;
                }
            }
            catch (Exception e)
        ...
        public string BOMDescription(BusinessObject oSupportOrComponent)
        {
            ...
            try
            {
                ...
                BOMString = "Gate support C1 -" + Convert.ToString(sizeBOM) + " SFS 5398";
