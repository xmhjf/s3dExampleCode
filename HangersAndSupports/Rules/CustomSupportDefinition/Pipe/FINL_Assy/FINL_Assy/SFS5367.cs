...
//
//   SFS5367.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5367
//   Author       :  Vijay
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    public class SFS5367 : CustomSupportDefinition
    {

        private const string LEFTGUIDE = "LeftGuide_5367";
        private const string RIGHTGUIDE = "RightGuide_5367";
        private const string ROUTECONNOBJECT = "RouteConnObject_5367";
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                string guideBom = "50 Steel Plate 50x25, Notch 20x15";
                double width = 50.00 / 1000.00;
                double depth = 25.00 / 1000.00;
                double X = 20.00 / 1000.00;
                double Z = 15.00 / 1000.00;
                double T = 50.00 / 1000.00;
