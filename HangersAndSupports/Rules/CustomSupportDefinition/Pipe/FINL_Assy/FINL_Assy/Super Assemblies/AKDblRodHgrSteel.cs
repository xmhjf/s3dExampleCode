...
//
//   AKDblRodHgrSteel.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.AKDblRodHgrSteel
//   Author       :  Hema
...
{
    public class AKDblRodHgrSteel : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                else if (subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AK4"))
                {
                    if (maxTemperature <= 20)
        ...
        public string BOMDescription(BusinessObject SupportOrComponent)
        {
            ...
            try
            {
                ...
                PipeObjectInfo pipeInfo = (PipeObjectInfo)SupportedHelper.SupportedObjectInfo(1);
                double d5384_CE = 0, E = 0, length, bottomPipeDiameter = pipeInfo.OutsideDiameter, bottomPipeNominalDiameter, bottomNominalDiameter = pipeInfo.NominalDiameter.Size;
