...
//
//   ARDblRodHgrTopStr.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.ARDblRodHgrTopStr
//   Author       :  Hema
...
{
    public class ARDblRodHgrTopStr : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (subBottomAssembly.GetType().FullName == "Ingr.SP3D.Content.Support.Rules.SFS5380_AR4")
                {
        ...
        public string BOMDescription(BusinessObject SupportOrComponent)
        {
            ...
            try
            {
                ...
                double d5384_CE = 0, E = 0, length, bottomPipeNominalDiameter,bottomPipeDiameter = pipeInfo.OutsideDiameter;
