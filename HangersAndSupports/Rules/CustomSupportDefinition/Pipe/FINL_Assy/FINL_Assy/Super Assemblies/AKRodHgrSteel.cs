...
//
//   AKRodHgrSteel.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.AKRodHgrSteel
//   Author       :  Hema
...
//   -----------     ---     ------------------
//  27/06/2013       Hema    CR-CP-224492 Convert HS_FINL_SupAssy to C# .Net
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
using System;
...
{
    public class AKRodHgrSteel : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AK3") ||subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AK5"))
        ...
        public string BOMDescription(BusinessObject SupportOrComponent)
        {
            ...
            try
            {
                ...
                if (subTop.Equals("FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5380_YK1"))
                    top = "YK1";
                else if (subTop.Equals("FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5380_YK2"))
                    top = "YK2";

                int loadClass = (int)((PropertyValueInt)SupportOrComponent.GetPropertyValue("IJOAFINL_LoadClass", "LoadClass")).PropValue;

                return bomDesciption = "Pipe Hanger SFS 5380 - " + Convert.ToString(loadClass) + " " + top.ToString() + " - " + Math.Round(length * 1000, 0) + " " + bottom.ToString() + " DN " + bottomNominalDiameter;
            }
            catch (Exception e)
            {
                Type myType = this.GetType();
