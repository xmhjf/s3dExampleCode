...
//
//   ARRodHgrPipe2Pipe.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.ARRodHgrPipe2Pipe
//   Author       :  Hema
...
//   -----------     ---     ------------------
//   14/06/2013       Hema       CR-CP-224492 Convert HS_FINL_SupAssy to C# .Net
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
using System;
...
{
    public class ARRodHgrPipe2Pipe : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                double bottomPipeNominalDiameter;
                ...
                else if (subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AR3"))
                {
                    ...
                    maxLoad = FINLAssemblyServices.GetDataByCondition("FINLCmp_SFS5862", "IJOAFINL_MaxLoad", "MaxLoad", "IJUAFINL_PipeND_mm", "PipeND", bottomPipeNominalDiameter - 0.0001, bottomPipeNominalDiameter + 0.0001);
                }
