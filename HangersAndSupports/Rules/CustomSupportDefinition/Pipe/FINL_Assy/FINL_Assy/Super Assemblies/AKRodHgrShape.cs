...
//
//   AKRodHgrShape.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.AKRodHgrShape
//   Author       :  Hema
...
{
    public class AKRodHgrShape : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AK6"))
                {
                    if (subTopAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_YK3") && (SupportHelper.PlacementType == PlacementType.PlaceByPoint|| SupportHelper.PlacementType == PlacementType.PlaceByReference))
                    {
                        ...
                        {
                            if (Configuration == 1)
                                JointHelper.CreateRigidJoint(subAssyStructConnections[0].PartKey, "InThdRH", subAssyRouteConnections[0].PartKey, "TopExThdRH", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                            else if (Configuration == 2)
                                JointHelper.CreateRigidJoint(subAssyStructConnections[0].PartKey, "InThdRH", subAssyRouteConnections[0].PartKey, "TopExThdRH", Plane.XY, Plane.XY, Axis.X, Axis.NegativeY, 0, 0, 0);
                            else if (Configuration == 3)
                                JointHelper.CreateRigidJoint(subAssyStructConnections[0].PartKey, "InThdRH", subAssyRouteConnections[0].PartKey, "TopExThdRH", Plane.XY, Plane.XY, Axis.X, Axis.NegativeX, 0, 0, 0);
                            else if (Configuration == 4)
                                JointHelper.CreateRigidJoint(subAssyStructConnections[0].PartKey, "InThdRH", subAssyRouteConnections[0].PartKey, "TopExThdRH", Plane.XY, Plane.XY, Axis.X, Axis.Y, 0, 0, 0);
                        }
                        else
                        {
                            if (Configuration == 1)
                ...
                else if (subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AK3"))
                {
                    if (subTopAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_YK3"))
                    {
                        if (SupportHelper.PlacementType == PlacementType.PlaceByPoint || SupportHelper.PlacementType == PlacementType.PlaceByReference)
                        {
                            if (supportingType == "Slab")
                                if (Configuration == 1)
                                    JointHelper.CreateRigidJoint(subAssyStructConnections[0].PartKey, "InThdRH", subAssyRouteConnections[0].PartKey, "TopExThdRH", Plane.XY, Plane.NegativeXY, Axis.X, Axis.X, 0, 0, 0);
                                else
                                    JointHelper.CreateRigidJoint(subAssyStructConnections[0].PartKey, "InThdRH", subAssyRouteConnections[0].PartKey, "TopExThdRH", Plane.XY, Plane.NegativeXY, Axis.X, Axis.NegativeX, 0, 0, 0);
                            else
                                if (Configuration == 1)
                                    JointHelper.CreateRigidJoint(subAssyStructConnections[0].PartKey, "InThdRH", subAssyRouteConnections[0].PartKey, "TopExThdRH", Plane.XY, Plane.NegativeXY, Axis.X, Axis.NegativeY, 0, 0, 0);
                                else
                                    JointHelper.CreateRigidJoint(subAssyStructConnections[0].PartKey, "InThdRH", subAssyRouteConnections[0].PartKey, "TopExThdRH", Plane.XY, Plane.NegativeXY, Axis.X, Axis.Y, 0, 0, 0);
                        }
                        else
                ...
                else if (subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AK5") && subTopAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_YK3"))
                {
                ...
                else if (subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AK1"))
                {
        ...
        public string BOMDescription(BusinessObject SupportOrComponent)
        {
            ...
            try
            {
                ...
                double length = RefPortHelper.DistanceBetweenPorts("Route", "Structure", PortDistanceType.Vertical) - heightAdjustment; //- HH.GetAttr("HeightAdjustment")
                ...
                if (subBottom.Equals("FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5380_AK1"))
                    ...
                    bottom = "AK5";
                else if (subBottom.Equals("FINL_Assy,Ingr.SP3D.Content.Support.Rules.SFS5380_AK6"))
                    bottom = "AK6";
