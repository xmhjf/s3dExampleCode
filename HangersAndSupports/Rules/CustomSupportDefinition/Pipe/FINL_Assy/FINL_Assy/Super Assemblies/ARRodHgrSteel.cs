...
//
//   ARRodHgrSteel.cs
//   FINL_Assy,Ingr.SP3D.Content.Support.Rules.ARRodHgrSteel
//   Author       :  Hema
...
{
    public class ARRodHgrSteel : CustomSupportDefinition, ICustomHgrBOMDescription
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AR6") || subBottomAssembly.GetType().FullName.Equals("Ingr.SP3D.Content.Support.Rules.SFS5380_AR1"))
