...
//
//   UDuctClamp.cs
//   SupDuctAssmInfoRules,Ingr.SP3D.Content.Support.Rules.UDuctClamp
//   Author       :Manikanth
            ...
            try
            {
                ...
                else
                {
                    if (bIsOffsetApplied[0])
                        //Add a Rigid Joint
                        JointHelper.CreateRigidJoint("-1", "BBR_Low", HGRBEAM2, "BeginCap", Plane.XY, Plane.YZ, Axis.X, Axis.Y, boundingBoxHeight + G, -lugOffset[1], 0);
                    else
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                {
                    if (leftPad)
                    {
                        ...
                        JointHelper.CreateRigidJoint(LEFTPAD, "HgrPort_2", HGRBEAM1, "BeginCap", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, -steelDepth / 2, -steelWidth / 2);
                    }
                    else
                        //add a prismatic joint
                ...
                {
                    if (bIsOffsetApplied[1])
                        JointHelper.CreatePlanarJoint("-1", rightStructPort, RIGHTPAD, "HgrPort_1", Plane.XY, Plane.NegativeXY, 0);
                    else
                        JointHelper.CreatePlanarSlotJoint("-1", rightStructPort, RIGHTPAD, "HgrPort_1", Plane.XY, Plane.NegativeXY, Axis.X, 0, 0); ;

                    JointHelper.CreateRigidJoint(RIGHTPAD, "HgrPort_2", HGRBEAM3, "EndCap", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, -steelDepth / 2, -steelWidth / 2);
                }
                else
                {
                    if (bIsOffsetApplied[1])
                ...
                JointHelper.CreatePrismaticJoint(HGRBEAM2, "BeginCap", DUCTCLAMP, "HgrPort_2", Plane.YZ, Plane.XY, Axis.Z, Axis.Y, 0, steelDepth / 2);
