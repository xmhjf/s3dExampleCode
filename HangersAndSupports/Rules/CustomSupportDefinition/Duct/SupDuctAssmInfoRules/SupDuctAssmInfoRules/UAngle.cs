...
//
//   UAngle.cs
//   SupDuctAssmInfoRules,Ingr.SP3D.Content.Support.Rules.UAngle
//   Author       :Vijay
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    parts.Add(new PartInfo(HGRBEAM3, "HgrBeam"));
                    parts.Add(new PartInfo(HGRBEAM4, "HgrBeam", "HgrSupSecondaryCS"));
                    parts.Add(new PartInfo(HGRBEAM5, "HgrBeam", "HgrSupSecondaryCS"));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                {
                    if (leftPad)
                    {
                        JointHelper.CreatePointOnAxisJoint(LEFTPAD, "HgrPort_1", "-1", leftStructPort, Axis.X);
                        JointHelper.CreateRigidJoint(LEFTPAD, "HgrPort_2", HGRBEAM1, "BeginCap", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, -pcsSectionDepth / 2.0, -pcsSectionWidth / 2.0);
                    }
                    else
                ...
                else
                {
                    ...
                    {
                        if (isOffsetApplied[0])
                            JointHelper.CreatePointOnPlaneJoint(LEFTPAD, "HgrPort_1", "-1", leftStructPort, Plane.XY);
                        else
                            JointHelper.CreatePointOnAxisJoint(LEFTPAD, "HgrPort_1", "-1", leftStructPort, Axis.X);
                        JointHelper.CreateRigidJoint(LEFTPAD, "HgrPort_2", HGRBEAM1, "BeginCap", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, -pcsSectionDepth / 2.0, -pcsSectionWidth / 2.0);
                    }
                ...
                {
                    if (isOffsetApplied[1])
                        JointHelper.CreatePointOnPlaneJoint(RIGHTPAD, "HgrPort_1", "-1", rightStructPort, Plane.XY);
                    else
                        JointHelper.CreatePointOnAxisJoint(RIGHTPAD, "HgrPort_1", "-1", rightStructPort, Axis.X);

                    JointHelper.CreateRigidJoint(RIGHTPAD, "HgrPort_2", HGRBEAM3, "EndCap", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, -pcsSectionDepth / 2.0, -pcsSectionWidth / 2.0);
                }
                else
                {
                    if (isOffsetApplied[1])
            ...
            get
            {
                try
                {
                    ...
                    if (rightPad)
                        ...
                        structConnections.Add(new ConnectionInfo(HGRBEAM3, 1));// partindex, routeindex
