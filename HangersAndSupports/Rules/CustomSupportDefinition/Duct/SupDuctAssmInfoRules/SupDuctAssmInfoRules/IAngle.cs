...
//
//   IAngle.cs
//   SupDuctAssmInfoRules,Ingr.SP3D.Content.Support.Rules.IAngle
//   Author       :Hema
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    parts.Add(new PartInfo(HGRBEAM2, "HgrBeam", "HgrSupSecondaryCS"));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                {
                    ...
                    {
                        JointHelper.CreateRigidJoint(HGRBEAM1, "BeginCap", RIGHTPAD, "HgrPort_1", Plane.XY, Plane.XY, Axis.X, Axis.X, 0.0, pcsSectionDepth / 2.0, pcsSectionWidth / 2.0);
                ...
                else
                {
                    ...
                    {
                        JointHelper.CreateRigidJoint(HGRBEAM1, "EndCap", LEFTPAD, "HgrPort_1", Plane.XY, Plane.XY, Axis.X, Axis.X, 0.0, pcsSectionDepth / 2.0, pcsSectionWidth / 2.0);
                        topStructPort = "HgrPort_2";
                        topPartIndex = LEFTPAD;
                    }
