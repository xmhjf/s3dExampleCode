...
//
//   HoldSideClamp.cs
//   CabletrayAssy2,Ingr.SP3D.Content.Support.Rules.ClipHoldClampHoldSideClamp
//   Author       : Vinay
    ...
    public class HoldSideClamp : CustomSupportDefinition
    {
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                JointHelper.CreateRigidJoint(ROD_1, "RodEnd1", CTHOLDSIDECLAMP1, "Structure", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
                ...
                //Add a Rigid Joint between cable tray Clamp and Bottom of Rod
                JointHelper.CreateRigidJoint(ROD_2, "RodEnd1", CTHOLDSIDECLAMP2, "Structure", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);
