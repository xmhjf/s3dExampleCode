...
//
//   HoldSideClamp.cs
//   CabletrayAssy,Ingr.SP3D.Content.Support.Rules.HoldSideClamp
//   Author       :  MK
...
{
    public class HoldSideClamp : CustomSupportDefinition
    {
        private const string CTHOLDSIDECLAMP1 = "CTHOLDSIDECLAMP1";
        private const string CTHOLDSIDECLAMP2 = "CTHOLDSIDECLAMP2";
        ...
        public override Collection<PartInfo> Parts
        {
            get
            {
                try
                {
                    ...
                    PartClass ctHoldSideClamp = (PartClass)catalogBaseHelper.GetPartClass("CTHoldSideClamp");
                    ...
                    Part ctHoldSideClampPart1 = supportComponentUtils.GetPartFromPartClass("CTHoldSideClamp", partselection, support);
                    Part ctHoldSideClampPart2 = supportComponentUtils.GetPartFromPartClass("CTHoldSideClamp", partselection, support);
                    ...
                    {
                        if (((double)((PropertyValueDouble)businessObject.GetPropertyValue("IJUAHgrDia", "RodSizeDia")).PropValue) >= (((double)((PropertyValueDouble)ctHoldSideClampPart1.GetPropertyValue("IJUAHgrCTHdSdClamp", "RodDiameter")).PropValue)))
                        {
                    ...
                    parts.Add(new PartInfo(CTHOLDSIDECLAMP1, ctHoldSideClampPart1.ToString()));
                    parts.Add(new PartInfo(CTHOLDSIDECLAMP2, ctHoldSideClampPart2.ToString()));
        ...
        public override void ConfigureSupport(Collection<SupportComponent> oSupCompColl)
        {
            try
            {
                ...
                (componentDictionary[CTHOLDSIDECLAMP1]).SetPropertyValue(width, "IJUAHgrCTOffset", "TrayWidth");
                (componentDictionary[CTHOLDSIDECLAMP1]).SetPropertyValue(depth, "IJUAHgrCTOffset", "TrayDepth");
                (componentDictionary[CTHOLDSIDECLAMP1]).SetPropertyValue(depth / 4.0, "IJUAHgrCTOffset", "TrayBeamWidth");

                (componentDictionary[CTHOLDSIDECLAMP2]).SetPropertyValue(width, "IJUAHgrCTOffset", "TrayWidth");
                (componentDictionary[CTHOLDSIDECLAMP2]).SetPropertyValue(depth, "IJUAHgrCTOffset", "TrayDepth");
                (componentDictionary[CTHOLDSIDECLAMP2]).SetPropertyValue(depth / 4.0, "IJUAHgrCTOffset", "TrayBeamWidth");
                ...
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                    JointHelper.CreatePrismaticJoint(CTHOLDSIDECLAMP1, "Route", "-1", "Route", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0);
                else
                    JointHelper.CreateRigidJoint(CTHOLDSIDECLAMP1, "Route", "-1", "Route", Plane.XY, Plane.XY, Axis.X, Axis.X, 0, 0, 0);

                //Add a Spherical Joint between cable tray Clamp and Bottom of Rod
                JointHelper.CreateSphericalJoint(CTHOLDSIDECLAMP1, "Structure", G4G1460011, "RodBottom");
                ...
                //Add a Joint between cable tray and Clamp
                if (SupportHelper.PlacementType == PlacementType.PlaceByStruct)
                    JointHelper.CreatePrismaticJoint(CTHOLDSIDECLAMP2, "Route", "-1", "Route", Plane.XY, Plane.XY, Axis.X, Axis.NegativeX, 0, 0);
                else
                    JointHelper.CreateRigidJoint(CTHOLDSIDECLAMP2, "Route", "-1", "Route", Plane.XY, Plane.XY, Axis.X, Axis.NegativeX, 0, 0, 0);

                //Add a Spherical Joint between cable tray Clamp and Bottom of Rod
                JointHelper.CreateSphericalJoint(CTHOLDSIDECLAMP2, "Structure", G4G1460012, "RodBottom");
        ...
        public override Collection<ConnectionInfo> SupportedConnections
        {
            get
            {
                try
                {
                    ...
                    routeConnections.Add(new ConnectionInfo(CTHOLDSIDECLAMP1, 1)); // partindex, routeindex
                    routeConnections.Add(new ConnectionInfo(CTHOLDSIDECLAMP2, 1)); // partindex, routeindex
