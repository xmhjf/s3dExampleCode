...
//
//   GenericDesignAssm.cs
//   DesignSupport,Ingr.SP3D.Support.Content.Rules.GenericDesignAssm
//   Author       :  Pavan
...
namespace Ingr.SP3D.Content.Support.Rules
{
    ...
    //-----------------------------------------------------------------------------------
    public class GenericDesignAssm : CustomSupportDefinition
    {
        //Constants
        ...
        {
            JointHelper.CreateRigidJoint("-1", "Route", "-1", "LocalCS", Plane.XY, Plane.ZX, Axis.Y, Axis.Z, 0, 0, 0);
        }
