...
Object = "{D296B115-BF1F-11D1-A758-00A0C98D9DB1}#1.1#0"; "GraphicInputSelectionHelper.ocx"
Begin VB.Form frmEditOccurrence 
   Caption         =   "Clock Edit Form"
   ClientHeight    =   4965
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4035
   ...
   Begin IMSSblTools.GraphicSelectHelper GraphicSelectHelper 
      Left            =   1440
      Top             =   4200
      _ExtentX        =   1931
      _ExtentY        =   1085
   ...
   Begin VB.Frame Representation 
      ...
      Top             =   2880
      Width           =   3735
      Begin VB.ListBox RepresentationList 
         Height          =   645
         Left            =   240
         TabIndex        =   5
         Top             =   240
   ...
   End
End
Attribute VB_Name = "frmEditOccurrence"
...
Private Sub Form_Load()
    ...
    ParameterGrid.Col = 1
    ParameterGrid.Text = "Name"
    ParameterGrid.Col = 2
    ParameterGrid.Text = "ByRef"
    ParameterGrid.Col = 3
...
Private Function CheckParams() As Boolean
    ...
    If (ParameterGrid.Text <= 0) Then
        MsgBox "Radius must be greater than 0", vbOKOnly, "Error"
        CheckParams = False
    End If
End Function
...
Private Sub cmdOK_Click()
    ...
    GraphicSelectHelper.RaiseEventClickOnOK
...
If Not m_bClickOnOK Then
    GraphicSelectHelper.RaiseEventClickOnCancel
End If
...
ElseIf ParameterGrid.Col = 2 Then
