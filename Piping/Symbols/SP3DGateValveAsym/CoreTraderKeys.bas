...
Public Const DUIEyeView = "EyeView"         ' 25.aug.98, cgp
...
Public Const TKStyleMgr = "StyleMgr"                    'may be obsolete?
...
'  Preference Keys
Public Const PRFColorHighlight = "PrefOptionsColorHighlight"

'  Key for the Units Of Measure Service
Public Const TKUnitsOfMeasure = "UnitsOfMeasure"

'  Key for the ATPTestApp   03/18/1999 Ed Bosworth
