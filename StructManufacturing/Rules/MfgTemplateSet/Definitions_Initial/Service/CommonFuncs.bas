...
'
'Abstract:
'    CommonFunctions. It can be customized by shipyard.
'
'Description:
'History :
'   ByungSam Lee               06/29/2001               Creation.
'   ByungSam Lee               07/03/2001               Created GetCenterFrameFromPlatePart Method
'   ByungSam Lee               07/06/2001               Created GetFarthestEdgePointAlongVector Method
'   ByungSam Lee               02/08/2002               Created Several Methods
'***********************************************************************
