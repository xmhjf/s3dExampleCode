...
'
'Abstract:
'    BasePlane service for Creation of BasePlane. It can be customized by shipyard.
'
'Description:
'History :
'   ByungSam Lee              06/28/2001        Creation.
'   ByungSam lee               02/21/2002       Totally update CreateBasePlane Procedure
'   ByungSam Lee              06/24/2002        Update this Procedure according to modification of Process Settings
'   Marcel Veldhuizen         2004/04/22        Included correct error handling
'   Ram Kandimalla            2005/09/29        changed from class to module
'   Suma Mallena              2009/08/06        Added method GetBasePlaneFromCorners() [DI-CP-169008  Expose new balance types ]
'************************************************************************************************************
Option Explicit
