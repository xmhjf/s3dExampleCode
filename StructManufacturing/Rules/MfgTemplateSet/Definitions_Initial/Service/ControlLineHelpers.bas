...
'
'Abstract:
'    ControlLine service for Creation of Control Line. It can be customized by shipyard.
'
'Description:
'History :
'   ByungSam Lee            06/26/2001      Creation.
'   ByungSam Lee            02/22/2002      Totally updated CreateControlLine Procedure
...
'   Ram Kandimalla            2005/09/29   changed from class to module
'***********************************************************************************************************
...
'   1. Check the Template Direction and choose the two good edges and get MidPoint of edges
'   2. Create SightPlane using BasePlane's Normal and Two mid point's direction
'   3. Get Control Line calculated by intersecting between Plate Part and SightPlane
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Public Function CreateBCtlLineOfNormalPlate(ByVal oPlatePart As IJPlatePart, ByVal strDirection As String, ByVal oSurfaceBody As IJSurfaceBody, ByVal pBasePlane As Plane3d, ByVal bBaseSide As Boolean) As IUnknown
    Const METHOD = "CreateBCtlLineOfNormalPlate"
    ...
    If oEdgeElements.count < 3 Then
        'Get Opposite mid points for BCL in special way
        GetMidPointsOfButtsSpecialForBCL oPlatePart, oSurfaceBody, oEdgeElements, strDirection, pBasePlane, oMidPoint1, oMidPoint2
    ElseIf oEdgeElements.count = 3 Then
        GetTriangleMidPointsOfButt oEdgeElements, strDirection, oMidPoint1, oMidPoint2, oRootPoint 'yes, this method works for two edges also
    Else 'plate of four or more edges
  
    '   Get MidPoints of Butts
        GetQuadRangleMidPointsOfButt oSurfaceBody, oEdgeElements, strDirection, oMidPoint1, oMidPoint2
    End If
    

'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'   1. Check Template Orientation and apply different algorithms according to that
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    oGeomHelper.MakeTransientPlane oMidPoint1.x, oMidPoint1.y, oMidPoint1.z, oNormalVec.x, oNormalVec.y, oNormalVec.z, oSightPlane
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    Set CreateBCtlLineOfNormalPlate = oCS
...
' Control Line is the CenterLine i.e. Intersection Line between PlatePart and y=0 plane
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
'   4. Create SightPlane as Middle Point and Get Intersection Line between this SightPlane and PlatePart
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Public Function CreateBCtlLineOfPerpendicularXY(ByVal oPlatePart As IJPlatePart, ByVal strTemplateDirection As String, ByVal oSurfaceBody As IJSurfaceBody, ByVal pBasePlane As Plane3d, ByVal bBaseSide As Boolean) As IUnknown
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    If oProjectedEdges.count < 3 Then
        GetMidPointsOfButtsSpecialForBCL oPlatePart, oSurfaceBody, oProjectedEdges, strTemplateDirection, pBasePlane, oMidPoint1, oMidPoint2
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    ...
    '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
'   5. Create SightPlane as Middle Point and Get Intersection Line between this SightPlane and PlatePart
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
    If Not oOutPutCurve Is Nothing Then
...
ErrorHandler:
    Err.Raise Err.Number, Err.Source, Err.Description
End Function
Public Function CreateControlLineAtAvgPointAvgNormal(ByVal oTemplateSetData As TemplateSetData, ByVal oPlatePart As Object, ByVal pProcessSettings As Object, ByVal pBasePlane As Object) As Object
    ...
    Set oSurfaceBody = oGeomHelper.GetSurfaceFromPlate(oPlatePart, TRUE_MOLD, ePlateThicknessSide, 0)

    On Error Resume Next 'expected that there can be errors when surface is bad
    Set oEdgeElements = oGeomHelper.GetPlatePartEdgesInIJElements(oSurfaceBody, oTemplateSetData.IsOnBaseSide)
    On Error GoTo ErrorHandler
    
    'call the extended method
    Set CreateControlLineAtAvgPointAvgNormal = CreateControlLineAtAvgPointAvgNormal_Ex(oTemplateSetData, oPlatePart, pProcessSettings, pBasePlane, oEdgeElements)
...
Public Function CreateControlLineAtAvgPointAvgNormal_Ex(oTemplateSetData As TemplateSetData, pPlatePart As Object, pProcessSettings As Object, pBasePlane As Object, oEdgeElements As IJElements) As Object
...
'    Dim ePlateType As enumPlateType
    ...
    oGeomHelper.GetPlatePartAvgPointAvgNormal pPlatePart, bBaseSide, _
