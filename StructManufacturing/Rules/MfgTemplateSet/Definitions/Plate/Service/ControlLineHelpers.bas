...
'
'Abstract:
'   Bas file with functions to support CreateControlLine
'
'Description:
'History :
...
ErrorHandler:
    Err.Raise Err.Number, Err.Source, Err.Description
End Function
Public Function CreateControlLineAtAvgPointAvgNormal(ByVal oTemplSetData As TemplSetData, ByVal oPlatePart As Object, ByVal pProcessSettings As Object, ByVal pBasePlane As Object) As Object
    ...
    Set oSurfaceBody = oGeomHelper.GetSurfaceFromPlateEx(oPlatePart, TRUE_MOLD, ePlateThicknessSide, 0, True)

    On Error Resume Next 'expected that there can be errors when surface is bad
    Set oEdgeElements = oGeomHelper.GetPlatePartEdgesInIJElements(oSurfaceBody, oTemplSetData.IsOnBaseSide)
    On Error GoTo ErrorHandler
    
    'call the extended method
    Set CreateControlLineAtAvgPointAvgNormal = CreateControlLineAtAvgPointAvgNormal_Ex(oTemplSetData, oPlatePart, pProcessSettings, pBasePlane, oEdgeElements)
...
Public Function CreateControlLineAtAvgPointAvgNormal_Ex(oTemplSetData As TemplSetData, pPlatePart As Object, pProcessSettings As Object, pBasePlane As Object, oEdgeElements As IJElements) As Object
    ...
    Dim bBaseSide As Boolean
    bBaseSide = oTemplSetData.TemplateSide
...
'    Dim ePlateType As enumPlateType
    ...
    strDirection = oTemplSetData.Direction
