...
{
    /// <summary>
    /// LongDistBCLRule Rule for TemplateSet on Tube.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessLongDistBCLParamName, SymbolsConstants.ProcessLongDistBCLParamUserName)]
    #endregion

    public class ProcessParameterLongDistBCLRuleRule : ProfileParameterRule
    {
        #region Parameters
