...
//
//      Purpose:  StemSternRule is a .NET process parameter rule for TemplateSet on Plate.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process StemStern Parameter Rule for TemplateSet on Plate.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessStemSternParamName, SymbolsConstants.ProcessStemSternParamUserName)]
    #endregion

    public class ProcessParameterStemSternRule : PlateParameterRule
    {
        #region Parameters
