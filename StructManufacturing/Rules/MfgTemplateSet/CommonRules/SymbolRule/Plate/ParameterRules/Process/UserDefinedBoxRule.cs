...
//
//      Purpose:   UserDefinedBoxRule is a .NET process parameter rule for TemplateSet on Plate.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process UserDefinedBox Parameter Rule for TemplateSet on Plate.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessUserDefinedBoxParamName, SymbolsConstants.ProcessUserDefinedBoxParamUserName)]
    #endregion

    public class ProcessParameterUserDefinedBoxRule : PlateParameterRule
    {
        #region Parameters
