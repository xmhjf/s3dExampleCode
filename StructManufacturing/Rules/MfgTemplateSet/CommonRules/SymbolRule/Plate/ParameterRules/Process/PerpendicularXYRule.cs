...
//
//      Purpose:   PerpendicularXYRule is a .NET process parameter rule for TemplateSet on Plate.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process PerpendicularXY Parameter Rule for TemplateSet on Plate.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessPerpendicularXYParamName, SymbolsConstants.ProcessPerpendicularXYParamUserName)]
    #endregion

    public class ProcessParameterPerpendicularXYRule : PlateParameterRule
    {
        #region Parameters
