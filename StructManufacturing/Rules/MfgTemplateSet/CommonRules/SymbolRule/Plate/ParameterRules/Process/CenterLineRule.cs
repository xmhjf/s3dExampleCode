...
//
//      Purpose:   CenterLineRule is a .NET process parameter rule for TemplateSet on Plate.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process CenterLine Parameter Rule for TemplateSet on Plate.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessCenterLineParamName, SymbolsConstants.ProcessCenterLineParamUserName)]
    #endregion

    public class ProcessParameterCenterLineRule : PlateParameterRule
    {
        #region Parameters
