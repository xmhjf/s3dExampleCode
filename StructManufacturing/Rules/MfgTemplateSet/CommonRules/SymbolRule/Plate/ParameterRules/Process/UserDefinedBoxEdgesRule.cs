...
//
//      Purpose:   UserDefinedBoxEdgesRule is a .NET process parameter rule for TemplateSet on Plate.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process UserDefinedBoxEdges Parameter Rule for TemplateSet on Plate.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessUserDefBoxEdgesParamName, SymbolsConstants.ProcessUserDefBoxEdgesParamUserName)]
    #endregion

    public class ProcessParameterUserDefinedBoxEdgesRule : PlateParameterRule
    {
        #region Parameters
