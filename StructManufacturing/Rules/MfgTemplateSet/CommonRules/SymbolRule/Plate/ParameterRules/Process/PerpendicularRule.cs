...
//
//      Purpose:   PerpendicularRule is a .NET process parameter rule for TemplateSet on Plate.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process Perpendicular Parameter Rule for TemplateSet on Plate.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    ...
    public class ProcessParameterPerpendicularRule : PlateParameterRule
    {
        #region Parameters
