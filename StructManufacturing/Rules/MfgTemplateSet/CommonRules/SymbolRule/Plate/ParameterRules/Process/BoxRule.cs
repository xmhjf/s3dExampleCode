...
//
//      Purpose:   BoxRule is a .NET process parameter rule for TemplateSet on Plate.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process Box Parameter Rule for TemplateSet on Plate.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessBoxParamName, SymbolsConstants.ProcessBoxParamUserName)]
    #endregion

    public class ProcessParameterBoxRule : PlateParameterRule
    {
        #region Parameters
