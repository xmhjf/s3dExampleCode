...
{
    /// <summary>
    /// Marking Box Parameter Rule for TemplateSet on Plate.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.MarkingBoxParamName, SymbolsConstants.MarkingBoxParamUserName)]
    #endregion

    public class MarkingParameterBoxRule : PlateParameterRule
    {
        #region Parameters
