...
//
//      Purpose:   EvenRule is a .NET process parameter rule for TemplateSet on Profile Face.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process Even Parameter Rule for TemplateSet on Profile Face.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessEvenParamName, SymbolsConstants.ProcessEvenParamUserName)]
    #endregion

    public class ProcessParameterEvenRule : ProfileParameterRule
    {
        #region Parameters
