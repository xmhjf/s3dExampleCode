...
//
//      Purpose:   AftForwardRule is a .NET process parameter rule for TemplateSet on Profile Face.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process AftForward Parameter Rule for TemplateSet on Profile Face.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessAftForwardParamName, SymbolsConstants.ProcessAftForwardParamUserName)]
    #endregion

    public class ProcessParameterAftForwardRule : PlateParameterRule
    {
        #region Parameters
