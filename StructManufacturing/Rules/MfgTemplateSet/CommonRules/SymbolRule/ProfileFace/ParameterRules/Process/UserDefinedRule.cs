...
//
//      Purpose:   UserDefinedRule is a .NET process parameter rule for TemplateSet on Profile Face.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process UserDefined Parameter Rule for TemplateSet on Profile Face.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessUserDefinedParamName, SymbolsConstants.ProcessUserDefinedParamUserName)]
    #endregion

    public class ProcessParameterUserDefinedRule : ProfileParameterRule
    {
        #region Parameters
