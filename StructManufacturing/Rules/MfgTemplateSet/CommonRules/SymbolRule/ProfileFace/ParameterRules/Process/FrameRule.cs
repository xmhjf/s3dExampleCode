...
//
//      Purpose:   FrameRule is a .NET process parameter rule for TemplateSet on Profile Face.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process Frame Parameter Rule for TemplateSet on Profile Face.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessFrameParamName, SymbolsConstants.ProcessFrameParamUserName)]
    #endregion

    public class ProcessParameterFrameRule : ProfileParameterRule
    {
        #region Parameters
