...
//
//      Purpose:   PerpendicularRule is a .NET process parameter rule for TemplateSet on Profile Face.
//                 
//
//      Author:  
//
...
{
    /// <summary>
    /// Process Perpendicular Parameter Rule for TemplateSet on Profile Face.
    /// </summary>
    [RuleVersion("1.0.0.0")]
    #region RuleInterface
    [RuleInterface(SymbolsConstants.ProcessPerpendicularParamName, SymbolsConstants.ProcessPerpendicularParamUserName)]
    #endregion

    public class ProcessParameterPerpendicularRule : ProfileParameterRule
    {
        #region Parameters
        ...
        public override void Evaluate()
        {
            try
            {
                ...
                //Default values were not defined in BulkloadSheet. So directly set valus for two paramters.
                this.userDefinedValues.Value = 53100;// base.GetCatalogValue(SymbolsConstants.ProcessParamInterface, SymbolsConstants.ProcessUserDefinedValues);  
                this.templateNaming.Value = 53110;//base.GetCatalogValue(SymbolsConstants.ProcessParamInterface, SymbolsConstants.ProcessTemplateNaming); 
