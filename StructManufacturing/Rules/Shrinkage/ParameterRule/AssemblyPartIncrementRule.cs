...
namespace Ingr.SP3D.Content.Manufacturing
{
    ...
    /// 
    /// </summary>
    public class AssemblyPartIncrementRule : ShrinkageParameterRuleBase
    {
        ...
        public override ShrinkageParameters GetParameters(ShrinkageEntityInformation shrinkageInformation)
        {
            ...
            if (shrinkageInformation.ManufacturingParent is PlatePartBase)
            {
            ...
            {
                ShrinkageParameters parms = new ShrinkageParameters(ShrinkageType.ByEdge, null, 0.2, null, 0.4, null, 0);
                return parms;
            }
        }
