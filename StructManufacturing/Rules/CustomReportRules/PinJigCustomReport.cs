...
namespace Ingr.SP3D.Content.Manufacturing
{
    ...
    /// </summary>
    public class PinJigCustomReport: ManufacturingCustomReportRuleBase
    {
        ...
        /// </summary>
        /// <param name="JigRemarkingIntersection">The jig remarking intersection.</param>
        ...
        /// </summary>
        /// <param name="pinJig">The pin jig.</param>
        ...
        private void ShowMfgPinInformation(PinJig pinjig)
        {
            ...
            for (int i = 0; i < rowCount ; i++)
            {
                ...
                {
                    pinsInRow[col] = rowsOfPins[rowArr[i], col];
                }
                ...
                {
                    logService.WriteToFile("Information on Pin No." + colNumber + " of " + coloumnCount + " Pins in Row No." + (rowArr[i]) + 1);
        ...
        private void ShowMountingAngleInformation(PinJig pinjig)
        {
            ...
            ReadOnlyCollection<GridPlaneBase> framesCollection2;

            if (framesCollection1 == null)
            { return; }
            else
            {
                framesCollection2 = EntityService.GetPlanesInRange(pinjig.RemarkingSurface, perpendicularVector2, pinjig.CoordinateSystemFromParent, false);
            ...
            logService.WriteToFile("Intersecting frame to get the mounting position : " + framesCollection2[0].ToString());
            logService.WriteToFile("----------------------------------------------------------------");
            logService.WriteToFile(" ");
