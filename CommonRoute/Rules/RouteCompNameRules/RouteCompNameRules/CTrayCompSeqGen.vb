...
'
'  Class    : CTrayCompSeqGen
'
'  Abstract : The file contains implementation of the naming rules for CableTrayComponents with sequence ID's.
'
'***************************************************************************************
...
Public Class CTrayCompSeqGen
    ...
    Public Overrides Sub ComputeName(ByVal oEntity As Common.Middle.BusinessObject, ByVal oParents As System.Collections.ObjectModel.ReadOnlyCollection(Of Common.Middle.BusinessObject), ByVal oActiveEntity As Common.Middle.BusinessObject)
        ...
        Dim sMethod = "CTrayCompSeqGen : ComputeName() "
        ...
        Try
            ...
            strCompName = strRunName + "-" + "TRAY" + "-" + strSequenceNo
