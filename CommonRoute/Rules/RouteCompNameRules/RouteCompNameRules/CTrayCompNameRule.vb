...
'
'  Class    : CTrayCompNameRule
'
'  Abstract : The file contains implementation of the naming rules for CableTrayComponents.
'
'***************************************************************************************
...
Public Class CTrayCompNameRule
    ...
    Public Overrides Sub ComputeName(ByVal oEntity As Common.Middle.BusinessObject, ByVal oParents As System.Collections.ObjectModel.ReadOnlyCollection(Of Common.Middle.BusinessObject), ByVal oActiveEntity As Common.Middle.BusinessObject)
        ...
        Dim strRunName As String, strCompName As String, strSequenceNo As String, strLocation As String, strTray As String
        Dim lcount As Long
        strTray = "TRAY"
        Dim oLogError As LogError
        oLogError = MiddleServiceProvider.ErrorLogger()
        Dim sMethod = "CTrayCompNameRule : ComputeName() "
        ...
        Try
            ...
            If strRunName <> GetNamingParentsString(oActiveEntity) Then                
                ...
                strCompName = strRunName + "-" + strTray + "-" + strSequenceNo
