...
Namespace Symbols
    Friend Module InterfaceIds
        Friend Const CONST_IJUATestDotNetSphere As String = "{5201D970-8E75-4245-BB3B-D932FA9CD534}"
        Friend Const CONST_IJUAModifyOutput As String = "{AD3AD493-3C9E-4195-00C5-2B302E51CED1}"
        Friend Const CONST_IJGenericVolume As String = "{E897A3AF-E949-457C-968D-67E5DFDAD154}"
        Friend Const CONST_IJSurfaceArea As String = "{2A7D37F3-0440-4ACF-A731-90CE0613ABA0}"
        Friend Const CONST_IJUAGenericProperties As String = "{6182D650-4DA9-4EA6-A08C-5EC30078A3F7}"
    End Module
    ...
    Public Class CustomAsmMove : Inherits CustomAssemblyDefinition
        '   1. "Part"  ( Catalog part )
        '   2. "Diameter"
    ...
    <InputNotification("IJDAttributes", True)> _
    <OutputNotification("IJDGeometry", True)> _
    <InputNotification(InterfaceIds.CONST_IJUATestDotNetSphere)> _
    <OutputNotification(InterfaceIds.CONST_IJGenericVolume)> _
    <OutputNotification(InterfaceIds.CONST_IJSurfaceArea)> _
    <InputNotification(InterfaceIds.CONST_IJUAGenericProperties)> _
    <InputNotification(InterfaceIds.CONST_IJUAModifyOutput)> _
    Public Class CustomAsmInputTestSymbol : Inherits CustomAssemblyDefinition
        '   1. "Part"  ( Catalog part )
        '   2. "Diameter"
        <InputCatalogPart(1)> _
        Public m_catalogPart As InputCatalogPart
        <InputDouble(2, "Diameter", "Diameter", 0.3)> _
        Public m_dblDiameter As InputDouble
        <InputDouble(3, "OriginX", "Input X", 0.0)> _
        Public m_dblOriginX As InputDouble
        <InputDouble(4, "OriginY", "Input Y", 0.0)> _
        Public m_dblOriginY As InputDouble
        <InputDouble(5, "OriginZ", "Input Z", 0.0)> _
        ...
        ''' <remarks></remarks>
        Public Overrides Sub EvaluateAssembly()
            Const CONST_IJUAModifyOutput As String = "IJUAModifyOutput"
            Const CONST_DeleteOutput As String = "DeleteOutput"
            ...
            Dim origin As New Position(m_dblOriginX.Value, m_dblOriginY.Value, m_dblOriginZ.Value)
            ...
            Dim oModifyHead As PropertyValueCodelist = DirectCast(Occurrence.GetPropertyValue(CONST_IJUAModifyOutput, CONST_DeleteOutput), PropertyValueCodelist)
            If (oModifyHead.PropValue = -1 OrElse oModifyHead.PropValue = 0) Then
                ' Set head origin
                origin.Z = origin.Z + dblBodyRadius + dblHeadRadius
                ...
                Else
                    ...
                    oHead.Center() = origin
                End If
            ElseIf Not m_objHead.Output Is Nothing Then
                m_objHead.Output.Delete()   ' Remove the head of the yeti
            End If
        End Sub
    End Class
End Namespace
